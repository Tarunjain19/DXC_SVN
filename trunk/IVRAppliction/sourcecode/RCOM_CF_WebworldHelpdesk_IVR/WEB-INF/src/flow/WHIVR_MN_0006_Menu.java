 ...
 */
public class WHIVR_MN_0006_Menu extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:RSN_Status_OtherMDN_Menu", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

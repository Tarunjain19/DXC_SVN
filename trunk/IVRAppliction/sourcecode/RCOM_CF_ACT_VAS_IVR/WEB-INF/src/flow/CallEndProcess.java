...
public class CallEndProcess extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		String strReserve1 ="NA";
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
		GetReportObject getReportObject = null;
		IVRREPORTDATA ivrreportdata = null;
		CALLINFO callInfo = null;
		String actResponseCode = Constants.BLANK;
		String productid = Constants.BLANK,validity = Constants.BLANK,price = Constants.BLANK,type = Constants.BLANK,parentApp = Constants.BLANK;
		try {
			...
			actResponseCode = mySession.getVariableField(IProjectVariables.CONFIRM_USER_CHOICE,IProjectVariables.CONFIRM_USER_CHOICE_FIELD_CCGRESPONSE).getStringValue();
		
			mySession.getVariableField(IProjectVariables.FLAG, IProjectVariables.FLAG_FIELD_IS_CALL_END_START).setValue(Constants.Yes);
			...
			productid = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_PRODUCTID).getStringValue();
			price = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_PRICE).getStringValue();
			validity = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_VALIDITY).getStringValue();
			type = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_TYPE).getStringValue();
			parentApp = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_PARENT_APP).getStringValue();
			
			strReserve1 = productid+"|"+price+"|"+validity+"|"+type;
			
			callInfo.setLANGCODE(mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_LANGUAGE).getStringValue());
			callInfo.setENDDATETIME(dateFormat.format(new Date()));
			callInfo.setDTMFPATH(strDTMFPath);
			callInfo.setMENUPATH(strMenuPath);
			callInfo.setRESERVE1(strReserve1);
			callInfo.setRESERVE2(parentApp);
			callInfo.setRESERVE3(actResponseCode);

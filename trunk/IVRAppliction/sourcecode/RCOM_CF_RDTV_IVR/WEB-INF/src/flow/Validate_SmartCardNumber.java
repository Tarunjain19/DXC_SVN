 ...
 * Last generated by Orchestration Designer at: 2015-MAY-26  01:31:18 PM
 */
public class Validate_SmartCardNumber extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:IsHostFailure", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "CONSTANTS:YES", true).setDebugId(6849)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:RD01_TR_0004", false).setDebugId(6850));
			actions.add(new com.avaya.sce.runtime.Next("LinkDownAnnc", "linkdown").setDebugId(6851));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("checkRTN_LoyalityCustomer", "Default").setDebugId(484));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			if(validateSCNStatus !=null && validateSCNStatus.getStatus().equalsIgnoreCase(AppConstants.Success) && validateSCNStatus.getErrorCode().equalsIgnoreCase(AppConstants.zero))
			{

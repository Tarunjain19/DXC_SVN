 ...
 * Last generated by Orchestration Designer at: 2015-SEP-08  05:28:58 PM
 */
public class WS_BalanceCheck extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:IsHostFailure", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "CONSTANTS:YES", true).setDebugId(696)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:RD01_TR_0055", false).setDebugId(697));
			actions.add(new com.avaya.sce.runtime.Next("Base_Pack-link_down", "(Linkdown)").setDebugId(698));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "AppVariables:IsBalanceAvailableToBuy", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(700)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:IsBalanceAvailableToBuy", "false", true).setDebugId(701));
				actions.add(new com.avaya.sce.runtime.Next("Base_Pack-DB_LogPurchaseRequest", "(Balance Available)").setDebugId(702));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:FromBalanceCheckFlow", "true", true).setDebugId(898));
				actions.add(new com.avaya.sce.runtime.Next("Base_Pack-SF_RechargeAccount", "(Balance Not Available)").setDebugId(704));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

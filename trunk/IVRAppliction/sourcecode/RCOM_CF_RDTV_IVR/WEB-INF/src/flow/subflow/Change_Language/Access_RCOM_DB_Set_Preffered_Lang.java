 ...
 * Last generated by Orchestration Designer at: 2015-JUN-16  08:53:55 PM
 */
public class Access_RCOM_DB_Set_Preffered_Lang extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2015-JUN-16  08:53:55 PM
	 */
	public Access_RCOM_DB_Set_Preffered_Lang() {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:IsHostFailure", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "CONSTANTS:YES", true).setDebugId(470)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:RD01_TR_0044", false).setDebugId(471));
			actions.add(new com.avaya.sce.runtime.Next("Change_Language-UpdateLangFailureAnnc", "linkdown").setDebugId(158));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Change_Language-Set_Preffered_Lang_IVR_CSP", "next").setDebugId(473));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		{trace=null;updatePrefferedLanguage=null;}
		}
}

...
public class GetLanguageConfirmProperties extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Language_Selection-LanguageConfirm");
		next.setDebugId(332);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		key = appName+AppConstants.SEPERATOR_HYPEN+AppConstants.RD01_MN_0004;
		...
		if(selectedLanguage!=null && !AppConstants.EMPTY_STRING.equalsIgnoreCase(selectedLanguage)){
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG,"Dynamic wave File :"+arrLanguage.toString());
		}
			
			
		/** Formation of Initial Prompt**/
		initialPrompt = DynamicMenu.playPrompt(arrLanguage, dynamicWaves, AppConstants.NA, AppConstants.RD01_MN_0004, trace);

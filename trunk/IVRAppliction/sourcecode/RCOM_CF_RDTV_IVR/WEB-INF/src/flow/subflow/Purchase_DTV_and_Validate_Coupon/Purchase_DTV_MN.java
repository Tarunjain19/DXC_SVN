 ...
 * Last generated by Orchestration Designer at: 2015-MAY-26  08:08:15 PM
 */
public class Purchase_DTV_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Purchase_DTV_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_maxNoMatchCount", "Purchase_DTV_MN:NomatchRemaining", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Purchase_DTV_and_Validate_Coupon-check_PurchaseDTVMN");
	}
	/**

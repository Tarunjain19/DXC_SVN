 ...
 */
public class GlobalPromptFeature extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:GlobalPromptFeature", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_maxNoInputCount", "Global_Counter:Max_NoMatch", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_manageRepeat", "False", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);
	...
	public String getNext() {
		return("GlobalFeaturePrompt-CheckGPFLValue");
	}
	/**

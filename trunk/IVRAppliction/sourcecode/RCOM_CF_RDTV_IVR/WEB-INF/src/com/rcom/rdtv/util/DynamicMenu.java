...
public class DynamicMenu {
	...
	public static String playPrompt(List<String> dynamicValue, String initialPrompt,String count, String menuID, ITraceInfo trace){
			...
			try {/** Replacing the dynamic Value **/
				...
				if(count!=null && !AppConstants.EMPTY.equals(count) && !AppConstants.NA.equalsIgnoreCase(count)){
					...
					String[] optionGroup = initialPrompt.split(AppConstants.DOUBLE_PIPE_SEPERATOR);
	...
	/*public static void main(String[] args) {
		String str ="1151.wav**1154.wav||1151.wav**1155.wav||1151.wav**1156.wav|1151.wav**1157.wav||1151.wav**1158.wav";
				String[] optionGroup1 = str.split("\\|\\|");
				
				for(int i=0;i<optionGroup1.length;i++)
				{
					System.out.println(optionGroup1[i]);
				}

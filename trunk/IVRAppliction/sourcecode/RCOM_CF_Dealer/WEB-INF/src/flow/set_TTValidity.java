 ...
 */
public class set_TTValidity extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Registered_PP", "Default");
		next.setDebugId(5889);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		String key = null,getMDN = null,getAmt = null,gettalktime= null,getValidity =null,getStatus = null, appName = null,initialPrompt = null;
		...
		{	/** Forming the Dynamic Prompt **/
			...
			getAmt = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_GET_DENOMINATION).getStringValue();
			gettalktime = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_GET_AMT).getStringValue();
			getValidity = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_GET_DAYS).getStringValue();
			...
			gettalktime = Utilities.adjust2Decimal(gettalktime);
			...
			dynamicList.add(gettalktime + AppConstant.currency);
			dynamicList.add(getValidity);

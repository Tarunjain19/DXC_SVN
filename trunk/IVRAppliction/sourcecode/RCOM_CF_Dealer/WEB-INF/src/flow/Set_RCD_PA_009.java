 ...
 */
public class Set_RCD_PA_009 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Annc_ActivationStatus", "Default");
		next.setDebugId(6088);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		/*	getMDN = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_GET_MDN).getStringValue();
			...
			key = appName+AppConstant.SEPERATOR_HYPEN+AppConstant.RCD_PA_009;
		...
		/*	dynamicList.add(getMDN);
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Dynamic Prompt Key "+AppConstant.RCD_PA_009+" :: "+key);
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Confirmation Initial Prompt "+AppConstant.RCD_PA_009+" :: "+initialPrompt);

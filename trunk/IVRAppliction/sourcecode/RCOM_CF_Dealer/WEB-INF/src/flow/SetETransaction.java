 ...
 */
public class SetETransaction extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("TransactionAvailable_PP", "Default");
		next.setDebugId(4985);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		String key = null,getAmt = null,appName = null,getMDN = null,getStatus = null,initialPrompt = null;
		...
		{	/** Forming the Dynamic Prompt **/
			...
			key = appName+AppConstant.SEPERATOR_HYPEN+AppConstant.RCD_PA_0013;
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Dynamic Prompt Key "+AppConstant.RCD_PA_0013+" :: "+key);
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Confirmation Initial Prompt "+AppConstant.RCD_PA_0013+" :: "+initialPrompt);
		...
		{initialPrompt = null;getAmt = null;getStatus = null;appName=null;key=null;}
	}
}

 ...
 * Last generated by Orchestration Designer at: 2016-SEP-15  12:22:45 PM
 */
public class WS_CMS_BillQuery extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:WebServiceResponse", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "CONSTANTS:SUCCESS", true).setDebugId(6127)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "AppVariables:IsSingleAccount", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(6128)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:IsSingleAccount", "CONSTANTS:FALSE", false).setDebugId(6129));
				actions.add(new com.avaya.sce.runtime.Next("Set_AccNum2", "Single").setDebugId(6130));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "AppVariables:IsNoAccount", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(6131)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:IsNoAccount", "CONSTANTS:FALSE", false).setDebugId(6132));
				actions.add(new com.avaya.sce.runtime.Next("Get_Number_Type_MN_0007Bill", "NoAcc").setDebugId(6133));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("Get_Number_Type_MN_0007Bill", "MultiAcc").setDebugId(6135));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition4", "AppVariables:IsVIPCaller", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(6992)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:TR_0068", false).setDebugId(6993));
				actions.add(new com.avaya.sce.runtime.Next("TransferAnn_PP", "Failure").setDebugId(6994));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:TR_0059", false).setDebugId(6137));
			actions.add(new com.avaya.sce.runtime.Next("TransferAnn_PP", "Failure").setDebugId(6138));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

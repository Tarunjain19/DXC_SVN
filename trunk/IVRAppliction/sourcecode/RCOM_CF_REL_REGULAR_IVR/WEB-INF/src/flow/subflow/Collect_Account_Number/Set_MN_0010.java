 ...
 * Last generated by Orchestration Designer at: 2015-APR-26  01:35:30 PM
 */
public class Set_MN_0010 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Collect_Account_Number-Confirm_AccNum_MN_0010", "Default");
		next.setDebugId(280);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		{	/** Forming the Dynamic Prompt **/
			...
			accountNumber = mySession.getVariableField(IProjectVariables.COLLECT__ACC_NUM__MN___0_0_0_9,IProjectVariables.COLLECT__ACC_NUM__MN___0_0_0_9_FIELD_VALUE).getStringValue();
			key = appName+AppConstants.HYPEN_SEPERATOR+AppConstants.MN_0010;
			initialPrompt = AppProperties.GetInstance(AppConstants.IVR_CONFIG_PROPERTIES).getIVRProp(key);
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Dynamic Prompt Key "+AppConstants.MN_0010+" :: "+key);
			dynamicList[AppConstants.Zero] = accountNumber;
			
			/** Invoking the playPromt method **/
			initialPrompt = DynamicMenu.playPrompt(dynamicList, initialPrompt, AppConstants.NA, AppConstants.MN_0010, trace);
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Confirmation Initial Prompt "+AppConstants.MN_0010+" :: "+initialPrompt);

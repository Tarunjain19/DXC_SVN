...
public class SetLang extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2017-APR-28  01:19:09 PM
	 */
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("chkGSMCDMA", "Default");
		next.setDebugId(4157);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Language_SIM_MN_0001:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constantCopy:success", true).setDebugId(4154)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Language_SIM_MN_0001:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "ENG", false).setDebugId(4339)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("DMProperty:ConfigFilePath", "DMProperty:ENG_ConfigFilePath", false).setDebugId(4340));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			String tem_Status=mySession.getVariableField(IProjectVariables.LANGUAGE__SIM__MN___0_0_0_1, IProjectVariables.LANGUAGE__SIM__MN___0_0_0_1_FIELD_RETURN_CODE).getStringValue();
			String tem_lang=mySession.getVariableField(IProjectVariables.LANGUAGE__SIM__MN___0_0_0_1, IProjectVariables.LANGUAGE__SIM__MN___0_0_0_1_FIELD_VALUE).getStringValue();

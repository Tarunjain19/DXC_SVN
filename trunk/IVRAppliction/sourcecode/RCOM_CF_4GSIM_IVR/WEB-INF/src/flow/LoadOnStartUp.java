...
public class LoadOnStartUp extends com.avaya.sce.runtime.BasicServlet {
	...
	public void init() throws ServletException {
		...
		ivrConfigFileName  = getServletContext().getInitParameter(AppConstant.IVR_SIM_CONFIG);
		...
		System.out.println("AppConstant.IVR_CONFIG is "+AppConstant.IVR_SIM_CONFIG);

		String PropertyLocation = AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp("ConfigFilePath");
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("MAPANI", 0, true, "Default");
		list.add(aGoto);

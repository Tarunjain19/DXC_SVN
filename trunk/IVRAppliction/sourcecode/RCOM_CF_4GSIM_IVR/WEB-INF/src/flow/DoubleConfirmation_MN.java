 ...
 */
public class DoubleConfirmation_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperty:DoubleConfirmation", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

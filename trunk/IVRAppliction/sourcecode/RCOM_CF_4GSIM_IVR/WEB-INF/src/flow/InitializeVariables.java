...
public class InitializeVariables extends com.avaya.sce.runtime.Data {
	...
	private static Logger logger = Logger.getLogger("Dialog.Designer.TraceWriter.RCOM_CF_4SIM_IVR");
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			callInfo.setHUB(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp("HUB"));
			...
			String circleID="NAA";
				  ...
				  if(objIVRRoutingInfo!=null){
						...
						mySession.getVariableField(IProjectVariables.CIRCLE__ID).setValue(circleID);
						ivrreportdata.setCALLINFO(callInfo);
		...
		/*	
			...
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_ENG__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.ENG_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_HIN__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.HIN_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_TAM__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.TAM_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_MAR__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.MAR_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_GUJ__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.GUJ_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_PUN__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.PUN_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_TEL__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.TEL_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_KAN__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.KAN_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_MAL__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.MAL_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_ORI__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.ORI_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_BEN__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.BEN_ConfigFilePath));
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_ASS__CONFIG_FILE_PATH).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.ASS_ConfigFilePath));
			//mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_INITIAL_PROMPT).setValue(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.DATA_PA_0001));

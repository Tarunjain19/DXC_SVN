 ...
 * Last generated by Orchestration Designer at: 2016-APR-11  04:25:32 PM
 */
public class setNumber extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			String MSISDN = mySession.getVariableField(IProjectVariables.APP__VARIABLES,IProjectVariables.APP__VARIABLES_FIELD_ALT_MDN).getStringValue();
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Calling MSISDN : " +MSISDN);
			
			appName = ivrProperties.getIVRProp(AppConstant.APPLICATION_NAMES);
			

			key = appName+AppConstant.SEPERATOR_HYPEN+AppConstant.MN_PLAY_NUM;
			initialPrompt = ivrProperties.getIVRProp(key);
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Dynamic Prompt Key : "+key);
			dynamicList.add(MSISDN);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("PlayNumber", "Default");
		next.setDebugId(5050);
		return next;
	}
	/**

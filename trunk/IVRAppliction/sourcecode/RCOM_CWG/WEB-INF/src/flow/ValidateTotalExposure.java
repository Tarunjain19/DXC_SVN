...
public class ValidateTotalExposure extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			strOutstandingAmount = mySession.getVariableField(IProjectVariables.CHECK_BILL_DETAIL, IProjectVariables.CHECK_BILL_DETAIL_FIELD_INVOICE_AMOUNT).getStringValue();
			...
			strCreditLimit = mySession.getVariableField(IProjectVariables.CREDIT_INFO, IProjectVariables.CREDIT_INFO_FIELD_CREDIT_AMOUNT).getStringValue();
			...
			if(doubleTotalExposure<(1.5*doubleCreditAmount)){
				mySession.getVariableField(IProjectVariables.FLAG, IProjectVariables.FLAG_FIELD_IS_TOTAL_EXPOSURE_VALID).setValue(Constants.Yes);
			}
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Flag:isTotalExposureValid", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(1252)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("AccessDB_PTP", "TotalExposureValid").setDebugId(1254));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("AccessDB_PTP", "TotalExposureInvalid").setDebugId(1251));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

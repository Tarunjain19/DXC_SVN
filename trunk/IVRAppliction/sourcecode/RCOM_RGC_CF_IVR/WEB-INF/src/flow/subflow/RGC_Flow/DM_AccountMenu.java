 ...
 */
public class DM_AccountMenu extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:AccountBal_Menu", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

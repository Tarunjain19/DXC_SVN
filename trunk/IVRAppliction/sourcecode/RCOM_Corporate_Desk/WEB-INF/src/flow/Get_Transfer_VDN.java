 ...
 */
public class Get_Transfer_VDN extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("BCHD_PA_0003_TransferAgent_Annce", "Default");
		next.setDebugId(343);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "UUI DATA :: ", "appVariables:uuiData").setDebugId(817));
		actions.add(new com.avaya.sce.runtime.varoperations.PrepareAAI("Service Provider", "", "appVariables:uuiData", "appVariables:uuiData").setDebugId(816));
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "UUI DATA :: ", "appVariables:uuiData").setDebugId(818));
	...
	public void requestBegin(SCESession mySession) {
		...
		String strUUI = "";
		String menuID = "";
		String transferCode = AppConstant.EMPTY_STRING,ani=AppConstant.EMPTY_STRING,dnis=AppConstant.EMPTY_STRING;
		...
		try{
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "transferCode:"+transferCode);
			...
			strUUI = strUUI+ani+"|"+dnis+"|"+mySession.getCurrentLanguage()+"|"+last5Menu;

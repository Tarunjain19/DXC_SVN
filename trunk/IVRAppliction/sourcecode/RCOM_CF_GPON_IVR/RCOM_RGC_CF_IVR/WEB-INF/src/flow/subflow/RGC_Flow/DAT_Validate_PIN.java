 ...
 * Last generated by Orchestration Designer at: 2016-JUN-07  11:46:27 AM
 */
public class DAT_Validate_PIN extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Length("RGC_Operation:PIN_Length", "DM_Get_PIN:Value").setDebugId(1576));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "RGC_Operation:PIN_Length", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:four", true).setDebugId(1577)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("RGC_Flow-DAT_WS_PIN_Validation", "Validate_PIN").setDebugId(1578));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Increment("Invalid_PIN_Count").setDebugId(1580));
			actions.add(new com.avaya.sce.runtime.Next("RGC_Flow-DAT_Chk_Tries1", "Invalid_PIN").setDebugId(1581));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("Dat_initializaVariables");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.HOT_FLASH_IDS, variableFields, new String[] {"HF_PA_001"}, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.VAR__GPON_FIELD_IS_CALL_END_START,
			IProjectVariables.VAR__GPON_FIELD_IS_TRANSFFERED,
			IProjectVariables.VAR__GPON_FIELD_JAVA__ERROR };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.VAR__GPON, variableFields, new String[] {"", "false", ""}, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.CALL_DATA_FIELD_CALLER_PATH,
			IProjectVariables.CALL_DATA_FIELD_CIRCLE,
			IProjectVariables.CALL_DATA_FIELD_CURRENT_LANG,
			IProjectVariables.CALL_DATA_FIELD_DEFAULT_LANG,
			IProjectVariables.CALL_DATA_FIELD_DTMF_PATH,
			IProjectVariables.CALL_DATA_FIELD_MENU_PATH,
			IProjectVariables.CALL_DATA_FIELD_TRANSFER_REASON_CODE,
			IProjectVariables.CALL_DATA_FIELD_TRANSFER_VDN,
			IProjectVariables.CALL_DATA_FIELD_UUIDATA };
		...
		variableFields = new String[] {
			IProjectVariables.VAR__LANG_FIELD_ANN__LANG__OPTION___1,
			IProjectVariables.VAR__LANG_FIELD_ANN__LANG__OPTION___2,
			IProjectVariables.VAR__LANG_FIELD_ANN__LANG__OPTION___3,
			IProjectVariables.VAR__LANG_FIELD_ANN__LANG__OPTION___4,
			IProjectVariables.VAR__LANG_FIELD_LANG___1,
			IProjectVariables.VAR__LANG_FIELD_LANG___2,
			IProjectVariables.VAR__LANG_FIELD_LANG___3,
			IProjectVariables.VAR__LANG_FIELD_NUMBER__WAVFILE__NAME,
			IProjectVariables.VAR__LANG_FIELD_PRESS___1,
			IProjectVariables.VAR__LANG_FIELD_PRESS___2,
			IProjectVariables.VAR__LANG_FIELD_PRESS___3,
			IProjectVariables.VAR__LANG_FIELD_PRESS___4,
			IProjectVariables.VAR__LANG_FIELD_PRESS__WAVFILE__NAME,
			IProjectVariables.VAR__LANG_FIELD_TOTAL__LANG,
			IProjectVariables.VAR__LANG_FIELD_WAVFILE__NAME };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.VAR__LANG, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CONSTANTS, variableFields, new String[] {"true"}, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			...
			IProjectVariables.VAR__CONFIG_FIELD_MAX__INVALIDTRY,
		...
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.VAR__CONFIG, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.MNU__LANG_SELECTION_FIELD_CONFIDENCE,
			IProjectVariables.MNU__LANG_SELECTION_FIELD_INPUTMODE,
			IProjectVariables.MNU__LANG_SELECTION_FIELD_INTERPRETATION,
			IProjectVariables.MNU__LANG_SELECTION_FIELD_NOINPUTCOUNT,
			IProjectVariables.MNU__LANG_SELECTION_FIELD_NOMATCHCOUNT,
			IProjectVariables.MNU__LANG_SELECTION_FIELD_UTTERANCE,
			IProjectVariables.MNU__LANG_SELECTION_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MNU__LANG_SELECTION, variableFields, null, session, false, false );
		session.putVariable(variable);

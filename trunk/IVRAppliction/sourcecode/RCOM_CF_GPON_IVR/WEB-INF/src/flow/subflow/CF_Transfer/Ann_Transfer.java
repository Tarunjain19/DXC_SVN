 ...
 * Last generated by Orchestration Designer at: 2016-JAN-20  04:02:33 PM
 */
public class Ann_Transfer extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_Transfer", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CF_Transfer-Dat_GetTransferVDN");
		return submit;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		String strPath=mySession.getVariableField(IProjectVariables.CALL_DATA,IProjectVariables.CALL_DATA_FIELD_CALLER_PATH).getStringValue();
		strPath="|"+"GPON_PA0003"+strPath;
		mySession.getVariableField(IProjectVariables.CALL_DATA,IProjectVariables.CALL_DATA_FIELD_CALLER_PATH).setValue(strPath);

...
public class MainMenu_MN_0005 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:MainMenu_MN_0005", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

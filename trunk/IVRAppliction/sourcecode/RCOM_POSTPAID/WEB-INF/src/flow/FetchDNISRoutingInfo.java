...
public class FetchDNISRoutingInfo extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			mySession.getVariableField(IProjectVariables.EPM__ALARM,IProjectVariables.EPM__ALARM_FIELD_TOMCAT__SERVER_IP).setValue(IP);
			WebService_Flag = appProperties.getIVRProp(Constants.WebService_Flag);
			info.writeln(ITraceInfo.TRACE_LEVEL_INFO, "IP - "+IP);
			
			if(WebService_Flag != null && WebService_Flag != "") 
			{
			mySession.getVariableField(IProjectVariables.EPM__ALARM,IProjectVariables.EPM__ALARM_FIELD_WEBSERVICE__FLAG).setValue(WebService_Flag) ;
			}
			else
			{
			mySession.getVariableField(IProjectVariables.EPM__ALARM,IProjectVariables.EPM__ALARM_FIELD_WEBSERVICE__FLAG).setValue("FALSE") ;
			}
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:True", true).setDebugId(6684)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_CRITICAL, "DB Down|Main Flow|IVR DNIS Routing|", "EPM_Alarm:Description", true).setDebugId(6685));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "Constants:False", false).setDebugId(6686));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(26)).evaluate(mySession)) {
			...
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:isDBDown", "Constants:yes", false).setDebugId(7094));
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "Flag:isCallBack", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(29)).evaluate(mySession)) {

...
public class Initialize_MN_0005 extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "CallData:mainMenuCount", com.avaya.sce.runtime.Expression.INT_LESS_THAN_EQUAL, "CallData:allowedMainMenuCount", true).setDebugId(966)).evaluate(mySession)) {
			...
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("DMProperties:initialAudios", "HotFlashName", false).setDebugId(6133));
			...
			actions.add(new com.avaya.sce.runtime.Next("HotFlash_199_Pos", "MainMenu").setDebugId(819));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions.add(new com.avaya.sce.runtime.Next("checkHNICaller", "Transfer").setDebugId(968));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

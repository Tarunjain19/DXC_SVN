...
public class AccessHost_VASList extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		String strPrice = Constants.EMPTY_STRING,strValidity_Type = Constants.EMPTY_STRING;
		...
		HashMap<String, String> offerPhraseMap =null,offerPrice = null,offerValidity_Type = null;
		...
		try
		{
			...
			offerPrice =  new HashMap<String,String>();
			offerValidity_Type =  new HashMap<String,String>();
			...
			if((resNonActivePackDetails!=null && Constants.zero.equals(resNonActivePackDetails.getResponseCode()))||(resNonActivePackDetails!=null && Constants.one.equals(resNonActivePackDetails.getResponseCode()))){
				...
				if((resPackDetails!=null)&&(resPackDetails.size()>=1)){
					...
					if(listIVRVasInfo!= null){
						...
						for (int j = 0; j < listIVRVasInfo.size(); j++) {
							...
							if(!(offerCodes.contains(objIVRVasInfo.getPackCode()))){
								...
								strPrice = objIVRVasInfo.getPrice().trim();
								strValidity_Type = objIVRVasInfo.getValidiy_Type().trim();
								...
								info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "strPrice :: "+strPrice);
								info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "strValidity_Type:: "+strValidity_Type);
								
								offerPhrase.add(strOfferCategoryPhrase);
								offerDetailPhrase.put(objIVRVasInfo.getPackCode(),strOfferDetailPhrase);
								offerPrice.put(objIVRVasInfo.getPackCode(),strPrice);
								offerValidity_Type.put(objIVRVasInfo.getPackCode(),strValidity_Type);
					...
					info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer Price :: "+offerPrice);
					info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer Validity_Type :: "+offerValidity_Type);
				}else{
					...
					if(listIVRVasInfo!= null){
						...
						for (int j = 0; j < listIVRVasInfo.size(); j++) {
							...
							if(objIVRVasInfo.getPackCode()!= null){
								...
								info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer Detail Phrase :: "+strOfferDetailPhrase);
								info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer Code :: "+strOfferCode);
								info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer Price :: "+strPrice);
								info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer Validity_Type :: "+strValidity_Type);
					...
					info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer detail phrase :: "+offerDetailPhrase);
					info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer Price :: "+offerPrice);
					info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer Validity&Type :: "+offerValidity_Type);
					info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Offer code :: "+strOfferCode);
			...
			mySession.setProperty(Constants.OFFER_PRICE, offerPrice);
			mySession.setProperty(Constants.OFFER_VALIDITY_TYPE, offerValidity_Type);
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:True", true).setDebugId(6457)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_CRITICAL, "WS Down|Service Managemant flow|AccessHost_VASList|", "EPM_Alarm:Description", true).setDebugId(6458));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "Constants:False", false).setDebugId(6459));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(5176)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);

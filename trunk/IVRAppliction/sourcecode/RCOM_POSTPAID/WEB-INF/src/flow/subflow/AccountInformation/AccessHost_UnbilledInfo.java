...
public class AccessHost_UnbilledInfo extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			//adjDecimal = new Adjust2Decimal();
			dateFormat = new SimpleDateFormat("dd-MM-yyyy");
			ivrDataBean = (IVRDataBean) mySession.getProperty(Constants.IVRDATABEAN);
			reqUnbilledInfo = new ReqUnbilledInfo();
			reqUnbilledInfo.setMDN(mySession.getVariableField(IProjectVariables.CALL_DATA, IProjectVariables.CALL_DATA_FIELD_MDN).getStringValue());
			...
			if((resUnbilledInfo.getResponseCode()).equals(Constants.zero)){
				...
				unbilledAmt		= resUnbilledInfo.getUnBilledAmount();
				mySession.getVariableField(IProjectVariables.UNBILLED_INFO, IProjectVariables.UNBILLED_INFO_FIELD_UNBILLED_AMOUNT).setValue(Adjust2Decimal.adjustDecimal(unbilledAmt));
				...
				strSMSFrame = appProperties.getIVRProp(Constants.UNBILLED_Success);
				...
				strSMSFrame = appProperties.getIVRProp(Constants.UNBILLED_Failure);
				smsHashTable = setPushSMS.generatePushSMSDataMap(strSMSFrame, arrSMSData);
	 ...
	 * Last generated by Orchestration Designer at: 2017-AUG-28  11:20:47 AM
	 */
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:True", true).setDebugId(6162)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_CRITICAL, "WS Down|Account Information flow|AccessHost_UnbilledInfo |", "EPM_Alarm:Description", true).setDebugId(6163));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "Constants:False", false).setDebugId(6164));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(519)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("CallData:transferReasonCode", "Constants:TR_0038", false).setDebugId(4745));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:isLinkDown", "Constants:no", false).setDebugId(5852));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "Flag:isFromInteractionHistory", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(522)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("AccountInformation-MainMenu", "LinkDown_MainMenu").setDebugId(518));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("AccountInformation-PushSMSUnbilledInfoLinkDown", "LinkDown_PushSMS").setDebugId(524));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("CallData:transferReasonCode", "Constants:TR_0039", false).setDebugId(4746));
			actions.add(new com.avaya.sce.runtime.Next("AccountInformation-Initialize_PA_0014", "Continue").setDebugId(521));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

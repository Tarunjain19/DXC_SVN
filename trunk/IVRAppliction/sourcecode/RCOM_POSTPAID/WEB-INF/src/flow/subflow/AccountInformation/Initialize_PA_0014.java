...
public class Initialize_PA_0014 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			/*Initializing audio*/
			strInitialAudios = appProperties.getIVRProp(strApplicationName+Constants.HYPEN+Constants.PA_0014);
			strInitialAudios = dynamicMenu.playPrompt(dynamicValueList, strInitialAudios, "NA", info);

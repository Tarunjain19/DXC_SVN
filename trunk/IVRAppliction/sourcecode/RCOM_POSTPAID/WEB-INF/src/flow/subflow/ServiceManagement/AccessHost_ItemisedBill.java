 ...
 */
public class AccessHost_ItemisedBill extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		ResItemizedBillActivation resItemizedBillActivation = null;
		...
		try
		{
			...
			reqItemisedBillActivation = new ReqItemisedBillActivation();
			reqItemisedBillActivation.setMDN(mdn);
			
			info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Activate Itemised bill Host request :: "+reqItemisedBillActivation.toString());
			
			//Response Processing......
			webServiceManager = new IVRWebServiceImpl();
			try{
			resItemizedBillActivation = webServiceManager.executeItemisedBillActivation(objIVRData, reqItemisedBillActivation);
			}
			catch(Exception e)
			{
			...
			if(resItemizedBillActivation!=null){
				if((resItemizedBillActivation.getResponseCode()).equals(Constants.zero)){
					...
					mySession.getVariableField(IProjectVariables.CALL_DATA, IProjectVariables.CALL_DATA_FIELD_MSG_TEXT).setValue(resItemizedBillActivation.getMessageText());
					
					strSMSFrame = appProperties.getIVRProp(Constants.ITEMISED_BILL_Success);
				...
				}else if((resItemizedBillActivation.getResponseCode()).equals(Constants.one)){
					strSMSFrame = appProperties.getIVRProp(Constants.ITEMISED_BILL_Failure);
					smsHashTable = setPushSMS.generatePushSMSDataMap(strSMSFrame, arrSMSData);
					mySession.setProperty(Constants.SMSDataMap, smsHashTable);
				...
				info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Activate VAS Host response :: "+resItemizedBillActivation.getResponseCode());
			}
		}
		catch(Exception e)
		{
		...
		{
			reqItemisedBillActivation = null;
			resItemizedBillActivation = null;
	 ...
	 * Last generated by Orchestration Designer at: 2015-MAY-06  07:11:56 PM
	 */
	public AccessHost_ItemisedBill() {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("CallData:globalMenuType", "Constants:FeatureLevel", false).setDebugId(5194));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:True", true).setDebugId(6465)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_CRITICAL, "WS Down|Service Managemant flow|AccessHost_ItemisedBill|", "EPM_Alarm:Description", true).setDebugId(6466));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "Constants:False", false).setDebugId(6467));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(2316)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("CallData:transferReasonCode", "TR_0058", true).setDebugId(5901));
			actions.add(new com.avaya.sce.runtime.Next("ServiceManagement-PushSMS_PA_0047", "LinkDown").setDebugId(2314));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

		} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "Flag:isHostFailure", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(6441)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("CallData:transferReasonCode", "TR_0014", true).setDebugId(6442));
			actions.add(new com.avaya.sce.runtime.Next("ServiceManagement-Transfer", "Transfer").setDebugId(6443));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("CallData:transferReasonCode", "TR_0059", true).setDebugId(5902));
			actions.add(new com.avaya.sce.runtime.Next("ServiceManagement-PushSMS_PA_0046", "Continue").setDebugId(2318));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

...
public class SetTransferData extends com.avaya.sce.runtime.Data {
	...
	try {
			...
			/* Changed application name for prepaid callers landing on Postpaid */
			strUIApplicationName = strApplicationName;
			
			if (strReasonCode.equalsIgnoreCase("TR_0134")){
				if(strUIApplicationName.contains("RCOM"))
					strUIApplicationName = strUIApplicationName.replace("POSTPAID", "PREPAID");
				else
					strUIApplicationName = "RTL_CF_198_GSM_PREPAID";
				info.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Application name changed for Prepaid Caller :"+strUIApplicationName);	
			}
			...
			strUUI = strANI+"|"+strDNIS+"|"+strUIApplicationName+"|"+last5Menu+"|"+strReasonCode+"|"+strLanguage;
	...
	try {
			...
			/**Setting transfer Reason Code if it is not already set **/
			
			if(strReasonCode==null || strReasonCode.equals(""))
			{
				info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "TransferReasonCode not yet Set.Setting TransferReasonCode Default");
				strReasonCode = mySession.getVariableField(IProjectVariables.CONSTANTS,IProjectVariables.CONSTANTS_FIELD_TR___0_0_1_6).getStringValue();
				info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "TransferReasonCode: "+strReasonCode);
			}
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Call UUI", "CallData:uuiData").setDebugId(5977));
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:True", true).setDebugId(6884)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_CRITICAL, "DB Down|Main Flow|SetTransferData|", "EPM_Alarm:Description", true).setDebugId(6885));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "Constants:False", false).setDebugId(6886));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(3099)).evaluate(mySession)) {
		...
		actions = new java.util.ArrayList(1);
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Prepare AAI", "CallData:uuiData").setDebugId(5976));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

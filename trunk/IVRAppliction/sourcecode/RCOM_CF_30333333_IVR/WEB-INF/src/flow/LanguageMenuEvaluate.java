...
public class LanguageMenuEvaluate extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Language Menu Return Code", "LanguageMenu:ReturnCode").setDebugId(8764));
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Language Menu Return Value", "LanguageMenu:Value").setDebugId(8765));
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("dmInputParameter:initialPrompt", "HotFlashName", false).setDebugId(15177));
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Initial Prompt", "dmInputParameter:initialPrompt").setDebugId(15178));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "LanguageMenu:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(8766)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.SetCurrentLanguage("LanguageMenu:Value", false).setDebugId(8767));
			actions.add(new com.avaya.sce.runtime.Next("HotFlash_199", "(Language Selected)").setDebugId(8768));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions.add(new com.avaya.sce.runtime.Next("HotFlash_199", "(Exceeded)").setDebugId(8772));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		{
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG,"Customer Exceeded tries in language menu, hence setting default circle language"+propetyKey);
			String defaultLang = mySession.getCurrentLanguage();
			
			propetyKey = AppConstant.PROPERTY + appName + AppConstant.SEPERATOR_UNDERSCORE + defaultLang;

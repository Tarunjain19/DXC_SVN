 ...
 */
public class AccessDBPrepaidService extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			String PrepaidOffersMenuRetVal = mySession.getVariableField(IProjectVariables.PREPAID_SERVICES__MN, (IProjectVariables.PREPAID_SERVICES__MN_FIELD_VALUE)).getStringValue();
			...
			key = AppConstant.PREPAID_SERVICES + AppConstant.SEPERATOR_UNDERSCORE + PrepaidOffersMenuRetVal + AppConstant.SEPERATOR_UNDERSCORE + serviceType;
			...
			if(htPrepaidPostPaidServiceInfo != null && htPrepaidPostPaidServiceInfo.size() != 0)
			{
				...
				{
					key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.MN_0036;
					...
					initialPrompt=DynamicMenu.playPrompt(Offerlist, initialPrompt, ""+Offerlist.size(), AppConstant.MN_0036, trace);
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(14830)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:HostResult", "constant:error", false).setDebugId(14833));
			actions.add(new com.avaya.sce.runtime.Next("PrepaidOffers_MN", "(Success)").setDebugId(14834));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferReason", "TR_0065", true).setDebugId(14934));
			actions.add(new com.avaya.sce.runtime.Next("LinkDown", "(Timeout)").setDebugId(12815));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

 ...
 */
public class ConfirmMobNo_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:ConfirmMobNo_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

...
public class CallStart extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "ANI :", "session:ani").setDebugId(9));
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "DNIS :", "session:dnis").setDebugId(10));
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Application Name", "AppName").setDebugId(11));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition").setDebugId(12)).evaluate(mySession, bo1)) {
			actions = new java.util.ArrayList(4);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:ani", "session:ani", false).setDebugId(16));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:dnis", "session:dnis", false).setDebugId(17));
			actions.add(new com.avaya.sce.runtime.Next("IVR_DNIS_Routing", "Ani&Dnis").setDebugId(18));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			/**ANI Override for Testing**/
			
			String MaskedANI = null;
			...
			if(ANI.length()>10)
			{
				...
				System.out.println("ANI After manipulation "+ANI);
			}
			
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO,"Ani returned : " +mySession.getVariableField(IProjectVariables.SESSION, IProjectVariables.SESSION_FIELD_ANI).getStringValue());
			if(null != ANI && !(AppConstant.EMPTY_STRING.equalsIgnoreCase(ivrProperties.getIVRProp(ANI))) && !(AppConstant.N.equalsIgnoreCase(ivrProperties.getIVRProp(ANI))))
			{
				MaskedANI = ivrProperties.getIVRProp(ANI);
				trace.writeln(ITraceInfo.TRACE_LEVEL_INFO,"Ani overridden to : " +MaskedANI);
				mySession.getVariableField(IProjectVariables.SESSION, IProjectVariables.SESSION_FIELD_ANI).setValue(MaskedANI);
			}

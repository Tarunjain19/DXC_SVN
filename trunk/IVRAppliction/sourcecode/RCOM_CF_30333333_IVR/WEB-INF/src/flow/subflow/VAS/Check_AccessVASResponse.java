...
public class Check_AccessVASResponse extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(362)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "appVariables:ActivateVASResponse", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "0", false).setDebugId(363)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("VAS-Set_PA_0033", "Yes").setDebugId(364));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "appVariables:ActivateVASResponse", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "1", false).setDebugId(365)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferReason", "TR_0023", true).setDebugId(366));
				actions.add(new com.avaya.sce.runtime.Next("VAS-VAS_Linkdown", "NetworkFailure").setDebugId(367));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("VAS-PA_0083", "No").setDebugId(369));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferReason", "TR_0023", true).setDebugId(371));
			actions.add(new com.avaya.sce.runtime.Next("VAS-VAS_Linkdown", "Timeout").setDebugId(372));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

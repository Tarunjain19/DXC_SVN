...
public class Set_PA_0033 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("VAS-PA_0033", "Default");
		next.setDebugId(949);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.PA_0019;
			...
			initialPrompt=DynamicMenu.playPrompt(dynamicWave, initialPrompt, AppConstant.NA, AppConstant.PA_0019, trace);

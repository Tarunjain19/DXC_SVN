...
public class executePackAndPlanDetails extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(6309)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("PostpaidAccountInformation-TGSM_PA_0026Copy", "success").setDebugId(6311));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferReason", "TR_0029", true).setDebugId(6313));
			actions.add(new com.avaya.sce.runtime.Next("PostpaidAccountInformation-Linkdown", "error").setDebugId(6314));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

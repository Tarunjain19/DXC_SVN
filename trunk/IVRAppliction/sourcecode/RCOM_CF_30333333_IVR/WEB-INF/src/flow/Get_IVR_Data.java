 ...
 */
public class Get_IVR_Data extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("DataOffersMenu");
		next.setDebugId(11720);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.MN_0030;
			...
			initialPrompt=DynamicMenu.playPrompt(offerPhrase, initialPrompt, ""+offerPhrase.size(), AppConstant.MN_0030, trace);

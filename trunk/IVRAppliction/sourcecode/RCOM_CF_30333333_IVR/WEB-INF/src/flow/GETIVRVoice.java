 ...
 * Last generated by Orchestration Designer at: 2015-APR-20  12:37:10 AM
 */
public class GETIVRVoice extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("VoiceOffersMenu", "Default");
		next.setDebugId(11712);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.MN_0028;
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Voice Offer initial Prompt Before Dynamic Insertion:: "+initialPrompt);
			...
			initialPrompt=DynamicMenu.playPrompt(offerPhrase, initialPrompt, ""+offerPhrase.size(), AppConstant.MN_0028, trace);
			
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Voice Offer initial Prompt :: "+initialPrompt);
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Voice Offer Selection Grammar :: "+offerID);

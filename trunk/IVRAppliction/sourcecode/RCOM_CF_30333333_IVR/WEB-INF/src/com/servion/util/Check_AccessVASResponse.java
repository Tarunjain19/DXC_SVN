...
public class Check_AccessVASResponse extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(5331)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "appVariables:ActivateVASResponse", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "0", false).setDebugId(5343)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("InternetAndVAS-Set_PA_0033", "Yes").setDebugId(5342));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "appVariables:ActivateVASResponse", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "1", false).setDebugId(5596)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferReason", "TR_0023", true).setDebugId(5622));
				actions.add(new com.avaya.sce.runtime.Next("InternetAndVAS-LinkDown", "NetworkFailure").setDebugId(5597));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("InternetAndVAS-PA_0083", "No").setDebugId(5332));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferReason", "TR_0023", true).setDebugId(5623));
			actions.add(new com.avaya.sce.runtime.Next("InternetAndVAS-LinkDown", "Timeout").setDebugId(5522));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

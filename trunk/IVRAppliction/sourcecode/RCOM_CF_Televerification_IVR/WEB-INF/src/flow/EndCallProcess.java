...
public class EndCallProcess extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			circle = mySession.getVariableField(IProjectVariables.CALL_DATA, IProjectVariables.CALL_DATA_FIELD_CIRCLE).getStringValue(); 
			if(null != circle &&  (!circle.equalsIgnoreCase(Constants.EMPTY_STRING)))

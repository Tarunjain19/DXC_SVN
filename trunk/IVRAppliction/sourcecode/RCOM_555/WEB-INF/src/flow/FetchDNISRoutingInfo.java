		...
		try {
			...
			if(ivrRoutingInfo!=null){
				...
				if(ivrRoutingInfo.getCircle()!=null){
					...
					mySession.getVariableField(IProjectVariables.PREPAID__APP_VARIABLES, IProjectVariables.PREPAID__APP_VARIABLES_FIELD_CIRCLE_ID).setValue(ivrRoutingInfo.getCircle());

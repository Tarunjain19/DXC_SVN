...
import com.rcom.hni.model.IVRRoutingInfo;
...
public class InitializeVariables extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			logger = Logger.getLogger(Constants.LOGGER_NAME_CALLLEVEL);
			...
			info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Application Name : "+ivrConfigInstance.getIVRProp(Constants.APPLICATION_NAMES));
			mySession.getVariableField(IProjectVariables.APP_NAME).setValue(ivrConfigInstance.getIVRProp(Constants.APPLICATION_NAMES));
			...
			if(!ivrConfigInstance.getIVRProp(strANI).equalsIgnoreCase("N"))
			...
			mySession.getVariableField(IProjectVariables.PREPAID__APP_VARIABLES, IProjectVariables.PREPAID__APP_VARIABLES_FIELD_ANI).setValue(strANI);

...
public class Get_IVR_STV extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Prepaid_appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Prepaid_constant:success", true).setDebugId(11451)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_Start-Get_STVMenu", "success").setDebugId(11452));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:transferCode", "TR_0111", true).setDebugId(13727));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_Start-LinkDown", "LinkDown").setDebugId(11454));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

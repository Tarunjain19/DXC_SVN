 ...
 */
public class Push_SMS_topup extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid_Start-PuchSMS_TopUp1");
		next.setDebugId(10822);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			dynamicValueList.add(amount);
			dynamicValueList.add(talkTime);

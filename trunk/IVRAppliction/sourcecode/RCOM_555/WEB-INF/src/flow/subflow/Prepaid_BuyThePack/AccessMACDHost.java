...
public class AccessMACDHost extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Pay Core Balance Host Details", "Prepaid_appVariables:HostResult").setDebugId(645));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Prepaid_appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Prepaid_constant:success", true).setDebugId(646)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_Flag:PushSMSDone", "Prepaid_constant:Key_False", false).setDebugId(795));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_BuyThePack-PayCoreBalSuccess", "Success").setDebugId(650));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			com.avaya.sce.runtime.Expression be1 = new com.avaya.sce.runtime.Expression("expression1", "Prepaid_appVariables:responseCode", com.avaya.sce.runtime.Expression.STRING_NOT_EQUAL_IGNORE, "Prepaid_constant:one", true);
			bo1.addExpression(be1);
			com.avaya.sce.runtime.Expression be2 = new com.avaya.sce.runtime.Expression("expression2", "Prepaid_appVariables:responseCode", com.avaya.sce.runtime.Expression.STRING_NOT_EQUAL_IGNORE, "Prepaid_constant:zero", true);
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition").setDebugId(2030)).evaluate(mySession, bo1)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.Next("Prepaid_BuyThePack-PayCoreBalFailure", "other").setDebugId(2035));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:transferCode", "TR_0070", true).setDebugId(2846));
				actions.add(new com.avaya.sce.runtime.Next("Prepaid_BuyThePack-Linkdown", "LinkDown").setDebugId(652));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			packName = mySession.getVariableField(IProjectVariables.PREPAID__APP_VARIABLES,IProjectVariables.PREPAID__APP_VARIABLES_FIELD_PACK_NAME).getStringValue();
	...
	public void initialPrompt (SCESession mySession){
		...
		packWave = mySession.getVariableField(IProjectVariables.PREPAID__APP_VARIABLES,IProjectVariables.PREPAID__APP_VARIABLES_FIELD_PACK_WAVE).getStringValue();

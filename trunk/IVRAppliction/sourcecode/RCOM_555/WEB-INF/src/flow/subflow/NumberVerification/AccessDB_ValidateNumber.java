...
import com.rcom.hni.model.ValidateMobileNumber;
			...
			if(validateMobileNumber.getValidationFlag()!=null){
				...
				if(strValidationFlag.equalsIgnoreCase(Constants.Success)){
					if(validateMobileNumber.getServiceType()!=null){
						...
						if(((strServiceType).contains(Constants.TRIPLEFIVE))||((strServiceType).contains(Constants.small_POSTPAID))||((strServiceType).contains("POST"))||((strServiceType).contains("post")))
							mySession.getVariableField(IProjectVariables.VALIDATE_OTHER_NUMBER, IProjectVariables.VALIDATE_OTHER_NUMBER_FIELD_NUMBER_TYPE).setValue(Constants.TRIPLEFIVE);

...
public class executeLastRechargeDetails extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Prepaid_appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Prepaid_constant:success", true).setDebugId(1979)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:transferCode", "TR_0079", true).setDebugId(3030));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_Account_Information-Set_TGSM_PA_0025", "success").setDebugId(1984));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:transferCode", "TR_0080", true).setDebugId(3031));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_Account_Information-TGSM_PA_0081", "network_failure").setDebugId(1986));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			lastRechargeDetails = mySession.getVariable(IProjectVariables.PREPAID__LAST_RECHARGE_AND_PLAN_DETAILS);
			...
			*//** Ends Here **/
			...
			if(resLastRechargeDetails!=null){
				...
				if(listRechargeDetails!=null){
					...
					lastRechargeDetails.getComplexVariable().getField(IProjectVariables.PREPAID__LAST_RECHARGE_AND_PLAN_DETAILS_FIELD_SMS_LAST_RECHARGE_DATA).setValue(rechargeDate);
				...
				lastRechargeDetails.getComplexVariable().getField(IProjectVariables.PREPAID__LAST_RECHARGE_AND_PLAN_DETAILS_FIELD_RESPONSE_CODE).setValue(resLastRechargeDetails.getResponseCode());
				lastRechargeDetails.getComplexVariable().getField(IProjectVariables.PREPAID__LAST_RECHARGE_AND_PLAN_DETAILS_FIELD_LAST_RECHARGE_AMOUNT).setValue(rechargeAmount);
				lastRechargeDetails.getComplexVariable().getField(IProjectVariables.PREPAID__LAST_RECHARGE_AND_PLAN_DETAILS_FIELD_LAST_RECHARGE_DATE).setValue(rechargeDate);

...
public class HOST_Get_IVRData extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Prepaid_appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Prepaid_constant:success", true).setDebugId(13688)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:VASCount", "0", true).setDebugId(13689));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_Start-Get_IVR_Data", "success").setDebugId(13690));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:transferCode", "TR_0065", true).setDebugId(13692));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_Start-LinkDown", "LinkDown").setDebugId(13693));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

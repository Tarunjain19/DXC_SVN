package flow.subflow.Prepaid_HotFlash;
...
public class Get_HotFlash_Message extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Hot Flash Enable Disable Flag :", "Prepaid_HotFlashInfo:Flag").setDebugId(145));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Prepaid_HotFlashInfo:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Prepaid_constant:Key_true", true).setDebugId(142)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_HotFlash-Start_HotFlash").setDebugId(7));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_HotFlash-Return", "Return").setDebugId(144));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			nodeID = mySession.getVariableField(IProjectVariables.PREPAID__HOT_FLASH_INFO,IProjectVariables.PREPAID__HOT_FLASH_INFO_FIELD_ANNO_ID).getStringValue();
				...
				if(objHotFlashInfo!=null){
					...
					if(AppConstant.Y.equalsIgnoreCase(hotFlashFlag)){
						...
						*//**Remove Time**//*
						...
						mySession.getVariableField(IProjectVariables.PREPAID__DM_INPUT_PARAMETER,IProjectVariables.PREPAID__DM_INPUT_PARAMETER_FIELD_INITIAL_PROMPT).setValue(phraseID);
		...
		mySession.getVariableField(IProjectVariables.PREPAID__HOT_FLASH_INFO,IProjectVariables.PREPAID__HOT_FLASH_INFO_FIELD_FLAG).setValue(flagPlayHotFlash);
	}
}

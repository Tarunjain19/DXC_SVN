 ...
 */
public class STVPack_PushSMS extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("Prepaid_PushSMS-Return", "Prepaid_Start-RC_TypeSTV");
		return exitPoints;
	}
}

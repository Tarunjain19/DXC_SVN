...
public class Set_MN_0010 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid_VAS-MN_0010", "Default");
		next.setDebugId(3224);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Prepaid_dmInputParameter:initialPrompt", com.avaya.sce.runtime.Expression.IS_EMPTY).setDebugId(5600)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_VAS-LinkDown", "linkdown").setDebugId(5601));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.MN_0010;

 ...
 * Last generated by Orchestration Designer at: 2015-MAY-21  08:48:26 PM
 */
public class EndCallProcess extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			if(mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_IS_HNICALLER).getBooleanValue() == true)
			{
				callInfo.setCATEGORY(Constants.HNI);
			}
			else
			{
				callInfo.setCATEGORY(Constants.NORMAL);
			}

 ...
 */
public class DB_DSS_CBB_ValidationComplaint extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2015-MAY-24  04:58:39 PM
	 */
	public DB_DSS_CBB_ValidationComplaint() {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:DB_Result", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constants:success", true).setDebugId(6243)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "appVariables:CBB_Status", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constants:CBB_Status_Success", true).setDebugId(6244)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TransferCodes:DAKC_TR_0007", false).setDebugId(6245));
				actions.add(new com.avaya.sce.runtime.Next("Check_SRC", "(CBB Success)").setDebugId(6246));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TransferCodes:DAKC_TR_0008", false).setDebugId(6248));
				actions.add(new com.avaya.sce.runtime.Next("Check_SRC", "(CBB Failure)").setDebugId(6249));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TransferCodes:DAKC_TR_0062", false).setDebugId(6251));
			actions.add(new com.avaya.sce.runtime.Next("Linkdown_PP", "(Host timeout)").setDebugId(6252));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

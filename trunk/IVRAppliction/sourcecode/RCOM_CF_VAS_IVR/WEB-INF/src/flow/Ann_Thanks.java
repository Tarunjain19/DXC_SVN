 ...
 */
public class Ann_Thanks extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Ann_Thanks", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

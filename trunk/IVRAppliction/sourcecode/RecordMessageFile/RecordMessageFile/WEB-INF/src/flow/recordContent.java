 ...
 */
public class recordContent extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("initAfterRecording");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Record getRecord(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("Recording_AskForRecording", ""));

		// build events for the record item: "recordContent"
		events = new java.util.ArrayList();
		event = new com.avaya.sce.runtime.OnDisconnect("returnOnDisconnect", true);
		events.add(event);

		// create the record item
		record = new com.avaya.sce.runtime.Record("recordContent", true, "300s", true, "3s", true, com.avaya.sce.runtime.Record.WAV_TYPE, com.avaya.sce.runtime.Record.RECORDMODE_AUDIO, promptNames, grammarInfo, events);
		return record;
	}
	/**

 ...
 * Last generated by Orchestration Designer at: 2017-OCT-10  11:39:21 AM
 */
public class askInputFileNumber extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("Recording_AskFileNumber", ""));

		// build the list of grammar information objects for the field
		String ___tempGrammarName = null;
		grammarInfo = new java.util.ArrayList(2);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("FileNumber", "1.0"));
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("NonDigitHandle", "1.0"));


		// build events for the field: "askInputFileNumber"
		events = new java.util.ArrayList(1);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("selectionNoInputBegining", 0, true, "noInput"));
		events.add(event);
		properties = new java.util.ArrayList();

		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("askInputFileNumber", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("checkInput");
		return submit;
	}
	/**

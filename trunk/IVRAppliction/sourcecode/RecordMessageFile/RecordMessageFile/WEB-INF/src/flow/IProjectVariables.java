...
public interface IProjectVariables {
	...
	public static final String RECORDING_FILE_NAME = "RecordingFileName";
	public static final String RETURN_STATE = "ReturnState";
	public static final String RETRY_COUNTER__NOMATCH = "RetryCounter_nomatch";
	public static final String SELECTION_AFTER_RECORDING = "selectionAfterRecording";
	public static final String SELECTION_AFTER_SAY_FILE_CONTENT = "selectionAfterSayFileContent";
	public static final String NO_MATCH__DESC = "NoMatch_Desc";
	public static final String INVALID_TYPE = "InvalidType";
	public static final String COMMON = "Common";
	public static final String RECORDING_FILE_PATH = "RecordingFilePath";
	public static final String RETURN_STATE__DESC = "ReturnState_Desc";
	public static final String RETRY_COUNTER__NOINPUT = "RetryCounter_noinput";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String NEW_RECORDED_FILE_PATH = "NewRecordedFilePath";
	public static final String SESSION = "session";
	public static final String ASK_INPUT_FILE_NUMBER = "askInputFileNumber";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String NO_INPUT__DESC = "NoInput_Desc";
	public static final String FILE_NOT_FIND__DESC = "fileNotFind_Desc";
	...
	public static final String RECORDING_FILE_NAME_FIELD_FIFTH_CHAR = "fifthChar";
	public static final String RECORDING_FILE_NAME_FIELD_FIRST_CHAR = "firstChar";
	public static final String RECORDING_FILE_NAME_FIELD_FOURTH_CHAR = "fourthChar";
	public static final String RECORDING_FILE_NAME_FIELD_SECOND_CHAR = "secondChar";
	public static final String RECORDING_FILE_NAME_FIELD_THIRD_CHAR = "thirdChar";
	public static final String SELECTION_AFTER_RECORDING_FIELD_CONFIDENCE = "confidence";
	public static final String SELECTION_AFTER_RECORDING_FIELD_INPUTMODE = "inputmode";
	public static final String SELECTION_AFTER_RECORDING_FIELD_INTERPRETATION = "interpretation";
	public static final String SELECTION_AFTER_RECORDING_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String SELECTION_AFTER_RECORDING_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String SELECTION_AFTER_RECORDING_FIELD_UTTERANCE = "utterance";
	public static final String SELECTION_AFTER_RECORDING_FIELD_VALUE = "value";
	public static final String SELECTION_AFTER_SAY_FILE_CONTENT_FIELD_CONFIDENCE = "confidence";
	public static final String SELECTION_AFTER_SAY_FILE_CONTENT_FIELD_INPUTMODE = "inputmode";
	public static final String SELECTION_AFTER_SAY_FILE_CONTENT_FIELD_INTERPRETATION = "interpretation";
	public static final String SELECTION_AFTER_SAY_FILE_CONTENT_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String SELECTION_AFTER_SAY_FILE_CONTENT_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String SELECTION_AFTER_SAY_FILE_CONTENT_FIELD_UTTERANCE = "utterance";
	public static final String SELECTION_AFTER_SAY_FILE_CONTENT_FIELD_VALUE = "value";
	public static final String COMMON_FIELD_ACTIVITY = "Activity";
	public static final String COMMON_FIELD_DEFAULT_VDN = "DefaultVDN";
	public static final String COMMON_FIELD_ENV = "Env";
	public static final String COMMON_FIELD_MAX__NOINPUT = "Max_noinput";
	public static final String COMMON_FIELD_MAX__NOMATCH = "Max_nomatch";
	public static final String COMMON_FIELD_TIMEOUT = "Timeout";
	public static final String RETURN_STATE__DESC_FIELD_BACKTO_MAIN_MENU = "BacktoMainMenu";
	public static final String RETURN_STATE__DESC_FIELD_ON_DISCONNECT = "OnDisconnect";
	public static final String RETURN_STATE__DESC_FIELD_RECORD_COMPLETE = "RecordComplete";
	...
	public static final String ASK_INPUT_FILE_NUMBER_FIELD_COLUMN_0 = "Column0";
	public static final String ASK_INPUT_FILE_NUMBER_FIELD_CONFIDENCE = "confidence";
	public static final String ASK_INPUT_FILE_NUMBER_FIELD_INPUTMODE = "inputmode";
	public static final String ASK_INPUT_FILE_NUMBER_FIELD_INTERPRETATION = "interpretation";
	public static final String ASK_INPUT_FILE_NUMBER_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String ASK_INPUT_FILE_NUMBER_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String ASK_INPUT_FILE_NUMBER_FIELD_UTTERANCE = "utterance";
	public static final String ASK_INPUT_FILE_NUMBER_FIELD_VALUE = "value";
	...
	public static final String RECORD_CONTENT_FIELD_CONFIDENCE = "confidence";
	public static final String RECORD_CONTENT_FIELD_DURATION = "duration";
	public static final String RECORD_CONTENT_FIELD_MAXTIME = "maxtime";
	public static final String RECORD_CONTENT_FIELD_SIZE = "size";
	public static final String RECORD_CONTENT_FIELD_TERMCHAR = "termchar";
	public static final String RECORD_CONTENT_FIELD_UTTERANCE = "utterance";
	public static final String RECORD_CONTENT_FIELD_VALUE = "value";

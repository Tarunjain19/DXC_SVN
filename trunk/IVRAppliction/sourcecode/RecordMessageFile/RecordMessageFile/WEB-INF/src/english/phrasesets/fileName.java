 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2017-OCT-09  03:48:35 PM
 */
public class fileName extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: fileNameByUser
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "fileNameByUser", "fileNameByUser.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(fileName.PHRASE_MAP, phraseName));
	}
}

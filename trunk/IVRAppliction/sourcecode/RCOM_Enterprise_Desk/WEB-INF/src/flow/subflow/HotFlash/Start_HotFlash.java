 ...
 */
public class Start_HotFlash extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DEFAULT", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_isAnnouncement", "true", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_AnnounceID", "HotFlashInfo:annoID", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_DialogName", "HotFlash", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);

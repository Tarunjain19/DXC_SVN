 ...
 */
public class LangSelect_RED_MN_0003_0001 extends com.avaya.sce.runtime.Invoke {
	 ...
	 * Last generated by Orchestration Designer at: 2015-MAR-17  02:43:20 PM
	 */
	public LangSelect_RED_MN_0003_0001() {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_globalPropertyFileName", "DMProperties:globalProperty", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:RED_MN_0003_property", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_initialPrompt", "DMProperties:initialPrompt", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionCount", "3", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionDynamicValues", "DMProperties:moreOption", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

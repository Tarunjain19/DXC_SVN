 ...
 * Last generated by Orchestration Designer at: 2015-MAR-17  02:56:15 PM
 */
public class BlindTransfer extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("EndProcess");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Transfer getTransfer(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		transfer = new com.avaya.sce.runtime.Transfer("BlindTransfer", "TransferVDN1", com.avaya.sce.runtime.Transfer.VARIABLE, null, "0s", com.avaya.sce.runtime.Transfer.CONSTANT, "0s", com.avaya.sce.runtime.Transfer.TransferType.BLIND, promptNames, null, this, "", com.avaya.sce.runtime.Transfer.CONSTANT, false, false);
		return transfer;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Transferred to ", "TransferVDN1"));
		return(list);
	}
	/**

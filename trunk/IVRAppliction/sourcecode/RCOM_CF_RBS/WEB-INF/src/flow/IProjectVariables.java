...
public interface IProjectVariables {
	...
	public static final String NON_BUSINESS_HOUR__PP = "NonBusinessHour_PP";
	public static final String TRANSFER__POINTS = "TRANSFER_POINTS";
	public static final String BUSINESS_HOUR__PP = "BusinessHour_PP";
	public static final String DM__PROPERTY_FILE_NAME = "DM_propertyFileName";
	public static final String TRANSFER__POINT = "TRANSFER_POINT";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String SESSION = "session";
	public static final String APP_VARIABLES = "appVariables";
	public static final String TRANSFER__VDN = "TRANSFER_VDN";
	...
	public static final String DM_INPUT_PARAMETER_FIELD_DM__GLOBAL_PROPERTY_FILE_NAME = "DM_globalPropertyFileName";
	public static final String DM_INPUT_PARAMETER_FIELD_PROPERTY_FILE_LOCATION = "propertyFileLocation";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_ANNOUNCE_ID = "AnnounceID";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_CONFIDENCE = "Confidence";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_CONFIRMATION_REMAINING = "ConfirmationRemaining";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_DIALOG_NAME = "DialogName";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_INPUT_TYPE = "InputType";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_MENU_END_TIME = "MenuEndTime";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_MENU_ID = "MenuID";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_MENU_START_TIME = "MenuStartTime";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_N_BEST_VALUES = "nBestValues";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_NOINPUT_REMAINING = "NoinputRemaining";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_NOMATCH_REMAINING = "NomatchRemaining";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_OTHER_SLOT = "OtherSlot";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_RECORDED__UTTERANCE = "Recorded_Utterance";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_RETURN_CODE = "ReturnCode";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_SPECIFIC_SLOT = "SpecificSlot";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_UTTERANCE = "Utterance";
	public static final String NON_BUSINESS_HOUR__PP_FIELD_VALUE = "Value";
	public static final String TRANSFER__POINTS_FIELD_DUMMY = "DUMMY";
	public static final String BUSINESS_HOUR__PP_FIELD_ANNOUNCE_ID = "AnnounceID";
	public static final String BUSINESS_HOUR__PP_FIELD_CONFIDENCE = "Confidence";
	public static final String BUSINESS_HOUR__PP_FIELD_CONFIRMATION_REMAINING = "ConfirmationRemaining";
	public static final String BUSINESS_HOUR__PP_FIELD_DIALOG_NAME = "DialogName";
	public static final String BUSINESS_HOUR__PP_FIELD_INPUT_TYPE = "InputType";
	public static final String BUSINESS_HOUR__PP_FIELD_MENU_END_TIME = "MenuEndTime";
	public static final String BUSINESS_HOUR__PP_FIELD_MENU_ID = "MenuID";
	public static final String BUSINESS_HOUR__PP_FIELD_MENU_START_TIME = "MenuStartTime";
	public static final String BUSINESS_HOUR__PP_FIELD_N_BEST_VALUES = "nBestValues";
	public static final String BUSINESS_HOUR__PP_FIELD_NOINPUT_REMAINING = "NoinputRemaining";
	public static final String BUSINESS_HOUR__PP_FIELD_NOMATCH_REMAINING = "NomatchRemaining";
	public static final String BUSINESS_HOUR__PP_FIELD_OTHER_SLOT = "OtherSlot";
	public static final String BUSINESS_HOUR__PP_FIELD_RECORDED__UTTERANCE = "Recorded_Utterance";
	public static final String BUSINESS_HOUR__PP_FIELD_RETURN_CODE = "ReturnCode";
	public static final String BUSINESS_HOUR__PP_FIELD_SPECIFIC_SLOT = "SpecificSlot";
	public static final String BUSINESS_HOUR__PP_FIELD_UTTERANCE = "Utterance";
	public static final String BUSINESS_HOUR__PP_FIELD_VALUE = "Value";
	public static final String DM__PROPERTY_FILE_NAME_FIELD_BUSINESS_HOUR__PP = "BusinessHour_PP";
	...
	public static final String CONSTANTS_FIELD_IS_CALLED_WITHIN_BUSINESS_HOURS = "IsCalledWithinBusinessHours";

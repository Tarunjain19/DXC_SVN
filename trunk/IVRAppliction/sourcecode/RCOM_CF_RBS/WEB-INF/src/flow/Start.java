 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2015-MAR-18  03:47:24 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2020-FEB-26  04:34:30 PM
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.DM_INPUT_PARAMETER_FIELD_DM__GLOBAL_PROPERTY_FILE_NAME,
		...
		variableFields = new String[] {
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_ANNOUNCE_ID,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_CONFIDENCE,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_CONFIRMATION_REMAINING,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_DIALOG_NAME,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_INPUT_TYPE,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_MENU_END_TIME,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_MENU_ID,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_MENU_START_TIME,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_N_BEST_VALUES,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_NOINPUT_REMAINING,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_NOMATCH_REMAINING,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_OTHER_SLOT,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_RECORDED__UTTERANCE,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_RETURN_CODE,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_SPECIFIC_SLOT,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_UTTERANCE,
			IProjectVariables.NON_BUSINESS_HOUR__PP_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.NON_BUSINESS_HOUR__PP, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.TRANSFER__POINTS_FIELD_DUMMY };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.TRANSFER__POINTS, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_ANNOUNCE_ID,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_CONFIDENCE,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_CONFIRMATION_REMAINING,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_DIALOG_NAME,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_INPUT_TYPE,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_MENU_END_TIME,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_MENU_ID,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_MENU_START_TIME,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_N_BEST_VALUES,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_NOINPUT_REMAINING,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_NOMATCH_REMAINING,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_OTHER_SLOT,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_RECORDED__UTTERANCE,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_RETURN_CODE,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_SPECIFIC_SLOT,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_UTTERANCE,
			IProjectVariables.BUSINESS_HOUR__PP_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.BUSINESS_HOUR__PP, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.DM__PROPERTY_FILE_NAME_FIELD_BUSINESS_HOUR__PP,
			IProjectVariables.DM__PROPERTY_FILE_NAME_FIELD_NON_BUSINESS_HOUR__PP };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.DM__PROPERTY_FILE_NAME, variableFields, new String[] {"BusinessHour_PP.properties", "NonBusinessHour_PP.properties"}, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TRANSFER__POINT, "", null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.APP_VARIABLES, variableFields, new String[] {"", "", "", "RBS_TR_0001", "", ""}, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TRANSFER__VDN, "null", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.CONSTANTS_FIELD_IS_CALLED_WITHIN_BUSINESS_HOURS,
			IProjectVariables.CONSTANTS_FIELD_YES };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CONSTANTS, variableFields, new String[] {"false", "yes"}, null, session, false, false );
		session.putVariable(variable);
	 ...
	 * Last generated by Orchestration Designer at: 2020-FEB-26  04:34:31 PM
	 */

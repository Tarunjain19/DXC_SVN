 ...
 * Last generated by Orchestration Designer at: 2015-MAR-18  04:02:02 PM
 */
public class GetTransferVDN extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			callInfo.setAGENTEXTN(LoadProperties.getivrconfigProp(mySession.getCurrentLanguage()+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
			mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_TRANSFER_VDN).setValue(LoadProperties.getivrconfigProp(Constants.DEFAULT_VDN));
			...
			if(transferVDNInfo.getTransferVDN1()==null){
				 mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_TRANSFER_VDN).setValue(LoadProperties.getivrconfigProp(mySession.getCurrentLanguage()+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
			}else{
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:networkError", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(376)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("EndCallProcess", "Error").setDebugId(377));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		actions = new java.util.ArrayList(1);
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Transfer Code :: ", "appVariables:reasonCode").setDebugId(378));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

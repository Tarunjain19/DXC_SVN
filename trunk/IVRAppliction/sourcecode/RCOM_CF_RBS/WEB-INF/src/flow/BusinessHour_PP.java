 ...
 */
public class BusinessHour_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		throw new com.avaya.sce.runtimecommon.SCERuntimeException("Module \"DM\" was not accessable in the development environment at code generation time. Unable to determine the input parameters for the dialog.");
	}
	/**
	...
	public java.util.Collection getOutputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		throw new com.avaya.sce.runtimecommon.SCERuntimeException("Module \"DM\" was not accessable in the development environment at code generation time. Unable to determine the output parameters for the dialog.");
	}
	/**
	...
	public String getWebAppEntryPoint(com.avaya.sce.runtimecommon.SCESession mySession) {
		throw new com.avaya.sce.runtimecommon.SCERuntimeException("Module \"DM\" was not accessable in the development environment at code generation time. Unable to determine the entry point for the dialog.");
	}
	/**

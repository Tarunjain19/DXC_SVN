 ...
 * Last generated by Orchestration Designer at: 2016-FEB-09  12:44:37 PM
 */
public class DAT_CallEndProcess extends com.avaya.sce.runtime.Data {
...
public void requestBegin(SCESession mySession) {
		...
		String strAnnouncePath =  AppConstant.EMPTY_STRING;
		...
		String dnis =  AppConstant.EMPTY_STRING;
		String ani =  AppConstant.EMPTY_STRING;
		String call_end_time =  AppConstant.EMPTY_STRING;
		String call_start_time =  AppConstant.EMPTY_STRING;
		String Registered_PhNum =  AppConstant.EMPTY_STRING;
		
		try {
			
			call_end_time = dateFormat.format(new Date());
			
			call_start_time = mySession.getVariableField(IProjectVariables.CALL__DETAILS,IProjectVariables.CALL__DETAILS_FIELD_CALL_START_TIME).getStringValue();
			mySession.getVariableField(IProjectVariables.CALL__DETAILS,IProjectVariables.CALL__DETAILS_FIELD_CALL_END_TIME).setValue(call_end_time);
			...
			Registered_PhNum = mySession.getVariableField(IProjectVariables.CALL__DETAILS,IProjectVariables.CALL__DETAILS_FIELD_REGISTERED__PH_NUM).getStringValue();
			...
			callInfo.setAPPNAME(mySession.getVariableField(IProjectVariables.APP_NAME).getStringValue());
			callInfo.setLANGCODE(mySession.getCurrentLanguage());
			callInfo.setCALLERTYPE("RGC Customer");
			callInfo.setDNIS(dnis);
			callInfo.setCLI(ani);
			callInfo.setSTARTDATETIME(call_start_time);
			callInfo.setENDDATETIME(call_end_time);
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Exception_Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:TRUE", true).setDebugId(3507)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Disconnect", "Disconnect").setDebugId(3508));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Disconnect", "Continue").setDebugId(3510));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

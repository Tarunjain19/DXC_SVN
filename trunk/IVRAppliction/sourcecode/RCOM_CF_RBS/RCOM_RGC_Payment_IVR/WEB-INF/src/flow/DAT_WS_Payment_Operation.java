 ...
 * Last generated by Orchestration Designer at: 2016-FEB-10  02:22:48 PM
 */
public class DAT_WS_Payment_Operation extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2016-FEB-10  02:22:48 PM
	 */
	public DAT_WS_Payment_Operation() {
	...
	public void requestBegin(SCESession mySession)
	{
		...
		String OTP = AppConstant.EMPTY_STRING, ExpiryDate = AppConstant.EMPTY_STRING,InstCode = AppConstant.EMPTY_STRING,InstNumber = AppConstant.EMPTY_STRING,NafNumber = AppConstant.EMPTY_STRING;
		...
		testResp = servInst.pinlessPayment(mySession.getVariableField(IProjectVariables.AUTH__KEY).getStringValue(), mySession.getVariableField(IProjectVariables.EDUID).getStringValue(), 1, mySession.getVariableField(IProjectVariables.DM__GET_REGISTERED_PH_NUM__MENU,IProjectVariables.DM__GET_REGISTERED_PH_NUM__MENU_FIELD_VALUE).getStringValue(), NafNumber, 0, InstNumber, ExpiryDate, InstCode, "RGCIVR", new StringHolder(""), new StringHolder(""));
		...
		mySession.getVariableField(IProjectVariables.WS__PAYMENT__REQUEST,IProjectVariables.WS__PAYMENT__REQUEST_FIELD_OUT__STR_MESSAGE).setValue(Result_status);
		mySession.getVariableField(IProjectVariables.WS__PAYMENT__REQUEST,IProjectVariables.WS__PAYMENT__REQUEST_FIELD_OUT__STR_RESPONSE_XML).setValue(testResp);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("DAT_Chk_Payment_Status", "Next");
		next.setDebugId(2596);
		return next;
	}
	/**

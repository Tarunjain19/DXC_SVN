 ...
 * Last generated by Orchestration Designer at: 2015-MAR-18  12:26:51 PM
 */
public class CallDisonnect extends com.avaya.sce.runtime.Disconnect {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.OnDisconnect("EndCallProcess", false);
		list.add(event);
		return(list);
	}
	/**

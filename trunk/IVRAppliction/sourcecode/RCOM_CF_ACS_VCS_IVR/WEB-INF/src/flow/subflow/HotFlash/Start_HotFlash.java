...
public class Start_HotFlash extends com.avaya.sce.runtime.Invoke {
	 ...
	 * Last generated by Orchestration Designer at: 2015-MAY-11  04:20:52 PM
	 */
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list = new java.util.ArrayList(110);

		param = new com.avaya.sce.runtime.Parameter("input_propertiesLocation", "DEFAULT", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_globalPropertyFileName", "DEFAULT", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);

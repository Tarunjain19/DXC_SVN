 ...
 * Last generated by Orchestration Designer at: 2013-OCT-15  03:48:13 PM
 */
public class InternalConfirmationPromptandCollect extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2013-OCT-15  03:48:13 PM
	 */
	public InternalConfirmationPromptandCollect() {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("yesnoSpeech", "1.0"));
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("yesnodtmf", "1.0"));


		// build events for the field: "InternalConfirmationPromptandCollect"
		...
		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("InternalConfirmationPromptandCollect", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("SetReturnValue");
		return submit;
	}
	/**

 ...
 * Last generated by Orchestration Designer at: 2013-OCT-07  04:11:52 PM
 */
public class PlayNINM extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("PlayNINMPrompt", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("RepromptCheck");
		return submit;
	}
	/**

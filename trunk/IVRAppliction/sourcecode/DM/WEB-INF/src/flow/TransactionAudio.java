 ...
 * Last generated by Orchestration Designer at: 2014-MAY-30  06:12:09 PM
 */
public class TransactionAudio extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2017-SEP-04  04:23:28 PM
	...
	public java.util.Collection getProperties(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		property = new com.avaya.sce.runtime.Property("fetchaudio", "PlayTransaction");
		list.add(property);

		property = new com.avaya.sce.runtime.Property("fetchaudiodelay", "2s");
		list.add(property);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ReportEnd");
		return submit;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		if (mySession.isAppTraceEnabled() == true){mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Transaction Audio Prompt :" +initialPrompt );}	
		if(!Constants.NONE.equalsIgnoreCase(initialPrompt)){
			...
			value = promptLocation + initialPrompt;
			if(initialPrompt.contains(Constants.HTTP)){
				value=initialPrompt;
			}
		}
		if (mySession.isAppTraceEnabled() == true){mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Transaction Final Audio :" +value );}
		inputVar.getComplexVariable().getField(IProjectVariables.INPUT_VARIABLES_FIELD_INITIAL_PROMPT).setValue(value);
	}
}

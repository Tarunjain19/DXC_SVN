/**
 * Last generated by Orchestration Designer at: 2013-OCT-15  04:39:06 PM
 */
package TEL.prompts;
...
public class PlayConfirmationRetry extends com.avaya.sce.runtime.Prompt {

	//{{START:CLASS:FIELDS
	//}}END:CLASS:FIELDS

	/**
	 * Constructor for PlayConfirmationRetry.
	 */
	public PlayConfirmationRetry() {
	 ...
	 * void updatePrompt()
	 * Last generated by Orchestration Designer at: 2017-SEP-04  04:23:56 PM
	 */
		...
		for (int i=1 ; listAudio.getCollection().hasMore(); i++){
			...
			if (audio.indexOf(Constants.TTS_COLON)!= -1){
				...
				if (textTTS.equalsIgnoreCase(Constants.INPUT_VALUE)){
					textTTS = mySession.getVariableField(IProjectVariables.CONFIRMATION_PROMPT_AND_COLLECT, IProjectVariables.CONFIRMATION_PROMPT_AND_COLLECT_FIELD_VALUE).getStringValue();						
				}
				if (textTTS.equalsIgnoreCase(Constants.INPUT_UTTERANCE)){
					textTTS = mySession.getVariableField(IProjectVariables.CONFIRMATION_PROMPT_AND_COLLECT, IProjectVariables.CONFIRMATION_PROMPT_AND_COLLECT_FIELD_UTTERANCE).getStringValue();						
				}
				...
				int posStart = audio.indexOf(Constants.COLON)+1;
				int posEnd = audio.indexOf(Constants.COLON,posStart);
				textSS=audio.substring(posStart, posEnd);
				if (textSS.equalsIgnoreCase(Constants.INPUT_VALUE)){
					textSS = mySession.getVariableField(IProjectVariables.CONFIRMATION_PROMPT_AND_COLLECT, IProjectVariables.CONFIRMATION_PROMPT_AND_COLLECT_FIELD_VALUE).getStringValue();						
				}
				
				if (textSS.equalsIgnoreCase(Constants.INPUT_UTTERANCE)){
					textSS = mySession.getVariableField(IProjectVariables.CONFIRMATION_PROMPT_AND_COLLECT, IProjectVariables.CONFIRMATION_PROMPT_AND_COLLECT_FIELD_UTTERANCE).getStringValue();						
				}
				//TYPE SELECTION
				if (audio.endsWith(Constants.NUMBER)){
					ssNumberCounter++;

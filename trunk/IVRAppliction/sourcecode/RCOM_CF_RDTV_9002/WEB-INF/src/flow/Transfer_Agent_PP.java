 ...
 */
public class Transfer_Agent_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:Transfer_Agent_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

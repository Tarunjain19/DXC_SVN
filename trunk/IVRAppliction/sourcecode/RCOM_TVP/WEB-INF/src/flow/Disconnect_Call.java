 ...
 * Last generated by Orchestration Designer at: 2015-OCT-19  12:35:27 PM
 */
public class Disconnect_Call extends com.avaya.sce.runtime.Disconnect {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.OnDisconnect("Call_endCallProcess", false);
		list.add(event);
		return(list);
	}
	/**

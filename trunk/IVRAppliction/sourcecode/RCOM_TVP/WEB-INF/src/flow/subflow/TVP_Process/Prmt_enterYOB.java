 ...
 * Last generated by Orchestration Designer at: 2016-SEP-19  02:40:36 PM
 */
public class Prmt_enterYOB extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2016-SEP-19  02:41:02 PM
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_enterYOB", ""));

		// build the list of grammar information objects for the field
		String ___tempGrammarName = null;
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("DOIGrammar", "1.0"));


		// build events for the field: "Prmt_enterYOB"
		...
		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("Prmt_enterYOB", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("TVP_Process-Dat_assignNumberPlayDOB");
		return submit;
	}
	/**

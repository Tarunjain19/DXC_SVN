 ...
 * Last generated by Orchestration Designer at: 2015-OCT-27  07:55:03 PM
 */
public class Prmt_enterDOB extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_YOB", ""));
		...
		// build events for the field: "Prmt_enterDOB"
		...
		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("Prmt_enterDOB", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("TVP_Process-Dat_DOBCheck");
		return submit;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		String Number=mySession.getVariableField(IProjectVariables.PRMT__ENTER_DOB,IProjectVariables.PRMT__ENTER_DOB_FIELD_VALUE).getStringValue();

 ...
 * Last generated by Orchestration Designer at: 2015-OCT-28  09:00:13 AM
 */
public class Mnu_NumberConfirm extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Confirm", "1", true, "exact", "ReadSIM_Number-Ret_ReadSIM", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Reenter", "2", true, "exact", "ReadSIM_Number-Dat_checkTries", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("An_SIMenteredIs", ""));

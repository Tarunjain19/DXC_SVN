 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2020-FEB-26  05:23:29 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2020-FEB-27  05:09:59 PM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("Data1");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.UC_REC_FIELD_CONFIDENCE,
			IProjectVariables.UC_REC_FIELD_DURATION,
			IProjectVariables.UC_REC_FIELD_MAXTIME,
			IProjectVariables.UC_REC_FIELD_SIZE,
			IProjectVariables.UC_REC_FIELD_TERMCHAR,
			IProjectVariables.UC_REC_FIELD_UTTERANCE,
			IProjectVariables.UC_REC_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.UC_REC, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.PLAY__RE__VAL_FIELD_FIELD_1 };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PLAY__RE__VAL, variableFields, null, session, false, false );
		session.putVariable(variable);

 ...
 * Last generated by Orchestration Designer at: 2020-FEB-27  03:47:46 PM
 */
public class untitledAnnounce1 extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("test_rec", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Rec_var");
		return submit;
	}
	/**
	...
	System.out.println("promptNames is "+promptNames);

		// create the record item
		record = new com.avaya.sce.runtime.Record("UcRec", true, "30s", true, "5s", true, com.avaya.sce.runtime.Record.WAV_TYPE, com.avaya.sce.runtime.Record.RECORDMODE_AUDIO, promptNames, grammarInfo, events);
		return record;
	}
	/**

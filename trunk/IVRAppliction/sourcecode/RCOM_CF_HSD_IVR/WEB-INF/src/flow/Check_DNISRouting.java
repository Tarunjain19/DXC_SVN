 ...
 * Last generated by Orchestration Designer at: 2015-JUL-22  08:34:21 PM
 */
public class Check_DNISRouting extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(8983)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("WelcomeAnnc", "success").setDebugId(8984));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0001", false).setDebugId(8986));
			actions.add(new com.avaya.sce.runtime.Next("IVR_CSP_CustomerVal", "linkdown").setDebugId(8987));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

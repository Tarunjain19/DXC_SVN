...
public class AccessHost_RequestDuplicateBill extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			reqDuplicateBill.setMDN(mySession.getVariableField(IProjectVariables.GET_DATA_CARD, IProjectVariables.GET_DATA_CARD_FIELD_VALUE).getStringValue());
			...
			mySession.getVariableField(IProjectVariables.POSTPAID__REQUEST_DUPLICATE_BILL, IProjectVariables.POSTPAID__REQUEST_DUPLICATE_BILL_FIELD_RESPONSE_CODE).setValue(resDuplicateBill.getResponseCode());
			if((resDuplicateBill.getResponseCode()).equals(Constants.zero)){
				mySession.getVariableField(IProjectVariables.POSTPAID__REQUEST_DUPLICATE_BILL, IProjectVariables.POSTPAID__REQUEST_DUPLICATE_BILL_FIELD_CODE).setValue(resDuplicateBill.getCaseId());
				mySession.getVariableField(IProjectVariables.POSTPAID__REQUEST_DUPLICATE_BILL, IProjectVariables.POSTPAID__REQUEST_DUPLICATE_BILL_FIELD_STATUS).setValue(resDuplicateBill.getMessageText());
				mySession.getVariableField(IProjectVariables.POSTPAID__CALL_DATA, IProjectVariables.POSTPAID__CALL_DATA_FIELD_MSG_TEXT).setValue(resDuplicateBill.getMessageText());
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_CallData:repeatTries", "0", true).setDebugId(5306));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Postpaid_Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(2867)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0037", false).setDebugId(5849));

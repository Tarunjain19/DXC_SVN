 ...
 */
public class Initialize_PA_0029 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			strSMSFrame = appProperties.getIVRProp(Constants.DELIVERY_STATUS_ETA_Success);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("AccountInformation-PlayEstimatedDelivery_PA_0029", "Default");
		next.setDebugId(2535);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_CallData:transferReasonCode", "TR_0047", true).setDebugId(5134));

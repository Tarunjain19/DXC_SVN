...
public class AccessHost_CreditInfo extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			mySession.getVariableField(IProjectVariables.POSTPAID__CREDIT_INFO, IProjectVariables.POSTPAID__CREDIT_INFO_FIELD_RESPONSE_CODE).setValue(resCreditLimitInfo.getResponseCode());
			if((resCreditLimitInfo.getResponseCode()).equals(Constants.zero)){
				mySession.getVariableField(IProjectVariables.POSTPAID__CREDIT_INFO, IProjectVariables.POSTPAID__CREDIT_INFO_FIELD_CREDIT_AMOUNT).setValue(resCreditLimitInfo.getCreditLimit());
				mySession.getVariableField(IProjectVariables.POSTPAID__CREDIT_INFO, IProjectVariables.POSTPAID__CREDIT_INFO_FIELD_DATE).setValue(resCreditLimitInfo.getSysDate());
			...
			info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, e.getMessage()+e.getLocalizedMessage());
			strSMSFrame = appProperties.getIVRProp(Constants.CREDIT_INFO_Failure);
			smsHashTable = setPushSMS.generatePushSMSDataMap(strSMSFrame, arrSMSData);
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_CallData:globalMenuType", "Postpaid_Constants:FeatureLevel", false).setDebugId(4410));
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_CallData:repeatTries", "0", true).setDebugId(5301));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Postpaid_Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(1452)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0032", false).setDebugId(4749));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_Flag:isLinkDown", "Postpaid_Constants:no", false).setDebugId(5854));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Postpaid_Flag:isFromInteractionHistory", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(1453)).evaluate(mySession)) {
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("AccountInformation-LinkDown", "LinkDown").setDebugId(1456));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_CallData:transferReasonCode", "Postpaid_Constants:TR_0043", false).setDebugId(4750));

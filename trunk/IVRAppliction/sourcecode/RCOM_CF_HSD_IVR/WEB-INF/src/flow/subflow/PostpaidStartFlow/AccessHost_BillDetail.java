...
public class AccessHost_BillDetail extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			reqBillInfo.setMDN(mySession.getVariableField(IProjectVariables.GET_DATA_CARD, IProjectVariables.GET_DATA_CARD_FIELD_VALUE).getStringValue());
			...
			if((resBillInfo.getResponseCode()).equals(Constants.zero)){
				...
				mySession.getVariableField(IProjectVariables.POSTPAID__CHECK_BILL_DETAIL, IProjectVariables.POSTPAID__CHECK_BILL_DETAIL_FIELD_DUE_DATE).setValue(strDueDate);
				...
				mySession.getVariableField(IProjectVariables.POSTPAID__CHECK_BILL_DETAIL, IProjectVariables.POSTPAID__CHECK_BILL_DETAIL_FIELD_ISSUE_DATE).setValue(strBillDate);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("PostpaidStartFlow-ValidateTotalExposure", "Coninue");
		next.setDebugId(6966);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Postpaid_Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(6964)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-Initialize_MN_0005", "LinkDown").setDebugId(6965));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

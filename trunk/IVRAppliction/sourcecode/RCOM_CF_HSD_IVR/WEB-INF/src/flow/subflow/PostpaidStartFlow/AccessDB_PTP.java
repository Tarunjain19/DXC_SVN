...
import com.rcom.prepaid.model.PromiseToPayInfo;
...
public class AccessDB_PTP extends com.avaya.sce.runtime.Data {
			...
			if(promiseToPayInfo != null){
				...
				if(strRequestDate != null){
					...
					if((dateRequestDate.compareTo(callDate)>=0)&&(dateRequestDate.compareTo(new Date())<=0)){
						mySession.getVariableField(IProjectVariables.POSTPAID__FLAG, IProjectVariables.POSTPAID__FLAG_FIELD_IS_PTPSRPRESENT).setValue(Constants.Yes);
					}else{
						mySession.getVariableField(IProjectVariables.POSTPAID__FLAG, IProjectVariables.POSTPAID__FLAG_FIELD_IS_PTPSRPRESENT).setValue(Constants.No);
					}
				}else{
					mySession.getVariableField(IProjectVariables.POSTPAID__FLAG, IProjectVariables.POSTPAID__FLAG_FIELD_IS_PTPSRPRESENT).setValue(Constants.No);
				}
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Postpaid_Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(7386)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-Initialize_MN_0005", "LinkDown").setDebugId(7387));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Postpaid_Flag:isPTPSRPResent", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(7389)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_CallData:transferReasonCode", "Postpaid_Constants:TR_0003", false).setDebugId(7390));
				actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-PostpaidTransfer", "PTPPresent").setDebugId(7391));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-MakePayment_MN_0001", "PTPNotPresent").setDebugId(7393));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

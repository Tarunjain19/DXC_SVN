...
public class CheckGPFLValue extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2016-AUG-11  02:39:09 PM
	 */
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "GlobalPromptCommon:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(145)).evaluate(mySession)) {
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "GlobalPromptCommon:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:previous", true).setDebugId(143)).evaluate(mySession)) {
				...
				if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition5", "AppVariables:RCOUNT", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "3", false).setDebugId(161)).evaluate(mySession)) {
					...
					if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition6", "dmInputParameter:propertyFileName", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "propertyFileName:GlobalPromptFeature", true).setDebugId(450)).evaluate(mySession)) {
						actions = new java.util.ArrayList(1);
						actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0072", false).setDebugId(449));
						if(evaluateActions(actions, mySession)) {
							return true;
						}
						actions = null;
						...
						actions = new java.util.ArrayList(1);
						actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0069", false).setDebugId(453));
						if(evaluateActions(actions, mySession)) {
							return true;
						}
						actions = null;
				...
				if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition7", "dmInputParameter:propertyFileName", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "propertyFileName:GlobalPromptFeature", true).setDebugId(456)).evaluate(mySession)) {
					actions = new java.util.ArrayList(1);
					actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0070", false).setDebugId(454));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition8", "dmInputParameter:propertyFileName", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "propertyFileName:GlobalPromptFeature", true).setDebugId(444)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0071", false).setDebugId(443));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0067", false).setDebugId(447));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

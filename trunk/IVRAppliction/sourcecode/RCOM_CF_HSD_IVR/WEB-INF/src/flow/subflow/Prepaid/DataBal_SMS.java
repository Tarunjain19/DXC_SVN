 ...
 * Last generated by Orchestration Designer at: 2015-NOV-07  04:32:39 PM
 */
public class DataBal_SMS extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid-DataBalSuccSMS", "Default");
		next.setDebugId(11511);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "PushSMSFlag:DataBalFlag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:Key_true", true).setDebugId(11513)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Prepaid-DataBalance_SuccessAnnc", "Skip").setDebugId(11514));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		actions = new java.util.ArrayList(1);
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("PushSMSFlag:DataBalFlag", "constant:Key_true", false).setDebugId(11515));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;
		...
		*//**Assign**//*
		...
		try {
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Data Balance Host response TwoGNetBalanceExpiryDate:: "+twoGNetBalanceExpiryDate);
				...
				key = Constants.DATA_BAL_SUCCESS+AppConstant.SEPERATOR_UNDERSCORE+AppConstant.GSM;

...
public class Get_IVR_RPV extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(7476)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:RechargeCount", "0", true).setDebugId(7477));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid-Get_RechargeMenu", "success").setDebugId(7478));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0018", false).setDebugId(7480));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid-linkdown", "LinkDown").setDebugId(7481));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

...
public class PaymentHostHit extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:PushSMSDone", "constant:Key_False", false).setDebugId(10126));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(10127)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Prepaid-PUSHSMS_Payment", "success").setDebugId(10128));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

		} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "AppVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:error", true).setDebugId(10129)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:HSDI_TR_0065", false).setDebugId(10131));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid-PaymentError", "error").setDebugId(10132));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("dmInputParameter:propertyFileLocation", "propertyFileName:GlobalPromptFeature", false).setDebugId(11444));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid-TechnicalErrorAnnc", "LinkDown").setDebugId(10135));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

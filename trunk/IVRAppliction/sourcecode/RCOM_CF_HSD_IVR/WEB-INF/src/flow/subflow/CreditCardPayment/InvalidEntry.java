 ...
 */
public class InvalidEntry extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_globalPropertyFileName", "dmInputParameter:propertyFileLocation", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "InvalidEntry.properties", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);
	...
	public String getNext() {
		return("CreditCardPayment-CollectCardNo_MN_0033");
	}
	/**

...
public class Initialize_PA_0032 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			strInitialAudio = audioPropertyInstance.getIVRProp(strApplicationName+Constants.HYPEN+Constants.HSDI_PA_0028);
			strAmount = mySession.getVariableField(IProjectVariables.POSTPAID__CHECK_PAYMENT, IProjectVariables.POSTPAID__CHECK_PAYMENT_FIELD_AMOUNT).getStringValue();
			strDate = mySession.getVariableField(IProjectVariables.POSTPAID__CHECK_PAYMENT, IProjectVariables.POSTPAID__CHECK_PAYMENT_FIELD_PAYMENT_RECEIVED_DATE).getStringValue();
			strMode = mySession.getVariableField(IProjectVariables.POSTPAID__CHECK_PAYMENT, IProjectVariables.POSTPAID__CHECK_PAYMENT_FIELD_PAYMENT_TYPE).getStringValue();

...
public class AccessPACE_ValidateCardDetails extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			rcType = mySession.getVariableField(IProjectVariables.POSTPAID__CALL_DATA, IProjectVariables.POSTPAID__CALL_DATA_FIELD_REQUEST_TYPE).getStringValue();
					//"TOPUP";
			...
			strMDNToRecharge = mySession.getVariableField(IProjectVariables.POSTPAID__CALL_DATA, IProjectVariables.POSTPAID__CALL_DATA_FIELD_NUMBER_VERIFICATION_MDN).getStringValue();
			...
			if(resPaymentUsingCreditcard!= null){
				...
				mySession.getVariableField(IProjectVariables.POSTPAID__VALIDATE_CREDIT_CARD, IProjectVariables.POSTPAID__VALIDATE_CREDIT_CARD_FIELD_ERROR_CODE).setValue(responseCode);
				...
				if((Constants.zero).equals(responseCode)){
					...
					mySession.getVariableField(IProjectVariables.POSTPAID__DMPROPERTIES, IProjectVariables.POSTPAID__DMPROPERTIES_FIELD_INITIAL_AUDIOS).setValue(strInitialAudios);*/
	...
	public void requestBegin(SCESession mySession) {
		...
		strAmountEntered = mySession.getVariableField(IProjectVariables.POSTPAID__COLLECT_AMOUNT__MN___0_0_3_7, IProjectVariables.POSTPAID__COLLECT_AMOUNT__MN___0_0_3_7_FIELD_VALUE).getStringValue();
		strApplicationName = mySession.getVariableField(IProjectVariables.POSTPAID__CALL_DATA, IProjectVariables.POSTPAID__CALL_DATA_FIELD_APPLICATION_NAME).getStringValue();
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Postpaid_Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(1818)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_CallData:transferReasonCode", "TR_0075", true).setDebugId(2459));
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Postpaid_ValidateCreditCard:errorCode", com.avaya.sce.runtime.Expression.STRING_NOT_EQUAL_IGNORE, "0", false).setDebugId(1956)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);

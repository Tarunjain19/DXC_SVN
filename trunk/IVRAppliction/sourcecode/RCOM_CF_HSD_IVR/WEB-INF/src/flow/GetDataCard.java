 ...
 * Last generated by Orchestration Designer at: 2015-AUG-25  04:06:30 PM
 */
public class GetDataCard extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_globalPropertyFileName", "dmInputParameter:globalPropertyWithoutGlobalPrompt", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:GetDataCard", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

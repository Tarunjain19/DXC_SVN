...
public class Set_Store_Global extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("dmInputParameter:propertyFileName", "propertyFileName:GPMenuRepeat", false).setDebugId(5308));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Flag:PushSMSDone", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:Key_False", true).setDebugId(5317)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:PushSMSDone", "constant:Key_true", false).setDebugId(5318));
			actions.add(new com.avaya.sce.runtime.Next("PushSMS_StoreAddress", "pushSMS").setDebugId(5319));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions.add(new com.avaya.sce.runtime.Next("Store_GlobalMenu", "Global").setDebugId(5321));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

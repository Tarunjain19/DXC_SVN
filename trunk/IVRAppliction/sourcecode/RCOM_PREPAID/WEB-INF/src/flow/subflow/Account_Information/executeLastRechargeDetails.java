...
public class executeLastRechargeDetails extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:TRUE", true).setDebugId(3191)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "WS_Alarm_Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:ON", true).setDebugId(3202)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_MAJOR, "WS Down|Account Info Flow|Exe Last Rech|", "EPM_Alarm:Description", true).setDebugId(3192));
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "constant:FALSE", false).setDebugId(3193));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(1979)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0079", true).setDebugId(3030));
			actions.add(new com.avaya.sce.runtime.Next("Account_Information-Set_TGSM_PA_0025", "success").setDebugId(1984));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0080", true).setDebugId(3031));
			actions.add(new com.avaya.sce.runtime.Next("Account_Information-TGSM_PA_0081", "network_failure").setDebugId(1986));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		try
		{
			...
			*//** Ends Here **/
			...
			if(resLastRechargeDetails!=null){
				...
				if(listRechargeDetails!=null && (!listRechargeDetails.isEmpty())){
					...
					trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Last Recharge Amount :: "+listRechargeDetails.get(0).getAmount());
					
					if(listRechargeDetails.get(0) !=null)
					{
					...
					if(rechargeDate != null && (rechargeDate.length() > 0))
					{

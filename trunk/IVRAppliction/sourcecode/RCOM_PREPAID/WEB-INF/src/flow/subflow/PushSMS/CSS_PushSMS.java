...
public class CSS_PushSMS extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:TRUE", true).setDebugId(29)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "WS_Alarm_Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:ON", true).setDebugId(32)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_MAJOR, "WS Down|Push SMS|CSS PushSMS|", "EPM_Alarm:Description", true).setDebugId(30));
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "constant:FALSE", false).setDebugId(31));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("PushSMSFlag:PushSMSText", "", true).setDebugId(27));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;
		...
		try{
			...
			if(completeSMSText!=null && !AppConstant.EMPTY_STRING.equalsIgnoreCase(completeSMSText)){
				...
				trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "SMSText:"+strMsgText);
			     ...
			     if(mySession.getVariableField(IProjectVariables.FLAG,IProjectVariables.FLAG_FIELD_IS_CALL_END).getStringValue().equalsIgnoreCase(AppConstant.TRUE)){
					if(mySession.getVariableField(IProjectVariables.FLAG,IProjectVariables.FLAG_FIELD_MAIN_MENU_TRAVERSED).getStringValue().equalsIgnoreCase(AppConstant.TRUE)){
						strKeyword = AppConstant.MAINMENU_OFFER;
						mySession.getVariableField(IProjectVariables.FLAG,IProjectVariables.FLAG_FIELD_MAIN_MENU_TRAVERSED).setValue(AppConstant.FALSE);
					  }
			     }
				else
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "pushSMSHashTable" + pushSMSHashTable);
			}
			catch (Exception e){

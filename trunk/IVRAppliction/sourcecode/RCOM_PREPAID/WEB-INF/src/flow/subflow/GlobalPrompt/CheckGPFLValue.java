	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "GlobalPromptCommon:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(145)).evaluate(mySession)) {
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "GlobalPromptCommon:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:previous", true).setDebugId(143)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("GlobalPrompt-PreviousMenu", "PreviousMenu").setDebugId(456));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition4", "GlobalPromptCommon:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:repeat", true).setDebugId(148)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				...
				if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition5", "appVariables:RCount", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "3", false).setDebugId(161)).evaluate(mySession)) {
					actions = new java.util.ArrayList(1);
					actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:NIFlag", "NOMATCH", true).setDebugId(467));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;

					if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition6", "dmInputParameter:propertyFileName", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "propertyFileName:GPFeatureLevel", true).setDebugId(450)).evaluate(mySession)) {
						actions = new java.util.ArrayList(1);
						actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0014", true).setDebugId(449));
						if(evaluateActions(actions, mySession)) {
							return true;
						}
						actions = null;
						...
						actions = new java.util.ArrayList(1);
						actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0015", true).setDebugId(453));
						if(evaluateActions(actions, mySession)) {
							return true;
						}
						actions = null;
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition7", "dmInputParameter:propertyFileName", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "propertyFileName:GPFeatureLevel", true).setDebugId(444)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0051", true).setDebugId(443));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition8", "dmInputParameter:propertyFileName", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "propertyFileName:GPMenuLevel", true).setDebugId(445)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0050", true).setDebugId(447));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0052", true).setDebugId(448));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

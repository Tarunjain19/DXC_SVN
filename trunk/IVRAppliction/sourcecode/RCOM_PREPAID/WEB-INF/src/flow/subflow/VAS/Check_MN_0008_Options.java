		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "MN_0008_Inet_VAS_MM:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(3807)).evaluate(mySession)) {
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "MN_0008_Inet_VAS_MM:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Grammars:InternetSettings", true).setDebugId(3808)).evaluate(mySession)) {
				...
				if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "appVariables:callerType", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "CDMA", false).setDebugId(5628)).evaluate(mySession)) {
					actions = new java.util.ArrayList(2);
					actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0108", true).setDebugId(5631));
					actions.add(new com.avaya.sce.runtime.Next("VAS-AgentTransfer", "Transfer").setDebugId(5630));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;
					...
					actions = new java.util.ArrayList(1);
					actions.add(new com.avaya.sce.runtime.Next("VAS-MN_0012", "Get_GPRS_Settings").setDebugId(3809));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("VAS-VAS", "VAS").setDebugId(3811));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("VAS-PA_0028_CallerTune_Annce", "Caller_Tune").setDebugId(3813));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition6", "MN_0008_Inet_VAS_MM:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:previous", true).setDebugId(5274)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("VAS-PreviousMenu", "Previous").setDebugId(5275));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition7", "MN_0008_Inet_VAS_MM:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:MainMenu", true).setDebugId(5276)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("VAS-MainMenu", "Main_Menu").setDebugId(5277));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0084", true).setDebugId(5608));
				actions.add(new com.avaya.sce.runtime.Next("VAS-AgentTransfer", "Agent").setDebugId(5279));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0021", true).setDebugId(5609));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:NIFlag", "MN_0008_Inet_VAS_MM:ReturnCode", false).setDebugId(5708));
			actions.add(new com.avaya.sce.runtime.Next("VAS-AgentTransfer", "Agent").setDebugId(3814));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

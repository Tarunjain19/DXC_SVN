...
public class ChangeLanguageMenuEvaluate extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Language Menu Return Code", "ChangeLanguageMenu:ReturnCode").setDebugId(5342));
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Language Menu Return Value", "ChangeLanguageMenu:Value").setDebugId(5343));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "ChangeLanguageMenu:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(5344)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "ChangeLanguageMenu:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "MenuOption:agent", true).setDebugId(7129)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0107", true).setDebugId(7496));
				actions.add(new com.avaya.sce.runtime.Next("checkNIexceeds", "agent").setDebugId(7130));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "ChangeLanguageMenu:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "MenuOption:MainMenu", true).setDebugId(7131)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("checkMainMenuCount", "MainMenu").setDebugId(7132));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition4", "ChangeLanguageMenu:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "MenuOption:previous", true).setDebugId(7133)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("checkMainMenuCount", "previous").setDebugId(7134));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.SetCurrentLanguage("ChangeLanguageMenu:Value", false).setDebugId(5345));
				actions.add(new com.avaya.sce.runtime.Next("UpdateLanguage", "confirm").setDebugId(5346));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(3);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0049", true).setDebugId(7498));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:NIFlag", "ChangeLanguageMenu:ReturnCode", false).setDebugId(9084));
			actions.add(new com.avaya.sce.runtime.Next("checkNIexceeds", "Exceeded").setDebugId(5348));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

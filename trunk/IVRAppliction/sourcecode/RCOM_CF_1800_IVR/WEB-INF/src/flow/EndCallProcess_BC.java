 ...
 * Last generated by Orchestration Designer at: 2015-JUN-12  03:26:42 PM
 */
public class EndCallProcess_BC extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		IVRDataBean ivrDataBean = (IVRDataBean) mySession.getProperty(AppConstants.IVRDATABEAN);
		ITraceInfo trace = null;
		Result reportData = null;
		String strDTMFPath =  AppConstants.EMPTY_STRING;
		String strMenuOption =  AppConstants.EMPTY_STRING , priority = AppConstants.EMPTY_STRING;
		String strMenuPath =  AppConstants.EMPTY_STRING , language = AppConstants.EMPTY_STRING; 
		String strAnnouncePath =  AppConstants.EMPTY_STRING,circleID = AppConstants.EMPTY_STRING;
		String priorityFlag = AppConstants.EMPTY_STRING;
		...
		try {
			...
			/***CDMA Mobile Number ID ***/
			String CdmaMobile = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_CDMA_MOBILE_NUMBER).getStringValue();
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO,"CdmaMobile :"+CdmaMobile);
			
			callInfo.setRESERVE1(CdmaMobile);
			
			/***Last 4 digit sim number ***/
			String Last4digit = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_LASTFOUR_DIGIT).getStringValue();
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO,"Last4digit :"+Last4digit);
			
			callInfo.setRESERVE2(Last4digit);
			
			/***19 digit sim number ***/
			String simnumber = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_SIM_NUMBER).getStringValue();
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO,"simnumber :"+simnumber);
			
			callInfo.setRESERVE3(simnumber);

...
public class Main {
	...
	public static void main(String[] args)
	{
		...
		AppProperties.setInstance("RCOM_CF_HSD_HOSTCONFIG", "C:/RCOM/555/");
		...
		ReqDataBalance req = new ReqDataBalance();
		
		req.setMDN("9339151267");
		
		ResDataBalance res = ivrWebService.executeDataBalance(ivrDataBean, req);
		
		System.out.println("Response Code : " +res.getResponseCode());
		System.out.println("Core Bal : " +res.getCoreBalanceExpiryDate());
		System.out.println("Core Bal Exp Date : " +res.getCoreBalanceExpiryDate());
		System.out.println("RConnect Bal : " +res.getRconnectBalance());
		System.out.println("RConnect Bal Exp Date : " +res.getRconnectBalanceExpiryDate());

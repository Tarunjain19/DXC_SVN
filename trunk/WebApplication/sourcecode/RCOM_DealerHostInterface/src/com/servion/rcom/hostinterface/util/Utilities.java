...
public class Utilities {
	...
	public static String getXMLFromObject(Logger logger, Class beanClassName, Object object, String xmlHeader){
		...
		try {
			...
			logger.info("JAXBException while converting to XML from Object" + e);
			logger.info("JAXBException while converting to XML from Object | Error Message" + e.getMessage());
		}
	...
	public static Object getObjectFromXML(Logger logger, Class beanClassName, String xml)
	{
		...
		try {
			...
			logger.info("JAXBException while converting to Object from XML" + e);
			logger.info("JAXBException while converting to Object from XML | Error Message" + e.getMessage());
		}

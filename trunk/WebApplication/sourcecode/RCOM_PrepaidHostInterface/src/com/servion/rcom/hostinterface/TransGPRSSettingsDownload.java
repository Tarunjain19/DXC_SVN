...
public class TransGPRSSettingsDownload implements ITransaction{
	...
	public ResGPRSSettingsDownload getHostInterface(IVRDataBean ivrDataBean, ReqGPRSSettingsDownload request){
		...
		try{
			...
			logger.info(uniqueId + "|" + "TransGPRSSettingsDownload getHostInterface method start");
			wsdlProcessor();
			logger.info(uniqueId + "|" + "Response Code to Call Flow : " + responseCode);
			logger.info(uniqueId + "|" + "TransGPRSSettingsDownload getHostInterface method end");
	...
	public void wsdlProcessor() {
		...
		try {
			...
			logger.info(uniqueId + "|" + "Before calling GPRS settings Service");
			...
			request = null;
			logger.info(uniqueId + "|" + "After calling GPRS settings Service");

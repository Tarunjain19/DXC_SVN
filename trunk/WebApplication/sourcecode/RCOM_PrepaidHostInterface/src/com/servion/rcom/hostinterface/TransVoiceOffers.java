...
public class TransVoiceOffers implements ITransaction{
	...
	public ResVoiceOffers getHostInterface(IVRDataBean ivrDataBean , ReqVoiceOffers request) {
		...
		try{
			...
			logger.info(uniqueId + "|" + "TransVoiceOffers getHostInterface method start");
			wsdlProcessor();
			logger.info(uniqueId + "|" + "Response Code to Call Flow : " + responseCode);
			logger.info(uniqueId + "|" + "TransVoiceOffers getHostInterface method end");
	...
	public void wsdlProcessor() {
		...
		try {
			...
			logger.info(uniqueId + "|" + "QName Namespace : " +qnameNamespace);
			logger.info(uniqueId + "|" + "QName Localpart : " +qnameNamespace);
			...
			logger.info(uniqueId + "|" + "Timestamp : " +Utilities.getTimeStamp(logger, appProperties.getIVRProp(HostConstants.CSS_REQUEST_TIMESTAMP_FORMAT)));
			logger.info(uniqueId + "|" + "Before calling voice offers Service");
			...
			logger.info(uniqueId + "|" + "After calling voice offers Service");
			...
			if(offers != null)
			{
					...
					if(listOffers != null)
					{
						logger.info(uniqueId + "|" + "No of Offers returned : " +listOffers.size());
						...
						for(OfferInfo offerInfo : listOffers)
						{
							...
							logger.info(uniqueId + "|" + "Offer Details : " +offerDetails.toString());
			...
			//For Reporting
			host.setHOSTOUTPARAMS(responseCode+HostConstants.PIPE+resVoiceOffers.toString());

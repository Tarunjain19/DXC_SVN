...
public class TransDataBalance implements ITransaction{
	...
	public ResDataBalance getHostInterface(IVRDataBean ivrDataBean, ReqDataBalance request) {
		...
		try{
			...
			logger.info(uniqueId + "|" + "TransDataBalance getHostInterface method start");
			wsdlProcessor();
			logger.info(uniqueId + "|" + "Response Code to Call Flow : " + responseCode);
			logger.info(uniqueId + "|" + "TransDataBalance getHostInterface method end");
	...
	public void wsdlProcessor() {
		...
		try {
			...
			logger.info(uniqueId + "|" + "Before calling dataBalance Service");
			...
			request = null;
			logger.info(uniqueId + "|" + "After calling dataBalance Service");
					...
					if(twoGDataBalToken != null)
					{
						...
						for(Param param : listParam)
						{
							if(param.getId().equalsIgnoreCase(HostConstants.PARAM_VALUE))
							{
								...
								twoGNetBal = Utilities.adjustDecimal(logger, twoGNetBal);
							}
					...
					if(threeGDataBalToken != null)
					{
						...
						for(Param param : listParam)
						{
							if(param.getId().equalsIgnoreCase(HostConstants.PARAM_VALUE))
							{
								...
								threeGNetBal	 = Utilities.adjustDecimal(logger, threeGNetBal);
							}
							if(param.getId().equalsIgnoreCase(HostConstants.PARAM_VALIDITY))
							{
					...
					if(threeGFUDataBalToken != null)
					{
						...
						for(Param param : listParam)
						{
							if(param.getId().equalsIgnoreCase(HostConstants.PARAM_VALUE))
							{
								...
								threeGFUNetBal   = Utilities.adjustDecimal(logger, threeGFUNetBal);
							}
							if(param.getId().equalsIgnoreCase(HostConstants.PARAM_VALIDITY))
							{
					...
					if(cdmaDataBalToken != null)
					{
						...
						for(Param param : listParam)
						{
							if(param.getId().equalsIgnoreCase(HostConstants.PARAM_VALUE))
							{
								...
								cdmaDataNetBal   = Utilities.adjustDecimal(logger, cdmaDataNetBal);
							}
							if(param.getId().equalsIgnoreCase(HostConstants.PARAM_VALIDITY))
							{

...
@Entity
@NamedStoredProcedureQuery(name = Constants.PROC_SPSVN_GetSMSKeyword, procedureName = Constants.SPSVN_GetSMSKeyword, resultClasses = com.rcom.prepaid.model.PushSMSInfo.class,
parameters = {

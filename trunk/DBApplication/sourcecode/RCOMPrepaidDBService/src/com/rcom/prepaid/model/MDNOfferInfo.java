 ...
 */
@Entity
@NamedStoredProcedureQuery(name=Constants.PROC_spsvn_GetOfferMDN, procedureName = Constants.spsvn_GetOfferMDN, resultClasses = com.rcom.prepaid.model.MDNOfferInfo.class, 
parameters = {

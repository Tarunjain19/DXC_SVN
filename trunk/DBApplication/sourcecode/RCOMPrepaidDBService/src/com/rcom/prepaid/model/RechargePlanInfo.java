...
@Entity
@NamedStoredProcedureQuery(name=Constants.PROC_spsvn_GetPlanVoucherDenomination, procedureName = Constants.spsvn_GetPlanVoucherDenomination, resultClasses = com.rcom.prepaid.model.RechargePlanInfo.class,
parameters = {
...
public class RechargePlanInfo implements Serializable{
	...
	private String mrp;
	@Column(name = Constants.PlanCode)
	...
	public String toString() {
		...
		builder.append(", PlanCode:"+PlanCode);

 ...
 */
@Entity
@NamedStoredProcedureQuery(name=Constants.PROC_spsvn_GetOfferApplication, procedureName = Constants.spsvn_GetOfferApplication, resultClasses = com.rcom.postpaid.model.CircleOffersInfo.class, 
parameters = {

 ...
 */
@Entity
@NamedStoredProcedureQuery(name=Constants.PROC_IVR_DNISRouting, procedureName = Constants.SP_IVR_DNISRouting, resultClasses = com.rcom.red.model.IVRRoutingInfo.class,
parameters = {

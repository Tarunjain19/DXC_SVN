 ...
 * Last generated by Orchestration Designer at: 2015-MAY-24  06:14:38 PM
 */
public class Offers_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:Offers_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 * Last generated by Orchestration Designer at: 2015-APR-25  03:37:01 PM
 */
...
public Logger logger = Logger.getLogger("LoadOnStartup.class"); 
	...
	public void init(ServletConfig config) throws ServletException {
		...
		logger.debug("IVR_CONFIG PATH :: "+path);
		AppProperties.setInstance(AppConstants.IVR_CONFIG_PROPERTIES, path);
		AppProperties.setInstance(AppConstants.IVR_HOST_PROPERTIES, path);

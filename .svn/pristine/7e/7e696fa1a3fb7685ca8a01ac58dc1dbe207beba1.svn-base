 ...
 */
public class LinkDown_CSAT_PA_0004 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperty:LinkDown_CSAT_PA_004", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

...
public class Main {
	...
	public static void main(String[] args)
	{
		...
		AppProperties.setInstance("RCOM_CF_30333333_HOST_CONFIG", "D:/RCOM/Config/");
		...
		ReqDuplicateBill req = new ReqDuplicateBill();
		req.setMDN("9699877177");
		ResDuplicateBill res = ivrWebService.executeDuplicateBillRequest(ivrDataBean, req);
		System.out.println(res.getResponseCode());
		System.out.println(res.getMessageText());
		...
		reqNonActivePackDetails.setMDN("8081796378");

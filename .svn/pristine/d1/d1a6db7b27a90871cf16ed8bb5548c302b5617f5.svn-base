 ...
 * Last generated by Orchestration Designer at: 2015-APR-07  04:39:03 PM
 */
public class CallEnd extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Flag:EndCall", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:Key_true", true).setDebugId(2494)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("End", "Drop").setDebugId(2496));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		actions = new java.util.ArrayList(1);
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:EndCall", "constant:Key_true", false).setDebugId(2495));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

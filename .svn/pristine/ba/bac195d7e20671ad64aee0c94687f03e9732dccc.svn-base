...
public class CallEnd extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:isLoop", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "yes", false).setDebugId(8867)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("End", "LoopedCall").setDebugId(8868));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

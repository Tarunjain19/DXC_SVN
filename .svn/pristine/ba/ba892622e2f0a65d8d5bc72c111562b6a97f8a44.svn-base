 ...
 * Last generated by Orchestration Designer at: 2015-APR-28  11:42:48 AM
 */
public class MainMenuUnmanned_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:MainMenuUnmanned_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("CheckMMUnmannedValue_BC");
	}
	/**

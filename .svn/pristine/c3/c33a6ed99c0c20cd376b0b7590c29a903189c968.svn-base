 ...
 * Last generated by Orchestration Designer at: 2015-MAY-27  12:30:19 PM
 */
public class Get_AlterMobileNum extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:GetMobileNumber", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("RegisterComplaint_CollectAlternateMN_Error-Check_GetAlterMobileNum");
	}
	/**

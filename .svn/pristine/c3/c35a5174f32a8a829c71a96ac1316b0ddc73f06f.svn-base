...
import com.rcom.bb.model.TransferVDNInfo;
 ...
 * Last generated by Orchestration Designer at: 2015-MAY-22  03:02:54 PM
 */
public class DB_GetTransferVDN extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			String transerCode = mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_TRANSFER_CODE).getStringValue();
			...
			transferVDNInfo.setCallType("2");
			transferVDNInfo.setCustomerSegment("2");
			...
			if(transferVDNInfo.getTransferVDN1()!=null){
				...
				callInfo.setAGENTEXTN(ivrProperties.getIVRProp(language+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
				callInfo.setAGENTID(ivrProperties.getIVRProp(language+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
				callInfo.setTRANSFERVDN(ivrProperties.getIVRProp(language+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
			}
			...
			if(transferVDNInfo.getTransferVDN1()==null){
				 mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_TRANSFER_VDN).setValue(ivrProperties.getIVRProp(language+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
			}else{
			...
			if(callInfo!=null)
			{
				...
				{
					callInfo.setHOWCALLENDED("TRANSFER");
					callInfo.setAGENTEXTN(ivrProperties.getIVRProp(mySession.getCurrentLanguage()+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
					callInfo.setAGENTID(ivrProperties.getIVRProp(mySession.getCurrentLanguage()+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
					callInfo.setUUIDATA(strUUI);
			...
			mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_TRANSFER_VDN).setValue(ivrProperties.getIVRProp(mySession.getCurrentLanguage()+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Transfer_PP", "Default");
		next.setDebugId(190);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "uui data : ", "appVariables:uuiData").setDebugId(12159));
		actions.add(new com.avaya.sce.runtime.varoperations.PrepareAAI("Shared", "", "appVariables:uuiData", "UUIData").setDebugId(12158));
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Prepared AAI", "UUIData").setDebugId(12160));

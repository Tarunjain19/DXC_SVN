 ...
 * Last generated by Orchestration Designer at: 2015-APR-27  03:14:43 PM
 */
public class LinkdownThankyou_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:LinkdownThankyou_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

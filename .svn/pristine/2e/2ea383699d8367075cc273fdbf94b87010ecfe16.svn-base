 ...
 */
public class LanguageMenu extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:LanguageMenu", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_maxNoMatchCount", "LanguageMenu:NomatchRemaining", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionFlag", "false", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);
	...
	public String getNext() {
		return("Language_Selection-LanguageMenuEvaluate");
	}
	/**

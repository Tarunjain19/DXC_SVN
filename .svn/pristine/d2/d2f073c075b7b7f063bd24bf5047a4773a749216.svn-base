 ...
 * Last generated by Orchestration Designer at: 2015-APR-29  08:34:33 PM
 */
public class Begin extends com.avaya.sce.runtime.BasicServlet {
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("RegisterComplaint-WS_NoSupplyComplaint", 0, true, "Start");
		list.add(aGoto);

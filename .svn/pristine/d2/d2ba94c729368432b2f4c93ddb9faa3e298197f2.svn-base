...
public class CheckInput extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "SelectLang_MN Return Code :: ", "SelectLangApp_MN:ReturnCode").setDebugId(630));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "SelectLangApp_MN:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Success", true).setDebugId(344)).evaluate(mySession)) {
			actions = new java.util.ArrayList(4);
			actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "SelectLang_MN Value :: ", "SelectLangApp_MN:Value").setDebugId(631));
			actions.add(new com.avaya.sce.runtime.varoperations.SetCurrentLanguage("SelectLangApp_MN:Value", false).setDebugId(632));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "SPIVR_TR_0001", true).setDebugId(6169));
			actions.add(new com.avaya.sce.runtime.Next("TransferAgent", "SelectedLang").setDebugId(633));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

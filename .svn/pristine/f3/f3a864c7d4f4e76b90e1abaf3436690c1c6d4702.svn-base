 ...
 * Last generated by Orchestration Designer at: 2015-JUN-30  12:25:08 AM
 */
public class TopUp_SubMN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:TopUp_SubMN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Top_Up_Packs-check_TopUpSubMN");
	}
	/**

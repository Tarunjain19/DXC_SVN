 ...
 * Last generated by Orchestration Designer at: 2015-OCT-19  06:07:26 PM
 */
public class Ann_Welcome extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_Welcome", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("LanguageSelection-Mnu_LanguageSelection");
		return submit;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		String strPath = null;
		strPath = mySession.getVariableField(IProjectVariables.CALL_INFO,IProjectVariables.CALL_INFO_FIELD_CALLER_PATH).getStringValue();

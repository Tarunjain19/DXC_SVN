 ...
 * Last generated by Orchestration Designer at: 2015-MAY-27  07:10:49 PM
 */
public class CannotCancelled_Annc extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:CannotCancelled_Annc", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Cancel_A_Pack-GPFeatureLevel");
	}
	/**

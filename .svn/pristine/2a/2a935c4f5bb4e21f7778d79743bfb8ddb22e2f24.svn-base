 ...
 * Last generated by Orchestration Designer at: 2015-MAR-11  07:04:59 PM
 */
public class TGSM_PA_0019 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:MainAccountBalance_Regret_PA", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Account_Information-SetProperty6");
	}
	/**

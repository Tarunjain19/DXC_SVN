 ...
 */
@Entity
@NamedStoredProcedureQuery(name=Constants.PROC_spsvn_GetSpecialTraiffVoucher, procedureName = Constants.spsvn_GetSpecialTraiffVoucher, resultClasses = com.rcom.prepaid.model.SpecialTariffInfo.class,
parameters = {

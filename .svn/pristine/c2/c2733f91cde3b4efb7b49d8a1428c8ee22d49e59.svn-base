 ...
 */
public class DM_Play_AccBal_Repeating extends com.avaya.sce.runtime.Invoke {
	 ...
	 * Last generated by Orchestration Designer at: 2016-JUN-06  12:58:16 PM
	 */
	public DM_Play_AccBal_Repeating() {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:PlayAccBal_Again", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("RGC_Flow-DM_AccountMenu");
	}
	/**

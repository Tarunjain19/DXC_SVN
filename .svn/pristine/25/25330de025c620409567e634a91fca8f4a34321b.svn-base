...
import com.rcom.broadband.DBLoadOnStartUp;
import com.rcom.broadband.PeriodicChecker;
import com.servion.util.AppProperties;

/**
 * A basic servlet which allows a user to define their code, generate
 * any output, and to select where to transition to next.
 * Last generated by Orchestration Designer at: 2015-MAY-22  11:51:43 AM
 */
public class LoadOnStartup extends com.avaya.sce.runtime.BasicServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		String DBfileName = this.getServletContext().getInitParameter(Constants.HOST_CONFIG_FILE_NAME);
		...
		appName = AppProperties.GetInstance(Constants.IVR_CONFIG).getIVRProp(Constants.APP_NAME);
		...
		objDBLoadOnStartUp.loadPushSMSText(appName);
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("ANI_Override", 0, true, "Default");
		list.add(aGoto);

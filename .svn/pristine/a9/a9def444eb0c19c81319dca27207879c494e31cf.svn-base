 ...
 * Last generated by Orchestration Designer at: 2015-APR-02  05:20:08 PM
 */
public class Promo_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:Promo_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 * Last generated by Orchestration Designer at: 2015-MAR-15  10:01:47 PM
 */
public class Get_ConfirmationTopupInfo extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2015-MAR-15  10:01:47 PM
	 */
	public Get_ConfirmationTopupInfo() {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid_Start-ConfirmTopUpAmount");
		next.setDebugId(10509);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			amount = mySession.getVariableField(IProjectVariables.COLLECT__TOP_UP_AMOUNT,IProjectVariables.COLLECT__TOP_UP_AMOUNT_FIELD_VALUE).getStringValue();
			talkTime = mySession.getVariableField(IProjectVariables.PREPAID__TOP_UP_DETAIL,IProjectVariables.PREPAID__TOP_UP_DETAIL_FIELD_TALK_TIME).getStringValue();
			
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Application Name :: "+appName);
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Top Up Amount :: "+amount +":: TopUp talkTime ::"+talkTime);
			
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.MN_0018;
			...
			dynamicValue.add(amount);
			dynamicValue.add(talkTime+AppConstant.currency);

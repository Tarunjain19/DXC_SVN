...
public class globalMenuPaymentInfo extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("GlobalPrompt-PreviousMenu", "PostpaidAccountInformation-PaymentInfo_MN_0011");
		exitPoints.put("GlobalPrompt-ProspectMainMenu", "PostpaidAccountInformation-ProspectMainMenu");
		exitPoints.put("GlobalPrompt-Repeat", "PostpaidAccountInformation-ReceiveSMS_PA_0030");
		return exitPoints;
	}
}

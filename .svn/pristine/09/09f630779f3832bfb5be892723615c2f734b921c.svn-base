 ...
 * Last generated by Orchestration Designer at: 2016-MAY-23  11:08:28 AM
 */
public class DAT_Load_Config extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession)
	{
		...
		propertiesFilePath = "C:/RCOM/OtherFlows/RCOM_RGC_Payment_IVR/";
		ivrConfigFileName = "RCOM_RGC_Payment_IVR_IVR_CONFIG";
		dynMenuConfigFileName ="RCOM_RGC_Payment_IVR_DYN_MENU"; 
		HostConfigFileName = "RCOM_RGC_Payment_IVR_HOST_CONFIG";
		
		try{
			
			if(propertiesFilePath.equalsIgnoreCase("")||propertiesFilePath.equalsIgnoreCase(null)||ivrConfigFileName.equalsIgnoreCase("")||ivrConfigFileName.equalsIgnoreCase(null)||dynMenuConfigFileName.equalsIgnoreCase("")||dynMenuConfigFileName.equalsIgnoreCase(null)||HostConfigFileName.equalsIgnoreCase("")||HostConfigFileName.equalsIgnoreCase(null))
			{
			...
			AppProperties.setInstance("RCOM_CF_30333333_IVR_CONFIG","C://RCOM//OtherFlows//3033//");
			AppProperties.GetInstance("RCOM_CF_30333333_IVR_CONFIG").getIVRProp("DRIVER");
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_ERROR,"ERROR in Load Config :"+e);
  }
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Flag_Application_Error", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:TRUE", true).setDebugId(3501)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("DM_TechDiff_Msg", "TechDiff").setDebugId(3502));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("DM_Welcome_Msg", "Default").setDebugId(3498));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

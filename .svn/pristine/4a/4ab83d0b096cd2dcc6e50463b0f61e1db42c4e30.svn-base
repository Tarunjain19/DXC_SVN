 ...
 * Last generated by Orchestration Designer at: 2015-SEP-22  12:54:41 PM
 */
public class CheckInput2 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("CallEnd", "DefaultLang");
		next.setDebugId(6020);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "SelectLang_MN Return Code :: ", "SelectLang_MN:ReturnCode").setDebugId(6015));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "SelectLang_MN:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Success", true).setDebugId(6016)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "SelectLang_MN Value :: ", "SelectLang_MN:Value").setDebugId(6017));
			actions.add(new com.avaya.sce.runtime.varoperations.SetCurrentLanguage("SelectLang_MN:Value", false).setDebugId(6018));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Flag:abusiveType", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Yes", true).setDebugId(6172)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("BarredMsg_PP", "abusive").setDebugId(6019));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("SetHotFlashInfo", "continue").setDebugId(6174));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		/**Declaration **/
		String returnCode = AppConstants.EMPTY_STRING,returnValue = AppConstants.EMPTY_STRING;
		...
		/**Assign **/
		returnValue = mySession.getVariableField(IProjectVariables.SELECT_LANG__MN,IProjectVariables.SELECT_LANG__MN_FIELD_VALUE).getStringValue();
		returnCode = mySession.getVariableField(IProjectVariables.SELECT_LANG__MN,IProjectVariables.SELECT_LANG__MN_FIELD_RETURN_CODE).getStringValue();

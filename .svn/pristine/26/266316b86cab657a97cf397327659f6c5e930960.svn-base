 ...
 */
public class BEHD_PA_0002_Annce extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:ThankYou_Annce", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

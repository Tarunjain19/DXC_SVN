 ...
 * Last generated by Orchestration Designer at: 2015-MAY-24  05:45:16 PM
 */
public class AltContactNoConfirm_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:AltContactNoConfirm_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

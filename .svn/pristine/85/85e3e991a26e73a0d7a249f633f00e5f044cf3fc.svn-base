 ...
 * Last generated by Orchestration Designer at: 2015-MAY-26  08:22:38 PM
 */
public class Confirm_CouponNum extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Confirm_CouponNum", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_maxNoMatchCount", "Confirm_CouponNum:NomatchRemaining", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Purchase_DTV_and_Validate_Coupon-Check_ConfirmCouponNum");
	}
	/**

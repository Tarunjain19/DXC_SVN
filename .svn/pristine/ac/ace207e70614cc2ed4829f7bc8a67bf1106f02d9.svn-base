 ...
 */
public class LinkDown_PA_0098 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:LinkDown_PA_0001", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

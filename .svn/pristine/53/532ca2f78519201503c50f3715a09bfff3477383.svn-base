 ...
 * Last generated by Orchestration Designer at: 2015-MAY-28  05:40:43 PM
 */
public class ConfirmPIN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:ConfirmPIN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Recharge_Account_Using_Cash_Card-Check_ConfirmPIN");
	}
	/**

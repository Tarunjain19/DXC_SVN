 ...
 */
public class GetHotFlashMsg extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2016-OCT-12  11:13:33 AM
	 */
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Hot Flash Enable Disable Flag :", "HotFlashInfo:Flag").setDebugId(146));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "HotFlashInfo:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Key_true", true).setDebugId(147)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("HotFlash-HotFlash", "HotFlash").setDebugId(7));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TransferCodes:TR_0004", false).setDebugId(151));
			actions.add(new com.avaya.sce.runtime.Next("HotFlash-Return", "Return").setDebugId(149));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		/**Declaration**/
		String phraseID = AppConstants.EMPTY_STRING,appName =  AppConstants.EMPTY_STRING,circleID = AppConstants.EMPTY_STRING,hotFlashFlag = AppConstants.FALSE;
		String startDate = AppConstants.EMPTY_STRING, endDate = AppConstants.EMPTY_STRING,language = AppConstants.EMPTY_STRING;
		String hotFlashKey = AppConstants.EMPTY_STRING,phraseKey=AppConstants.EMPTY_STRING,nodeID =  AppConstants.EMPTY_STRING;
		String flagPlayHotFlash = AppConstants.FALSE;
		...
		try{
			...
			hotFlashKey = AppConstants.HOTFLASH_KEY+appName;
			...
			if(objMapHotFlashInfo!=null){
				...
				phraseKey =nodeID+AppConstants.SEPERATOR_UNDERSCORE+circleID+AppConstants.SEPERATOR_UNDERSCORE+language;
				...
				if(objHotFlashInfo!=null){
					...
					if(AppConstants.Y.equalsIgnoreCase(hotFlashFlag)){
						...
						*//**Remove Time**//*
						...
						mySession.getVariableField(IProjectVariables.DM__INPUT_PATH,IProjectVariables.DM__INPUT_PATH_FIELD_DM__INITIAL_PROMPT).setValue(phraseID);
						flagPlayHotFlash = AppConstants.TRUE;
						//}
					}
				}

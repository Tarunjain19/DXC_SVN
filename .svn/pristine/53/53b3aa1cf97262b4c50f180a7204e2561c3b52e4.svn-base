 ...
 * Last generated by Orchestration Designer at: 2015-JUN-12  07:18:59 PM
 */
public class CheckInput extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "SelectLang_MN Return Code :: ", "SelectLang_MN:ReturnCode").setDebugId(4135));
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "SelectLang_MN Value :: ", "SelectLang_MN:Value").setDebugId(4136));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "SelectLang_MN:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Success", true).setDebugId(4131)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.SetCurrentLanguage("SelectLang_MN:Value", false).setDebugId(4814));
			actions.add(new com.avaya.sce.runtime.Next("CheckRTN", "SelectedLang").setDebugId(4138));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions.add(new com.avaya.sce.runtime.Next("CheckRTN", "Exceeded").setDebugId(754));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

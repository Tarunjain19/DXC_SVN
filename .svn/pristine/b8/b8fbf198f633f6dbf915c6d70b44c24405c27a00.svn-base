 ...
 * Last generated by Orchestration Designer at: 2015-MAR-17  05:43:52 PM
 */
public class DND_MN_0002 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:MainMenu", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 * Last generated by Orchestration Designer at: 2015-APR-02  12:18:24 PM
 */
public class WelcomeAnnc_PA_0001 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:WelcomeAnnc", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

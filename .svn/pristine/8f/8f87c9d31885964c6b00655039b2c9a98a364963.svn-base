 ...
 * Last generated by Orchestration Designer at: 2015-MAR-16  05:02:00 PM
 */
public class Get_Transfer_VDN extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("BEHD_PA_0005_TransferAgent_Annce", "Default");
		next.setDebugId(354);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "UUI DATA :: ", "appVariables:uuiData").setDebugId(1174));
		actions.add(new com.avaya.sce.runtime.varoperations.PrepareAAI("Shared", "", "appVariables:uuiData", "appVariables:uuiData").setDebugId(1173));
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "UUI DATA :: ", "appVariables:uuiData").setDebugId(1175));
	...
	public void requestBegin(SCESession mySession) {
		...
		String strUUI = "";
		String menuID = "";
		String ani = AppConstant.EMPTY_STRING,dnis = AppConstant.EMPTY_STRING;

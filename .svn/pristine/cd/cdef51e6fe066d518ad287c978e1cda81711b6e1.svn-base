 ...
 * Last generated by Orchestration Designer at: 2015-MAY-28  06:14:22 PM
 */
public class Transfer_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:Transfer_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

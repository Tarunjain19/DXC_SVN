 ...
 * Last generated by Orchestration Designer at: 2015-APR-28  11:37:32 AM
 */
public class ThankingYou_PA_0048 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Thank_You_PA", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("PS_Related_Complaints-Tagging");
	}
	/**

...
public interface IProjectVariables {
	...
	public static final String VAR__MISS = "VAR_MISS";
	...
	public static final String VAR__MISS_FIELD_IS_CALL_END_START = "isCallEndStart";
	public static final String VAR__MISS_FIELD_IS_TRANSFFERED = "isTransffered";
	public static final String VAR__MISS_FIELD_JAVA__ERROR = "JAVA_ERROR";

 ...
 */
public class CustomerMenu_MN_0047 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:CustomerMenu_MN_0047", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

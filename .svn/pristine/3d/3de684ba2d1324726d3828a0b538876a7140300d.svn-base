 ...
 * Last generated by Orchestration Designer at: 2015-MAR-11  07:27:30 PM
 */
public class TGSM_PA_0026Copy extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:MyPlanMyPackSMS", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("PostpaidAccountInformation-SetProperty4");
	}
	/**

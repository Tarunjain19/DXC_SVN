 ...
 * Last generated by Orchestration Designer at: 2015-MAY-23  04:50:51 PM
 */
public class RepeatTriesExceeded_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:RepeatTriesExceeded_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

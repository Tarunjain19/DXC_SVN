 ...
 * Last generated by Orchestration Designer at: 2015-MAY-22  07:11:23 PM
 */
public class AnnTollFreeDetails_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:AnnTollFreeDetails_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 * Last generated by Orchestration Designer at: 2015-NOV-12  04:13:23 AM
 */
public class Ann_Max extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_Max", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("LanguageSelection-Ret_CallDisconnect");
		return submit;
	}
	/**

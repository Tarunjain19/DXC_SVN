 ...
 * Last generated by Orchestration Designer at: 2015-MAY-27  07:23:48 PM
 */
public class CancelConfirm_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:CancelConfirm_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Cancel_A_Pack-Check_CancelConfirmMN");
	}
	/**

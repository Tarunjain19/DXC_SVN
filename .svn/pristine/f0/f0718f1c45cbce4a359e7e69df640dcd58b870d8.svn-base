 ...
 */
public class NotAuthorized_PA_0003 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:NotAuthorized_PA_0003", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

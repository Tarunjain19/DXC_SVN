 ...
 * Last generated by Orchestration Designer at: 2015-APR-29  07:56:07 PM
 */
public class AnnBillDetails_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:AnnBillDetails_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

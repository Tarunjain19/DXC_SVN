...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("parseUUIData");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.APP_VARIABLES_FIELD_ACTION,
			IProjectVariables.APP_VARIABLES_FIELD_ACT_RESPONSE_CODE,
			IProjectVariables.APP_VARIABLES_FIELD_ANI,
			IProjectVariables.APP_VARIABLES_FIELD_APPID,
			IProjectVariables.APP_VARIABLES_FIELD_APP_NAME,
			IProjectVariables.APP_VARIABLES_FIELD_CBURL,
			IProjectVariables.APP_VARIABLES_FIELD_CHANNELID,
			IProjectVariables.APP_VARIABLES_FIELD_CIRCLE,
			IProjectVariables.APP_VARIABLES_FIELD_CONTENTID,
			IProjectVariables.APP_VARIABLES_FIELD_CPID,
			IProjectVariables.APP_VARIABLES_FIELD_HOST_RESULT,
			IProjectVariables.APP_VARIABLES_FIELD_IPMODE,
			IProjectVariables.APP_VARIABLES_FIELD_IS_LINK_DOWN,
			IProjectVariables.APP_VARIABLES_FIELD_IVR__APPROACH,
			IProjectVariables.APP_VARIABLES_FIELD_LANGUAGE,
			IProjectVariables.APP_VARIABLES_FIELD_PARENT_APP,
			IProjectVariables.APP_VARIABLES_FIELD_PASSWORD,
			IProjectVariables.APP_VARIABLES_FIELD_PNAME,
			IProjectVariables.APP_VARIABLES_FIELD_PRICE,
			IProjectVariables.APP_VARIABLES_FIELD_PRODUCTID,
			IProjectVariables.APP_VARIABLES_FIELD_TRANSID,
			IProjectVariables.APP_VARIABLES_FIELD_TYPE,
			IProjectVariables.APP_VARIABLES_FIELD_USERID,
			IProjectVariables.APP_VARIABLES_FIELD_VALIDITY };
		...
		variableFields = new String[] {
			...
			IProjectVariables.DM_INPUT_PARAMETER_FIELD_MENU_OPTION_COUNT,
		...
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PROPERTY_FILE_NAME, variableFields, new String[] {"Ann_Thanks.properties", "global.properties", "LinkDown.properties", "Max_Ann.properties", "welcome.properties"}, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.CONFIRM_USER_CHOICE_FIELD_CCGRESPONSE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CONFIRM_USER_CHOICE, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.FLAG_FIELD_IS_CALL_END_START };

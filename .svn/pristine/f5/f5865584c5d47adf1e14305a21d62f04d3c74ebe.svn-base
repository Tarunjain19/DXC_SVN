...
public class LoadOnStartUp extends com.avaya.sce.runtime.BasicServlet {
	...
	public void init() throws ServletException {
		...
		System.out.println("hostConfig is:"+hostConfig);
		...
		AppProperties.setInstance("webservice_data", "C:\\RCOM\\OtherFlows\\RCOM_CF_1925_IVR\\Config\\");
		
		System.out.println("AppConstant.IVR_CONFIG is "+AppConstant.IVR_CONFIG);
		
		
		
		
		String PropertyLocation = AppProperties.GetInstance(AppConstant.IVR_CONFIG).getIVRProp("ConfigFilePath");
		String WebLocation = AppProperties.GetInstance("webservice_data").getIVRProp("CSS_ENDPOINT_DATA_REQUEST");
		
		System.out.println("PropertyLocation is "+PropertyLocation);
		System.out.println("WebLocation is "+WebLocation);

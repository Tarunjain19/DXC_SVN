 ...
 * Last generated by Orchestration Designer at: 2015-MAY-29  10:58:34 AM
 */
public class NonRTN_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:NonRTN_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

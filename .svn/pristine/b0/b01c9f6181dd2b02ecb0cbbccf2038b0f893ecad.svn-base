 ...
 * Last generated by Orchestration Designer at: 2015-APR-02  12:45:29 PM
 */
public class LinkDown_PA_0012 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:LinkDownAnnc", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

...
import com.servion.rcom.hostinterface.view.*;
...
public class Srv_FlagUpdate extends com.avaya.sce.runtime.BasicServlet {
	 ...
	 * Last generated by Orchestration Designer at: 2016-JAN-06  03:21:29 PM
	 */
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("TVP_FlagUpdate-Dat_tvpUpdateCheck", 0, true, "Default");
		list.add(aGoto);

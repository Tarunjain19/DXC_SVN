 ...
 * Last generated by Orchestration Designer at: 2015-MAY-26  07:00:47 PM
 */
public class RetailerDetail_Annc extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:RetailerDetail_Annc", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Locate_Retailer_and_Collect_Area_PIN_Code-Check_From_6666");
	}
	/**

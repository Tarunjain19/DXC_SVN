 ...
 * Last generated by Orchestration Designer at: 2015-MAY-23  06:26:38 PM
 */
public class GetCVV_PC extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:GetCVV_PC", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

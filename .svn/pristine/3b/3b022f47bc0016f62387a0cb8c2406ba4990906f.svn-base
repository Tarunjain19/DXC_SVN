 ...
 */
public class PushSMS_Voice extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid_Start-PuchSMS_VoiceOffer", "Default");
		next.setDebugId(12559);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			trace = mySession.getTraceOutput();
			offerCode = mySession.getVariableField(IProjectVariables.VOICE_OFFERS_MENU,IProjectVariables.VOICE_OFFERS_MENU_FIELD_VALUE).getStringValue();
			key = AppConstant.VOICE_OFFER_SUCCESS+AppConstant.SEPERATOR_UNDERSCORE+offerCode;
			...
			if(AppConstant.N.equalsIgnoreCase(pushSMSkey)){
				pushSMSkey = AppProperties.GetInstance(Constants.IVR_CONFIG).getIVRProp(AppConstant.VOICE_OFFER_SUCCESS);
			}
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO,"Voice Push SMS Failure Key :"+pushSMSkey);

...
public class Set_TGSM_PA_0024 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Account_Information-TGSM_PA_0024", "Default");
		next.setDebugId(3630);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			cdmaUsageBalanceExpiryDate = dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_CDMA_BALANCE_EXPIRY_DATE).getStringValue();
			...
			twoGNetBalanceExpiryDate = dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_TWO_GNET_BALANCE_EXPIRY_DATE).getStringValue();
			...
			initialPrompt=DynamicMenu.playPrompt(dynamicValueList, initialPrompt, AppConstant.NA, AppConstant.PA_0024, trace);

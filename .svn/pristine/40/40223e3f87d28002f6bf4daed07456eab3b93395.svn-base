 ...
 * Last generated by Orchestration Designer at: 2015-SEP-22  04:53:29 PM
 */
public class HostAccess extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "TransactionStatus ::", "appVariables:transactionStatus").setDebugId(4981));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Success", true).setDebugId(5703)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "appVariables:transactionStatus", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Yes", true).setDebugId(1659)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("SetETransaction", "Yes").setDebugId(1661));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("TransactionNotAvailable_PP", "No").setDebugId(1384));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TransferCodes:RCD_TR_0037", false).setDebugId(3854));
			actions.add(new com.avaya.sce.runtime.Next("LinkDown_PP", "LinkDown").setDebugId(3850));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		try {
			...
			if(objLast3ERecharge!=null){
				...
				if(out_mrp!=null && out_status!=null && out_time !=null && !"".equalsIgnoreCase(out_mrp) && !"".equalsIgnoreCase(out_status) && !"".equalsIgnoreCase(out_time)){
					...
					mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_TRANSACTION_STATUS).setValue(AppConstant.Yes);
				}else{
					mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_TRANSACTION_STATUS).setValue(AppConstant.No);
				}

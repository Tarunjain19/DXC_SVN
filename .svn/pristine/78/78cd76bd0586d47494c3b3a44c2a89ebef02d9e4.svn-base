...
public class SetProperty2 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid_Account_Information-PushSMSDataBal", "Default");
		next.setDebugId(2162);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Push SMS Bal Success :", "Prepaid_PushSMSFlag:dataBalFailure").setDebugId(3083));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Prepaid_PushSMSFlag:dataBalSuccess", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Prepaid_constant:Key_true", true).setDebugId(3084)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_Account_Information-IntelCheck", "Skip").setDebugId(3085));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		actions = new java.util.ArrayList(1);
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_PushSMSFlag:dataBalSuccess", "Prepaid_constant:Key_true", false).setDebugId(3086));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			threeGFairUsageBalanceExpiryDate = dataBalance.getComplexVariable().getField(IProjectVariables.PREPAID__DATA_BALANCE_AND_VALIDITY_FIELD_SMS_THREE_GFAIR_USAGE_DATE).getStringValue();
			...
			threeGNetBalanceExpiryDate = dataBalance.getComplexVariable().getField(IProjectVariables.PREPAID__DATA_BALANCE_AND_VALIDITY_FIELD_SMSTHREE_GNET_DATE).getStringValue();
			...
			cdmaUsageBalanceExpiryDate = dataBalance.getComplexVariable().getField(IProjectVariables.PREPAID__DATA_BALANCE_AND_VALIDITY_FIELD_SMSCDMA_USAGE_DATE).getStringValue();
			...
			twoGNetBalanceExpiryDate = dataBalance.getComplexVariable().getField(IProjectVariables.PREPAID__DATA_BALANCE_AND_VALIDITY_FIELD_SMSTWO_GNET_DATE).getStringValue();
			...
			if(!appName.contains(AppConstant.CDMA)){
				...
				if(!AppConstant.N.equalsIgnoreCase(pushSMSkey)){
					...
					mySession.getVariableField(IProjectVariables.PREPAID__PUSH_SMSFLAG,IProjectVariables.PREPAID__PUSH_SMSFLAG_FIELD_PUSH_SMSTEXT).setValue(finalSMSText);
				}else{

 ...
 * Last generated by Orchestration Designer at: 2015-MAY-27  12:46:24 PM
 */
public class Error200_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Error200_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_maxNoMatchCount", "Error200_MN:NomatchRemaining", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("RegisterComplaint_CollectAlternateMN_Error-check_Error200MN");
	}
	/**

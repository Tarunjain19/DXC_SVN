 ...
 * Last generated by Orchestration Designer at: 2015-MAY-14  05:24:47 PM
 */
public class EndCallProcess_BC extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:isException", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Yes", true).setDebugId(2137)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("End", "ForceEnd").setDebugId(2138));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

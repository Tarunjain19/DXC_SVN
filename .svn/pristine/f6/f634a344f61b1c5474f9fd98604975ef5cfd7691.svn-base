 ...
 * Last generated by Orchestration Designer at: 2015-JUN-12  03:28:10 PM
 */
public class TechDiff_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "dm_PropertyFileName:TechDiff_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

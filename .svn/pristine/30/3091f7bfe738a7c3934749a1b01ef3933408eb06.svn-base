	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "GPRS_MN_0015:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:success", true).setDebugId(6217)).evaluate(mySession)) {
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "GPRS_MN_0015:Value", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Grammars:Download", true).setDebugId(6218)).evaluate(mySession)) {
				...
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferReason", "TR_0025", true).setDebugId(6237));
				...
				if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition7", "IVR_CSP_Details:isPostpaid", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(6634)).evaluate(mySession)) {
					actions = new java.util.ArrayList(1);
					actions.add(new com.avaya.sce.runtime.Next("ServiceManagement-PostpaidMainMenu", "(Postpaid Main Menu)").setDebugId(6635));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;

				} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition8", "IVR_CSP_Details:IsPrepaid", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(6636)).evaluate(mySession)) {
					actions = new java.util.ArrayList(1);
					actions.add(new com.avaya.sce.runtime.Next("ServiceManagement-PrepaidMainMenu", "(Prepaid Main Menu)").setDebugId(6637));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;
					...
					actions = new java.util.ArrayList(1);
					actions.add(new com.avaya.sce.runtime.Next("ServiceManagement-ProspectMainMenu", "(Prospect Main Menu)").setDebugId(6639));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:NIFlag", "GPRS_MN_0015:ReturnCode", false).setDebugId(6715));
			actions.add(new com.avaya.sce.runtime.Next("ServiceManagement-Transfer", "Exceeded").setDebugId(6235));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

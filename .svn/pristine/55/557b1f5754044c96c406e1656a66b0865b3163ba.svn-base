 ...
 * Last generated by Orchestration Designer at: 2015-MAY-28  04:06:59 PM
 */
public class ConfirmMobileNumber extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:ConfirmMobileNumber", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_maxNoMatchCount", "ConfirmMobileNumber:NomatchRemaining", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Register_MN-Check_ConfirmMobileNumber");
	}
	/**

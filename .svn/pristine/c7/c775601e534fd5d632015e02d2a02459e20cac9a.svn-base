...
public class EndCall extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			String strDataOffer_Input = mySession.getVariableField(IProjectVariables.CALL_DATA, IProjectVariables.CALL_DATA_FIELD_DATA_OFFER__INPUT).getStringValue();
			callInfo.setRESERVE2(strDataOffer_Input);
			
			if(mySession.getVariableField(IProjectVariables.FLAG,IProjectVariables.FLAG_FIELD_IS_LOW_ARPU).getStringValue().equalsIgnoreCase(Constants.Yes))
				callInfo.setRESERVE3(Constants.LowARPU);

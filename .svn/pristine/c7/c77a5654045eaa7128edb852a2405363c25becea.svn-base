 ...
 */
public class GPMenuRepeat2 extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("Prepaid_GlobalPrompt-Repeat", "Prepaid_Account_Information-Set_TGSM_PA_0020");
		return exitPoints;
	}
}

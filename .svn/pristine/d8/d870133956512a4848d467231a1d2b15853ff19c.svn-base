...
public class Get_HotFlash_Message extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "HotFlashInfo:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:yes", true).setDebugId(147)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("HotFlash-Start_HotFlash").setDebugId(148));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		String strStartDate = "", strEndDate = "", strInitialAudio = "";
		...
		objMapHotFlashInfo = IVRDBServiceInstance.getIVRDBInstance().getHotFlashInfo(ivrDataBean, hotFlashInfo);
		...
		if(objMapHotFlashInfo!=null){
			...
			hotFlashInfo = objMapHotFlashInfo.get(strNodeId+AppConstant.UNDERSCORE+strCircle+AppConstant.UNDERSCORE+strCurrentLanguage);

...
public class PushSMS_STV extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("STVPack_PushSMS");
		next.setDebugId(8245);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			trace = mySession.getTraceOutput();
			pushSMSkey = AppProperties.GetInstance(AppConstant.IVR_CONFIG).getIVRProp(AppConstant.STV_SUCCESS);

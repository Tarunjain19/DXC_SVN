 ...
 * Last generated by Orchestration Designer at: 2015-APR-30  11:42:16 AM
 */
public class CS_ClosedDisconnect_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:CS_ClosedDisconnect_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

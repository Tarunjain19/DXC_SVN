...
@Entity
@NamedStoredProcedureQuery(name=Constants.PROC_SP_IVR_SERVICE_UPDATION, procedureName = Constants.SP_IVR_SERVICE_UPDATION, resultClasses = com.rcom.prepaid.model.ServiceUpdateInfo.class,
parameters = {

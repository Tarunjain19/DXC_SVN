 ...
 * Last generated by Orchestration Designer at: 2015-SEP-21  04:08:47 PM
 */
public class SelectLangApp_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_globalPropertyFileName", "dm_InputPath:dm_globalPropertyFileName", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "dm_PropertyFileName:SelectLang_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

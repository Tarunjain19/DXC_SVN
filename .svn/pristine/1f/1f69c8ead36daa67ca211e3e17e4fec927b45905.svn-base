...
public class CollectMonthDetail_Evalute extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "CollectMonthDetail:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Prepaid_constant:success", true).setDebugId(1258)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Prepaid_Flag:validDate", com.avaya.sce.runtime.Expression.STRING_NOT_EQUAL_IGNORE, "Prepaid_constant:Key_true", true).setDebugId(2817)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.varoperations.Increment("Prepaid_appVariables:monthCount").setDebugId(2802));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

				if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "Prepaid_appVariables:monthCount", com.avaya.sce.runtime.Expression.INT_LESS_THAN, "3", false).setDebugId(2803)).evaluate(mySession)) {
					actions = new java.util.ArrayList(1);
					actions.add(new com.avaya.sce.runtime.Next("Prepaid_BuyThePack-InvalidMonth_Anno", "invalid").setDebugId(2812));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;
					...
					actions = new java.util.ArrayList(2);
					actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:transferCode", "TR_0011", true).setDebugId(2853));
					actions.add(new com.avaya.sce.runtime.Next("Prepaid_BuyThePack-Tries_ExceededMonth", "ExceededTries").setDebugId(2815));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("Prepaid_BuyThePack-CollectCVV", "CollectCVV").setDebugId(1259));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:transferCode", "TR_0046", true).setDebugId(2850));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_BuyThePack-agent", "ExceededTries").setDebugId(2788));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		if(AppConstant.Success.equalsIgnoreCase(returnCode)){
			...
			mySession.getVariableField(IProjectVariables.PREPAID__FLAG,IProjectVariables.PREPAID__FLAG_FIELD_VALID_DATE).setValue(isValidDate);

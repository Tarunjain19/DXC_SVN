...
public class SetIVRDisconnect extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		String strApplicationName = mySession.getVariableField(IProjectVariables.APP__VARIABLES, IProjectVariables.APP__VARIABLES_FIELD_APP_NAME).getStringValue();
		String isLinkDown = mySession.getVariableField(IProjectVariables.APP__VARIABLES,IProjectVariables.APP__VARIABLES_FIELD_IS_LINK_DOWN).getStringValue();
		...
		if(isLinkDown.equalsIgnoreCase(Constants.Yes))

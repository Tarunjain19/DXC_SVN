 ...
 * Last generated by Orchestration Designer at: 2015-NOV-09  04:07:08 PM
 */
public class Begin extends com.avaya.sce.runtime.BasicServlet {
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("EndCallProcess-Dat_CallDisconnect", 0, true, "Start");
		list.add(aGoto);

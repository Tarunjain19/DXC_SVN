 ...
 * Last generated by Orchestration Designer at: 2015-JUN-01  01:20:10 PM
 */
public class ConfirmCashCardNo_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:ConfirmCashCardNo_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("RechargeAcUsingCashCard-ConfirmCashCardNo");
	}
	/**

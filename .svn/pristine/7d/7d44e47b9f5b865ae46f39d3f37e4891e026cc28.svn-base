 ...
 */
public class GlobalPromptFeatureLevel extends com.avaya.sce.runtime.Invoke {
	 ...
	 * Last generated by Orchestration Designer at: 2015-MAY-21  07:49:20 PM
	 */
	public GlobalPromptFeatureLevel() {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:GlobalPromptFeatureLevel", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("GlobalPromptFL-CheckValue");
	}
	/**

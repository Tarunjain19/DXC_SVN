 ...
 * Last generated by Orchestration Designer at: 2015-SEP-08  03:25:05 PM
 */
public class ReqSuccessful_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:ReqSuccessful_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 */
public class Get_TopUpInfo extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid_Start-TopUpContinInfo", "Default");
		next.setDebugId(10826);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Top Up minAmount :: "+minAmount +":: TopUp minTalkTimet ::"+minTalkTimet);
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Top Up maxAmount :: "+maxAmount +":: TopUp maxTalkTime ::"+maxTalkTime);
			
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.PA_0041;
			...
			if(minAmount != null && !AppConstant.EMPTY_STRING.equals(minAmount) && minTalkTimet != null && !AppConstant.EMPTY_STRING.equals(minTalkTimet)){
				trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "MAX topup Value is added");
				dynamicValue.add(minAmount);
				dynamicValue.add(minTalkTimet+AppConstant.currency);
				count ++;
			}
			
			if(maxAmount != null && !AppConstant.EMPTY_STRING.equals(maxAmount) && maxTalkTime != null && !AppConstant.EMPTY_STRING.equals(maxTalkTime)){
				trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "MAX topup Value is added");
				dynamicValue.add(maxAmount);
				dynamicValue.add(maxTalkTime+AppConstant.currency);
				count ++;
			}

 ...
 * Last generated by Orchestration Designer at: 2015-MAY-27  08:03:47 PM
 */
public class CancelSuccess_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:CancelSuccess_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Cancel_A_Pack-Check_CancelSuccessMenu");
	}
	/**

 ...
 * Last generated by Orchestration Designer at: 2015-MAY-26  11:45:26 AM
 */
public class Begin extends com.avaya.sce.runtime.BasicServlet {
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("Language_Selection-CheckIsFromRTN", 0, true, "Start");
		list.add(aGoto);

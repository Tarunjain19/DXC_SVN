 ...
 */
public class WS_Chk_ACC_in_CMS_UnmannedFire extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2016-NOV-09  12:08:34 PM
	 */
	public WS_Chk_ACC_in_CMS_UnmannedFire() {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:WebServiceResponse", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "CONSTANTS:SUCCESS", true).setDebugId(9)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "AppVariables:IsSingleAccount", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(10)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:IsSingleAccount", "CONSTANTS:FALSE", false).setDebugId(11));
				actions.add(new com.avaya.sce.runtime.Next("UnManned_Fire_And_Shock-Set_AccNum4", "Single").setDebugId(12));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "AppVariables:IsNoAccount", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(13)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:IsNoAccount", "CONSTANTS:FALSE", false).setDebugId(14));
				actions.add(new com.avaya.sce.runtime.Next("UnManned_Fire_And_Shock-Unmanned_Input_MenuFire", "NoAcc").setDebugId(15));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("UnManned_Fire_And_Shock-Unmanned_Input_MenuFire", "MultiAcc").setDebugId(17));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("UnManned_Fire_And_Shock-LinkDown", "Failure").setDebugId(24));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

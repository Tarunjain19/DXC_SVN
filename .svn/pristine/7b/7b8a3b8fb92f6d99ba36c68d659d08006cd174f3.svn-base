 ...
 * Last generated by Orchestration Designer at: 2015-MAR-17  02:53:43 PM
 */
public class DND_PA_0010 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Cannot_DeRegistration", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

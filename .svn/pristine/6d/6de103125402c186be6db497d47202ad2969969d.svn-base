package com.rcom.red.resource;

import org.springframework.context.ApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;

import com.rcom.red.dbservice.IVRDataService;
...
public class IVRDBServiceInstance {
	...
	private IVRDBServiceInstance(){
		...
		ApplicationContext ctx = new ClassPathXmlApplicationContext("red-application-context.xml");
		ivrdbService = (IVRDataService) ctx.getBean("redDataServices");

 ...
 * Last generated by Orchestration Designer at: 2015-JUN-17  07:24:17 PM
 */
public class KnowCaller_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:KnowCaller_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

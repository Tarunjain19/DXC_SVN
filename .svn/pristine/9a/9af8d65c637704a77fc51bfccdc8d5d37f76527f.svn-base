 ...
 * Last generated by Orchestration Designer at: 2016-JUL-27  05:59:22 PM
 */
public class GSMPostpaidOffer extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			String circleid = mySession.getVariableField(IProjectVariables.CIRCLE__ID).getStringValue();
			
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "initialPrompt Value : "+circleid);
			
			key= "PLAY_POST_OFFER_"+circleid;
			
			initialPrompt = ivrProperties.getIVRProp(key);
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "initialPrompt Value : "+initialPrompt);
			
			initialPrompt = initialPrompt.replace("Circle", circleid);
			
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "initialPrompt Value after replcaing circle : "+initialPrompt);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("GSMPost_Offer_MN", "Default");
		next.setDebugId(7084);
		return next;
	}
	/**

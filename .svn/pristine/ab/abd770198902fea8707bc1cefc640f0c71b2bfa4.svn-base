 ...
 * Last generated by Orchestration Designer at: 2015-MAY-28  12:34:13 PM
 */
public class AccountBalance_Annc extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:AccountBalance_Annc", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

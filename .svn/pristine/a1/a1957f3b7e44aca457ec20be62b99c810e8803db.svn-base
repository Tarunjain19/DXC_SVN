 ...
 * Last generated by Orchestration Designer at: 2015-APR-28  12:12:33 PM
 */
public class BillingQueries_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:BillingQueries_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("CheckBillingQueriesValue_BC");
	}
	/**

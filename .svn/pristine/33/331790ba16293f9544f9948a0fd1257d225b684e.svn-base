 ...
 * Last generated by Orchestration Designer at: 2015-OCT-27  09:26:30 AM
 */
public class Begin extends com.avaya.sce.runtime.BasicServlet {
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("TVP_StatusCheck-Dat_TVP_StatusCheck", 0, true, "Start");
		list.add(aGoto);

 ...
 * Last generated by Orchestration Designer at: 2015-MAR-16  06:23:32 PM
 */
public class HLR_PA_0007 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Non_Business_Hour", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

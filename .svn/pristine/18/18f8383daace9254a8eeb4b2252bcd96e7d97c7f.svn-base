 ...
 * Last generated by Orchestration Designer at: 2015-JUN-28  04:56:33 PM
 */
public class BalSMSAnn extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:BalSMSAnn", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Account_Information-PushSMS");
	}
	/**

 ...
 */
public class Set_RCD_MN_0015 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		{	/** Forming the Dynamic Prompt **/
			...
			getNum = mySession.getVariableField(IProjectVariables.MOBILE_NUMBER__MN,IProjectVariables.MOBILE_NUMBER__MN_FIELD_VALUE).getStringValue();
			key = appName+AppConstant.SEPERATOR_HYPEN+AppConstant.RCD_MN_0015;
			initialPrompt = AppProperties.GetInstance(AppConstant.DYN_MENU).getIVRProp(key);
			dynamicList.add(getNum);
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Dynamic Prompt Key "+AppConstant.RCD_MN_0015+" :: "+key);
			
			/** Invoking the playPromt method **/
			DynamicMenu dynamicMenu = new DynamicMenu();
			initialPrompt = DynamicMenu.playPrompt(dynamicList, initialPrompt, dynamicList.size()+"",trace);
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Confirmation Initial Prompt "+AppConstant.RCD_MN_0015+" :: "+initialPrompt);

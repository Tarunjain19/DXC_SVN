 ...
 */
public class Set_RCD_PA_0020 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("ERechargeTransaction_PP", "Default");
		next.setDebugId(4026);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		String key = null,getMDN = null,appName = null,initialPrompt = null,getDate = null,getTime = null,getAmt = null,getStatus = null;
		...
		{	/** Forming the Dynamic Prompt **/
			...
			getDate = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_GET_DATE).getStringValue();
			getTime = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_GET_TIME).getStringValue();
			...
			key = appName+AppConstant.SEPERATOR_HYPEN+AppConstant.RCD_PA_0020;
			initialPrompt = AppProperties.GetInstance(AppConstant.DYN_MENU).getIVRProp(key);
			dynamicList.add(getMDN);
			dynamicList.add(getDate);
			dynamicList.add(getAmt+AppConstant.currency);
			dynamicList.add(getStatus);
			
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Dynamic Prompt Key "+AppConstant.RCD_PA_0020+" :: "+key);
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Confirmation Initial Prompt "+AppConstant.RCD_PA_0020+" :: "+initialPrompt);
		...
		{initialPrompt = null;getMDN = null;getDate = null;getTime = null;getAmt = null;getStatus = null;appName=null;key=null;}
	}

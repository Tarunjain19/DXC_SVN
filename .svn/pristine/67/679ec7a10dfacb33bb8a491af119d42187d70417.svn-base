 ...
 * Last generated by Orchestration Designer at: 2015-MAY-11  05:50:58 PM
 */
...
public void requestBegin(SCESession mySession) {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:isException", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:yes", true).setDebugId(2577)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:isException", "constant:yes", false).setDebugId(2898));
			actions.add(new com.avaya.sce.runtime.Next("End", "ForcedEnd").setDebugId(2578));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

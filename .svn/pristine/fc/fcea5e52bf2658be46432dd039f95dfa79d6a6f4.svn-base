...
public class Set_ChangeLangMenu extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid_Start-ChangeLanguageMenu");
		next.setDebugId(9440);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			circleLangCode = mySession.getVariableField(IProjectVariables.ROUTING_INFO, IProjectVariables.ROUTING_INFO_FIELD_CIRCLE_LANGUAGES).getStringValue();
			...
			if(circleLangCode!=null){
				...
				for(int i = 0;i<arrayLangCode.length;i++){
					...
					if(!currentLang.equalsIgnoreCase(circleLanguage)){
						...
						arrLanguage.add(AppProperties.GetInstance(Constants.AUDIO_CONFIG).getIVRProp(circleLanguage));

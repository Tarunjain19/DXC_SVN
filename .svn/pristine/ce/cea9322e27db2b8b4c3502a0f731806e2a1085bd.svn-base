...
public class executePackAndPlanDetails extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Prepaid_appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Prepaid_constant:success", true).setDebugId(2768)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:transferCode", "TR_0082", true).setDebugId(3032));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_Account_Information-TGSM_PA_0026", "success").setDebugId(2769));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Prepaid_appVariables:transferCode", "TR_0081", true).setDebugId(3033));
			actions.add(new com.avaya.sce.runtime.Next("Prepaid_Account_Information-TGSM_PA_0082", "error").setDebugId(2771));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

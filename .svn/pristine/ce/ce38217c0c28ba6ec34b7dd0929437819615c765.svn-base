 ...
 * Last generated by Orchestration Designer at: 2015-MAR-16  06:43:37 PM
 */
public class LoadOnStartUp extends com.avaya.sce.runtime.MLServlet {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CallStart");
		return submit;
	}
	...
	public void init() throws ServletException {
		...
		logger.trace("IVR_CONFIG_PATH :: "+this.getServletContext().getInitParameter(AppConstant.IVR_CONFIG));
		System.out.println("IVR_CONFIG_PATH :: "+this.getServletContext().getInitParameter(AppConstant.IVR_CONFIG));
		LoadProperty appProperties = new LoadProperty(this.getServletContext().getInitParameter(AppConstant.IVR_CONFIG));

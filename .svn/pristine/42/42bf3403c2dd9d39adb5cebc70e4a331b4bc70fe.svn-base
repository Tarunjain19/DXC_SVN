...
public class AccessDB_DNCDeregisterDays extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			if(daydiff >= 3)
			{
				...
				if(dndActivationDate != null && dndActivationDate != Constants.EMPTY_STRING)
				{
			...
			if(dndInfo.getActivationDate() == null){
				trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "DNC deactivation is not done and activation not activated");
				mySession.getVariableField(IProjectVariables.FLAG, IProjectVariables.FLAG_FIELD_IS_DNCREGISTRATION_DONE).setValue(Constants.No);
				mySession.getVariableField(IProjectVariables.FLAG, IProjectVariables.FLAG_FIELD_IS_DNCDEREGISTRATION_DONE).setValue(Constants.Yes);
			}else{
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:True", true).setDebugId(6477)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_CRITICAL, "DB Down|Service Managemant flow|AccessHost_ActivateILDl|", "EPM_Alarm:Description", true).setDebugId(6478));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "Constants:False", false).setDebugId(6479));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(3058)).evaluate(mySession)) {
			actions = new java.util.ArrayList(3);

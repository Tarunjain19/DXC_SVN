 ...
 * Last generated by Orchestration Designer at: 2016-JUN-01  04:25:36 PM
 */
public class Set_MN_0054 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("ConfirmCDMANumber");
		next.setDebugId(16030);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "CollectCDMAMobileNumber", "propertyFileName:CollectCDMANumber").setDebugId(15991));
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			String getMobileNumber = mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_PLAY_NUMBER).getStringValue();
			...
			appName =  mySession.getVariableField(IProjectVariables.APP_NAME).getStringValue();
				...
				key = appName+AppConstant.SEPERATOR_HYPEN+AppConstant.MN_0154;
				...
				initialPrompt = DynamicMenu.playPrompt(dynamicList, initialPrompt, AppConstant.NA, AppConstant.MN_0154, trace);

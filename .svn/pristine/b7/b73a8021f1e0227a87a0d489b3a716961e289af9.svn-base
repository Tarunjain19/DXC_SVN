 ...
 */
public class Set_MN_0042 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("MN_0042", "Default");
		next.setDebugId(10298);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.MN_0029;
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Voice Offer Confirmation initial Prompt Before Dynamic Insertion:: "+initialPrompt);
			...
			mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_PACK_WAVE).setValue(offerID);
			
			DynamicMenu objDynamicMenu = new DynamicMenu();
			initialPrompt=DynamicMenu.playPrompt(dynamicWave, initialPrompt, AppConstant.NA, AppConstant.MN_0029, trace);
			
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Voice Offer initial Prompt :: "+initialPrompt);

...
public class AccessHost_SR extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			strMDN = mySession.getVariableField(IProjectVariables.GET_DATA_CARD, IProjectVariables.GET_DATA_CARD_FIELD_VALUE).getStringValue();
			...
			if((resServiceRequestDetails.getResponseCode()).equals(Constants.zero)){
				...
				if(strSLADate != null){
					...
					if(dateSLADate.compareTo(callDate)<0){
						mySession.getVariableField(IProjectVariables.POSTPAID__FLAG, IProjectVariables.POSTPAID__FLAG_FIELD_IS_SLADATE_VALID).setValue(Constants.Yes);
					}else{
						mySession.getVariableField(IProjectVariables.POSTPAID__FLAG, IProjectVariables.POSTPAID__FLAG_FIELD_IS_SLADATE_VALID).setValue(Constants.No);
						
						dynamicMenu = new DynamicMenu();
						dynamicList = new ArrayList<String>();
						audioConfigInstance = AppProperties.GetInstance(AppConstant.DYN_MENU);
						...
						strInitialAudios = audioConfigInstance.getIVRProp(strApplicationName+Constants.HYPEN+Constants.HSDI_PA_0007);
					...
					mySession.getVariableField(IProjectVariables.POSTPAID__FLAG, IProjectVariables.POSTPAID__FLAG_FIELD_IS_SLADATE_VALID).setValue(Constants.NoRecord);
				}
			}else{
				mySession.getVariableField(IProjectVariables.POSTPAID__FLAG, IProjectVariables.POSTPAID__FLAG_FIELD_IS_SLADATE_VALID).setValue(Constants.NoRecord);
			}
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Postpaid_Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(8016)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_Flag:isLinkDown", "Postpaid_Constants:no", false).setDebugId(8017));
			actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-AccessDB_CRMCount", "LinkDown").setDebugId(8018));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Postpaid_Flag:isSLADateValid", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(8020)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("Postpaid_CallData:transferReasonCode", "Postpaid_Constants:TR_0004", false).setDebugId(8021));
				actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-PostpaidTransfer", "Transfer").setDebugId(8022));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

			} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "Postpaid_Flag:isSLADateValid", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "NoRecord", false).setDebugId(8023)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-AccessDB_CRMCount", "NoRecord").setDebugId(8024));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-PlayworkInProgress_PA_0005", "WorkInProgress").setDebugId(8026));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

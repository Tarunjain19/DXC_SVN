 ...
 */
public class BalanceAmt_PP extends com.avaya.sce.runtime.Invoke {
	 ...
	 * Last generated by Orchestration Designer at: 2016-MAY-12  05:47:09 PM
	 */
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:BalanceAmt_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 * Last generated by Orchestration Designer at: 2015-JUN-24  06:27:43 PM
 */
public class Set_MN0007 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Subscribe_MN", "Default");
		next.setDebugId(4868);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			key = appName +AppConstants.SEPERATOR_HYPEN+ AppConstants.MN_0007;

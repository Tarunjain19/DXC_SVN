 ...
 * Last generated by Orchestration Designer at: 2015-AUG-24  03:26:23 PM
 */
public class CheckBill_MN_0009 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:CheckBill_MN_0009", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("AccountInformation-Evaluate_MN_0009");
	}
	/**

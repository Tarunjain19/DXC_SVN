 ...
 */
@Entity
@NamedStoredProcedureQuery(name=Constants.PROC_spsvn_GetIVRHotFlash, procedureName = Constants.spsvn_GetIVRHotFlash, resultClasses = com.rcom.postpaid.model.HotFlashInfo.class, 
parameters = {

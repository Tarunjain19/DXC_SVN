 ...
 * Last generated by Orchestration Designer at: 2015-APR-27  05:54:07 PM
 */
public class HotFlash_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_globalPropertyFileName", "DM_propertyFileName:global", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

...
public class Evaluate_MN_0028 extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Verified MDN 2:", "CallData:numberVerificationMDN").setDebugId(2574));
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "ActivateOffer_MN_0028:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:success", true).setDebugId(2003)).evaluate(mySession)) {
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("Flag:NIFlag", "ActivateOffer_MN_0028:ReturnCode", false).setDebugId(2573));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

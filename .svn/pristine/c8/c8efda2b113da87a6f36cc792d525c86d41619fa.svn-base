 ...
 * Last generated by Orchestration Designer at: 2015-MAR-11  04:35:59 PM
 */
public class Set_TGSM_PA_0020 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid_Account_Information-TGSM_PA_0020", "Default");
		next.setDebugId(971);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		String expiryDate = null,accountBalance = AppConstant.EMPTY_STRING;
		...
		try
		{
			...
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.PA_0020;
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Non Zero Balance initial Prompt Before Dynamic Insertion:: "+initialPrompt);
			
			expiryDate = mySession.getVariableField(IProjectVariables.PREPAID__MAIN_ACCOUNT_BALANCE_AND_VALIDITY, IProjectVariables.PREPAID__MAIN_ACCOUNT_BALANCE_AND_VALIDITY_FIELD_DATE).getStringValue();
			...
			dynamicValueList.add(accountBalance+AppConstant.currency);
			...
			trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Non Zero Balance initial Prompt :: "+initialPrompt);

 ...
 * Last generated by Orchestration Designer at: 2015-APR-27  12:53:34 PM
 */
public class MulAccount_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:MulAccount_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

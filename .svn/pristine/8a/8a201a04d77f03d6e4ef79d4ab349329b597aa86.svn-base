 ...
 * Last generated by Orchestration Designer at: 2016-FEB-29  02:09:58 PM
 */
public class Ann_Hotflash extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_HotFlash", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CF_HotFlash-end");
		return submit;
	}
	/**

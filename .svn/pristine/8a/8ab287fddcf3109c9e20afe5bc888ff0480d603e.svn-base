...
public class TransPaymentUsingCoreBalance implements ITransaction{
	...
	public ResPaymentUsingCoreBalance getHostInterface(IVRDataBean ivrDataBean, ReqPaymentUsingCoreBalance request){
		...
		try{
			...
			logger.info(uniqueId + "|" + "TransPaymentUsingCoreBalance getHostInterface method start");
			wsdlProcessor();
			logger.info(uniqueId + "|" + "Response Code to Call Flow : " + responseCode);
			logger.info(uniqueId + "|" + "TransPaymentUsingCoreBalance getHostInterface method end");
	...
	public void wsdlProcessor() {
		...
		try {
			...
			logger.info(uniqueId + "|" + "Before calling Buy the pack using core balance Service");
			...
			request = null;
			logger.info(uniqueId + "|" + "After calling Buy the pack using core balance Service");

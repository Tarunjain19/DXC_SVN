 ...
 * Last generated by Orchestration Designer at: 2015-JUL-21  02:22:50 PM
 */
public class GetPaymentAmount extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:GetPaymentAmount", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Prepaid-check_GetPayment");
	}
	/**

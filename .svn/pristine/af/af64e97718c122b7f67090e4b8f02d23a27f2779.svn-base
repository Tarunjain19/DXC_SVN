...
public class TGSM_MN_0006 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "Prepaid_propertyFileName:MainAccountBalance_Credit_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Prepaid_Account_Information-Check_TGSM_MN_0006");
	}
	/**

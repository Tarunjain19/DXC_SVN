...
public class Get_IVR_Data extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid_Start-DataOffersMenu");
		next.setDebugId(13194);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.MN_0015;

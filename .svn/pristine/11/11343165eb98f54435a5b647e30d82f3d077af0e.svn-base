...
public class Initialize_PA_0027 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			dynamicValueList.add(strMode);
			
			key = strApplicationName +AppConstant.SEPERATOR_HYPEN+ AppConstant.PA_0030;
			info.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Key :: "+key);
			
			strInitialAudio = audioPropertyInstance.getIVRProp(strApplicationName+AppConstant.SEPERATOR_HYPEN+AppConstant.PA_0030);
			strInitialAudio = DynamicMenu.playPrompt(dynamicValueList, strInitialAudio, null, AppConstant.PA_0030 , info);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("PostpaidAccountInformation-DeliveryStatus_PA_0027", "Default");

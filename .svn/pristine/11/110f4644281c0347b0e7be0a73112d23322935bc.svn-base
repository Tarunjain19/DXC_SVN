 ...
 * Last generated by Orchestration Designer at: 2015-JUN-01  04:10:03 PM
 */
public class ThankU extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:ThankU", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

...
public class TransDNCregistration implements ITransaction{
	...
	public void wsdlProcessor() {
		...
		try {
			...
			serviceURL = appProperties.getIVRProp(HostConstants.CSS_ENDPOINT_URL_DNC_ACT);
			...
			request.setRequestType(appProperties.getIVRProp(HostConstants.CSS_REQUEST_TYPE_DNC_ACTIVATION));
			...
			//For Reporting
			host.setHOSTMETHOD(HostConstants.CSS_HOST_METHOD + HostConstants.PIPE + appProperties.getIVRProp(HostConstants.CSS_REQUEST_TYPE_DNC_ACTIVATION));

		...
		try{
			...
			if(strData!=null && !Constants.EMPTY_STRING.equals(strData)){
				...
				if(major!=0){
					...
					if(major==1){
						playcurrency = playcurrency+Constants._Star+majorCurrency;
					}else{
						playcurrency = playcurrency+Constants._Star+majorCurrency;
					}
				}
				if(arrayData.length>1){
					...
					if(minor!=0 && major!=0){
						playcurrency =  playcurrency+Constants._Star+fillerWave+Constants._Star+Constants.SS+minor+Constants.number+Constants._Star+minorCurrency;
					}else if(minor!=0){
						playcurrency =Constants.SS+minor+Constants.number+Constants._Star+minorCurrency;
					}else if(major == 0 && minor == 0){
						playcurrency =Constants.SS+major+Constants.number+Constants._Star+majorCurrency;
					}
				}
			}else{

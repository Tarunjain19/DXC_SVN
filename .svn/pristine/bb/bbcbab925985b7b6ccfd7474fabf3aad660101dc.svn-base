 ...
 * Last generated by Orchestration Designer at: 2015-MAY-27  12:17:59 PM
 */
public class HotFlash extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("HotFlash-Return", "RegisterComplaint_CollectAlternateMN_Error-Error400_MN");
		return exitPoints;
	}
}

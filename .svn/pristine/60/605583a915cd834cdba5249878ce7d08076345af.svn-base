 ...
 * Last generated by Orchestration Designer at: 2015-MAY-24  04:18:48 PM
 */
public class Last3PaymentDetails_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:Last3PaymentDetails_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 * Last generated by Orchestration Designer at: 2015-MAR-12  06:27:27 PM
 */
public class GPMenuRepeat extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("Prepaid_GlobalPrompt-PreviousMenu", "Prepaid_Account_Information-TGSM_MN_0004");
		exitPoints.put("Prepaid_GlobalPrompt-Repeat", "Prepaid_Account_Information-TGSM_PA_0018");
		return exitPoints;
	}
}

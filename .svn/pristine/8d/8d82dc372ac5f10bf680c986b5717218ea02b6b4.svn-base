 ...
 * Last generated by Orchestration Designer at: 2015-MAR-17  02:52:45 PM
 */
public class OfficeHour_RED_PA_0003 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:RED_PA_0003_property", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

...
public class Fetch_RechargeAmount extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:IsHostFailure", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "CONSTANTS:YES", true).setDebugId(2664)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:RD01_TR_0011", false).setDebugId(2665));
			actions.add(new com.avaya.sce.runtime.Next("Recharge_Account_Using_Cash_Card-link_down", "linkdown").setDebugId(2666));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:ForPurchase", "CONSTANTS:NO", false).setDebugId(2674));
			actions.add(new com.avaya.sce.runtime.Next("Recharge_Account_Using_Cash_Card-Get_PIN", "cash-card").setDebugId(2675));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		{rechargeAmount = null;fetchRechargeAmount=null;trace=null;}

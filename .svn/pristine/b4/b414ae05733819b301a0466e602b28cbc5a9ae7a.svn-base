 ...
 * Last generated by Orchestration Designer at: 2015-JUN-09  03:55:01 PM
 */
public class ExceededTries_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:ExceededTries_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 */
public class GlobalMenuFreeUnitInfoLD extends com.avaya.sce.runtime.Subflow {
	 ...
	 * Last generated by Orchestration Designer at: 2015-APR-15  08:54:55 PM
	 */
	public GlobalMenuFreeUnitInfoLD() {
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("GlobalMenu-Repeat", "AccountInformation-FreeUnitInfoLinkDown_PA_0017");

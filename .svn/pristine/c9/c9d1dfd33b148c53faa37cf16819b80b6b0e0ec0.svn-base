...
public class InitializeLanguage extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			info.writeln(ITraceInfo.TRACE_LEVEL_INFO,"DATA_MN_0006 Property file Value :"+strReginalLanguage);
			arrLanguages = strReginalLanguage.split(",");
			strInitialAudio =AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(Constants.DATA_MN_0006);
			//strInitialAudio = LoadProperty.getivrconfigProp(Constants.TELV_MN_0006);
			
			info.writeln(ITraceInfo.TRACE_LEVEL_INFO,"DATA_MN_0006 Property file Value :"+strInitialAudio);
			...
			for (int i = 0; i < arrLanguages.length; i++) {
				...
				dynamicValueList.add(AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp(arrLanguages[i]));
			...
			info.writeln(ITraceInfo.TRACE_LEVEL_INFO,"strInitialAudio is :"+strInitialAudio);
			info.writeln(ITraceInfo.TRACE_LEVEL_INFO,"strReginalLanguage is :"+strReginalLanguage);
			info.writeln(ITraceInfo.TRACE_LEVEL_INFO,"arrLanguages.length is :"+arrLanguages.length);
			...
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_MENU_OPTION_COUNT).setValue(arrLanguages.length);
			 ...
			 String PropertyLocation=AppProperties.GetInstance(AppConstant.IVR_SIM_CONFIG).getIVRProp("ENG_ConfigFilePath");
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Language_SIM_MN_0001", "Default");
		next.setDebugId(4150);
		return next;
	}
	/**

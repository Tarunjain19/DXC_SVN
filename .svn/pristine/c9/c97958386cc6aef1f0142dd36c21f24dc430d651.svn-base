...
import com.rcom.prepaid.model.BarringInfo;
...
public class AccessDB_CheckDunnedCaller extends com.avaya.sce.runtime.Data {
			...
			if(barringInfo!=null){
				...
				if((barringInfo.getBarringType())!=null){
					...
					if((strBarringType.equalsIgnoreCase("TBD"))||(strBarringType.equalsIgnoreCase("VBD"))){
						...
						mySession.getVariableField(IProjectVariables.POSTPAID__FLAG, IProjectVariables.POSTPAID__FLAG_FIELD_IS_CALLER_DUNNED).setValue(Constants.Yes);
					}else{
						info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "---> Caller Not Dunned, Baring type :"+strBarringType);
						mySession.getVariableField(IProjectVariables.POSTPAID__FLAG, IProjectVariables.POSTPAID__FLAG_FIELD_IS_CALLER_DUNNED).setValue(Constants.No);
					}
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Postpaid_Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(8353)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-AccessHost_SR", "LinkDown").setDebugId(8354));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Postpaid_Flag:isCallerDunned", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Postpaid_Constants:yes", true).setDebugId(8356)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-AccessHost_UnbilledInfo", "CallerDunned").setDebugId(8357));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("PostpaidStartFlow-AccessHost_SR", "CallerNotDunned").setDebugId(8359));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

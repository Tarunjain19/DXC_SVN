 ...
 */
public class Postpaid_MainMenu extends com.avaya.sce.runtime.Invoke {
	 ...
	 * Last generated by Orchestration Designer at: 2016-JAN-25  06:26:28 PM
	 */
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "dm_PropertyFileName:PostpaidMainMenu_MM", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Postpaid_SPIVR_MN_0007_Data");
	}
	/**

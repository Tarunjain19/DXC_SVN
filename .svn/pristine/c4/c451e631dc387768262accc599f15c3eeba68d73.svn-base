 ...
 * Last generated by Orchestration Designer at: 2015-OCT-27  02:16:27 PM
 */
public class Ann_ActivationMsg extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_ActivationMsg", ""));

...
public class executeDataBalance extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(1119)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "dataBalanceAndValidity:noDataFlag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:Key_False", true).setDebugId(1122)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);

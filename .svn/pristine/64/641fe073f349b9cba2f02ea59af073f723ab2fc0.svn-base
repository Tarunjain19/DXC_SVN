 ...
 * Last generated by Orchestration Designer at: 2015-SEP-24  07:25:17 PM
 */
public class TransactionAvailableCheck extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2015-SEP-24  07:25:17 PM
	 */
	public TransactionAvailableCheck() {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Success", true).setDebugId(5709)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "appVariables:ERechargeTransactionAvailable", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Yes", true).setDebugId(4017)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("Set_RCD_PA_0020", "Yes").setDebugId(4019));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("NoERechargeTransaction_PP", "No").setDebugId(4016));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("LinkDown_PP", "LinkDown").setDebugId(5715));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
	    ...
	    String donor_mdn = AppConstant.EMPTY_STRING;
		...
		try {
			...
			/**Assigning**/
			mdn = mySession.getVariableField(IProjectVariables.MOBILE_NUMBER__MN,IProjectVariables.MOBILE_NUMBER__MN_FIELD_VALUE).getStringValue();
			appName = mySession.getVariableField(IProjectVariables.APPNAME).getStringValue();
			donor_mdn = mySession.getVariableField(IProjectVariables.SESSION,IProjectVariables.SESSION_FIELD_ANI).getStringValue();
			...
			objLast3ERecharge.setIn_donor_mdn(donor_mdn);
			objLast3ERecharge.setIn_ivr_code("4");
			...
			if(objLast3ERecharge!=null){
				...
				if(out_mrp!=null && out_status!=null && out_time !=null && !"".equalsIgnoreCase(out_mrp) && !"".equalsIgnoreCase(out_status) && !"".equalsIgnoreCase(out_time)){
					...
					mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_ERECHARGE_TRANSACTION_AVAILABLE).setValue(AppConstant.Yes);
					...
					SimpleDateFormat spdf = new SimpleDateFormat("dd-MMM-yy");
					SimpleDateFormat spdf1 = new SimpleDateFormat("yyyyMMdd");
					Date d1 = spdf.parse(out_time);
					String formatedDate = spdf1.format(d1);
					trace.writeln(ITraceInfo.TRACE_LEVEL_INFO, "out Time :"+formatedDate);
					
					mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_GET_DATE).setValue(formatedDate);
					mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_ERECHARGE_TRANSACTION_AVAILABLE).setValue(AppConstant.Yes);
				}else{
					mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_ERECHARGE_TRANSACTION_AVAILABLE).setValue(AppConstant.No);
				}

 ...
 * Last generated by Orchestration Designer at: 2015-MAY-27  12:43:34 PM
 */
public class SR_SuccessAnnc extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:SR_SuccessAnnc", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("RegisterComplaint_CollectAlternateMN_Error-thank_you");
	}
	/**

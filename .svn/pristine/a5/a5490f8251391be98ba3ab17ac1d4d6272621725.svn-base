 ...
 * Last generated by Orchestration Designer at: 2015-MAR-11  03:57:25 PM
 */
public class TGSM_MN_0006 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:MainAccountBalance_Credit_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Account_Information-Check_TGSM_MN_0006");
	}
	/**

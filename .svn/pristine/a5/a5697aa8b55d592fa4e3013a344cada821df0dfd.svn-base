...
public class UnbilledAndCreditInfo_MN_0007 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_globalPropertyFileName", "DMProperties:GlobalPromptMenuRepeatWithOutZero", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 * Last generated by Orchestration Designer at: 2015-MAY-24  07:19:43 PM
 */
public class ComboPlans_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:ComboPlans_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

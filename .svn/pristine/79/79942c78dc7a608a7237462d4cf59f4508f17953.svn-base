...
public class GlobalMenuUnbilledInfoLDCopyCopy extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("GlobalPrompt-PreviousMenu", "PostpaidAccountInformation-UnbilledAndCreditInfo_MN_0007");
		exitPoints.put("GlobalPrompt-ProspectMainMenu", "PostpaidAccountInformation-ProspectMainMenu");
		exitPoints.put("GlobalPrompt-Repeat", "PostpaidAccountInformation-CreditInfo_PA_0018");
		return exitPoints;
	}
}

 ...
 * Last generated by Orchestration Designer at: 2015-OCT-30  04:24:23 PM
 */
public class Ann_PostpaidCopy extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2015-NOV-06  04:35:33 PM
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_Postpaid", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Dat_CallDisconnect");
		return submit;
	}
	/**

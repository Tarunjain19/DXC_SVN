...
import com.rcom.hni.model.UpdateLanguage;
...
public class UpdateLanguageInCSP extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "---> LanguageCode:"+AppDataMap.getInstance(Constants.TRIPLEFIVE).getAppData(strCurrentLanguage));
		...
		updateLanguage.setLanguageCode((String) AppDataMap.getInstance(Constants.TRIPLEFIVE).getAppData(strCurrentLanguage));
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(5640)).evaluate(mySession)) {
			...
			actions.add(new com.avaya.sce.runtime.Next("LanguageNotUpdate_PA_0010", "(Lang not updated)").setDebugId(5642));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Initialize_PA_0009", "(Lang updated)").setDebugId(489));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

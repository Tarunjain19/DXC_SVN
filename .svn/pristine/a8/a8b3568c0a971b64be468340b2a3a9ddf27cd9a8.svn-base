 ...
 * Last generated by Orchestration Designer at: 2015-MAR-17  11:51:16 AM
 */
public class DND_PA_0002 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Techical_Difficulty", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 */
public class Initialize_PA_0065 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			selectedOfferID = mySession.getVariableField(IProjectVariables.DATA_OFFER__MN___0_0_2_6,IProjectVariables.DATA_OFFER__MN___0_0_2_6_FIELD_VALUE).getStringValue();
			...
			info.writeln(ITraceInfo.TRACE_LEVEL_INFO, "Data initial Prompt :: "+initialPrompt);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("ProductsAndOffers-PlayOffer_PA_0065", "Continue");
		next.setDebugId(2552);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("CallData:transferReasonCode", "TR_0072", true).setDebugId(2569));

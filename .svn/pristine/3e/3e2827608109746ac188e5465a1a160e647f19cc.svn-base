...
public class Initialize_MN_0038 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		/*Initializing audio*/
		strInitialAudios = appProperties.getIVRProp(strApplicationName+Constants.HYPEN+Constants.HSDI_MN_0033);
		dynamicArrayList.add(strAmountEntered+Constants.currency);
		strInitialAudios = dynamicMenu.playPrompt(dynamicArrayList, strInitialAudios, dynamicArrayList.size()+"", info);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("CreditCardPayment-ConfirmAmount_MN_0038", "Default");
		next.setDebugId(1683);
		return next;
	}
	/**

 ...
 * Last generated by Orchestration Designer at: 2015-NOV-06  10:16:27 AM
 */
public class playNumber extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2015-NOV-06  11:30:23 AM
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_PlayNumber", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("PlayNumber-end");
		return submit;
	}
	/**

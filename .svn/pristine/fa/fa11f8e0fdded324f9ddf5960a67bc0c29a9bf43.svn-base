 ...
 * Last generated by Orchestration Designer at: 2015-MAY-21  07:49:20 PM
 */
public class LanguageSelection_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionCount", "DM_input:MoreOptionCount", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionDynamicValues", "DM_input:Menu_Option", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

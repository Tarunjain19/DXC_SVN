 ...
 * Last generated by Orchestration Designer at: 2015-JUN-12  07:19:00 PM
 */
public class IVR_CSP_Validation extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "IVR CSP Host Result ::", "appVariables:HostResult").setDebugId(4481));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Success", true).setDebugId(4120)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("SelectLang_MN", "Success").setDebugId(4126));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TransferCodes:TR_0003", false).setDebugId(4127));
			actions.add(new com.avaya.sce.runtime.Next("LinkDown_PP", "LinkDown").setDebugId(347));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	public void requestBegin(SCESession mySession) {
		...
		String  barringCode = AppConstants.EMPTY_STRING,key = AppConstants.EMPTY_STRING,appName= AppConstants.EMPTY_STRING,propertiesLocation = AppConstants.EMPTY_STRING;
		String  serviceType = AppConstants.EMPTY_STRING,dataType = AppConstants.EMPTY_STRING;
		String hostOutput = AppConstants.ERROR;
		...
		if(barringCode!=null && barringCode.contains(AppConstants.ABUSIVE))
			mySession.getVariableField(IProjectVariables.IVR__CSP__DETAILS,IProjectVariables.IVR__CSP__DETAILS_FIELD_BARRING_LIST).setValue(AppConstants.ABUSIVE);
		...
		/*
		*//**Service Type ***//*
			serviceType = objIVRCspInfo.getService();
	...
	public void LanguageSelectionMenu (SCESession mySession){
		...
		trace = mySession.getTraceOutput();
		appName = mySession.getVariableField(IProjectVariables.APP_NAME).getStringValue();
		key = appName+AppConstants.SEPERATOR_HYPEN+AppConstants.MN_0001;
		...
		dynamicWaves = AppProperties.GetInstance(AppConstants.DYN_MENU).getIVRProp(key);
		...
		if(circleLangCode!=null){
			...
			mySession.getVariableField(IProjectVariables.DM__INPUT_PATH,IProjectVariables.DM__INPUT_PATH_FIELD_MORE_OPTION_COUNT).setValue(count);
			mySession.getVariableField(IProjectVariables.DM__INPUT_PATH,IProjectVariables.DM__INPUT_PATH_FIELD_MENU_OPTION).setValue(circleLangCode);

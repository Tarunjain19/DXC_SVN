 ...
 */
public class UpdateLanguage_MN_0004 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:UpdateLanguage_MN_0004", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

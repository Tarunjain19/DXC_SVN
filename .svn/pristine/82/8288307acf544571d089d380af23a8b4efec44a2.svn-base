 ...
 */
public class Welcome_RED_PA_0001 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:RED_PA_0001_property", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

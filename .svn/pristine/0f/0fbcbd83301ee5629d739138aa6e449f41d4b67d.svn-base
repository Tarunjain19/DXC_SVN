...
public class TransURLHitTopUpAmountValidation implements ITransaction{
	...
	public ResTopUpAmountValidation getHostInterface(IVRDataBean ivrDataBean, ReqTopUpAmountValidation request){
		...
		try{
			...
			logger.info(uniqueId + "|" + "TransURLHitTopUpAmountValidation getHostInterface method start");
			wsdlProcessor();
			logger.info(uniqueId + "|" + "Response Code to Call Flow : " + responseCode);
			logger.info(uniqueId + "|" + "TransURLHitTopUpAmountValidation getHostInterface method end");
	...
	public void wsdlProcessor() {
		...
		try {
			...
			if(urlConnection instanceof HttpURLConnection)
			{
				...
				String strResAmount = Utilities.adjustDecimal(logger, eRechargeRes.getAMOUNT());
				String strResTalktime = Utilities.adjustDecimal(logger, eRechargeRes.getTALKTIME());

 ...
 * Last generated by Orchestration Designer at: 2015-MAY-26  06:00:56 PM
 */
public class Get_PINCode extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Get_PINCode", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_maxNoMatchCount", "Get_PINCode:NomatchRemaining", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Locate_Retailer_and_Collect_Area_PIN_Code-check_GetPINCode");
	}
	/**

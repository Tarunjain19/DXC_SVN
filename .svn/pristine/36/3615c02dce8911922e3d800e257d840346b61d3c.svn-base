 ...
 */
public class UnbilledInfo extends com.avaya.sce.runtime.Invoke {
	 ...
	 * Last generated by Orchestration Designer at: 2016-JAN-25  06:26:30 PM
	 */
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "dm_PropertyFileName:UnbilledInfo", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

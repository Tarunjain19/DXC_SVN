 ...
 */
public class SetDisconnectData extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		String strApplicationName = mySession.getVariableField(IProjectVariables.CALL_DATA, IProjectVariables.CALL_DATA_FIELD_APPLICATION_NAME).getStringValue();
		...
		/*Barred Caller Check */
		trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG,"SRC flag in Disconnect:: "+mySession.getVariableField(IProjectVariables.FLAG,IProjectVariables.FLAG_FIELD_SRC_FLAG).getStringValue());
		if(mySession.getVariableField(IProjectVariables.FLAG,IProjectVariables.FLAG_FIELD_SRC_FLAG).getStringValue().equalsIgnoreCase(Constants.FALSE))
			callInfo.setERRREASON("BARRED");
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("check_CampignSMS", "Default");
		next.setDebugId(807);
		return next;
	}
	/**

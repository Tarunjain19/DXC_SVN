 ...
 */
@Entity
@NamedStoredProcedureQuery(name=Constants.PROC_spsvn_GetIntelligentLayer, procedureName = Constants.spsvn_GetIntelligentLayer, resultClasses = com.rcom.postpaid.model.IntelligentLayerInfo.class,
parameters = {

 ...
 * Last generated by Orchestration Designer at: 2015-APR-02  03:00:38 PM
 */
public class Transfer extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Transfer getTransfer(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		transfer = new com.avaya.sce.runtime.Transfer("Transfer", "CallData:transferVDN", com.avaya.sce.runtime.Transfer.VARIABLE, null, "0s", com.avaya.sce.runtime.Transfer.CONSTANT, "0s", com.avaya.sce.runtime.Transfer.TransferType.BLIND, promptNames, null, this, "UUIData", com.avaya.sce.runtime.Transfer.VARIABLE, false, false);
		return transfer;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Transfer Reason Code", "CallData:transferReasonCode"));
		return(list);
	}
	/**

...
public class Initialize_PA_0018 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			strCreditAmount = mySession.getVariableField(IProjectVariables.CREDIT_INFO, IProjectVariables.CREDIT_INFO_FIELD_CREDIT_AMOUNT).getStringValue();
			...
			/*Initializing audio*/
			strInitialAudios = appProperties.getIVRProp(strApplicationName+Constants.HYPEN+Constants.PA_0018);

...
public class Set_MN_0010 extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "dmInputParameter:initialPrompt", com.avaya.sce.runtime.Expression.IS_EMPTY).setDebugId(5600)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("VAS-LinkDown", "linkdown").setDebugId(5601));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

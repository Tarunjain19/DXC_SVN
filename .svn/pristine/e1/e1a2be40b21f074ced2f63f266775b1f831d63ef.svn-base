...
public class CheckInput extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("SetHotFlashInfo", "DefaultLang");
		next.setDebugId(203);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "SelectLang_MN Return Code :: ", "SelectLang_MN:ReturnCode").setDebugId(630));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;

		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "SelectLang_MN:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:Success", true).setDebugId(344)).evaluate(mySession)) {
			actions = new java.util.ArrayList(3);
			actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "SelectLang_MN Value :: ", "SelectLang_MN:Value").setDebugId(631));
			actions.add(new com.avaya.sce.runtime.varoperations.SetCurrentLanguage("SelectLang_MN:Value", false).setDebugId(632));
			actions.add(new com.avaya.sce.runtime.Next("SetHotFlashInfo", "SelectedLang").setDebugId(633));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

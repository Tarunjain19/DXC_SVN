...
public class PlayEstimatedDelivery_PA_0029 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:PlayEstimatedDelivery_PA_0029", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("PostpaidAccountInformation-PushSMSEstimatedDelivery");
	}
	/**

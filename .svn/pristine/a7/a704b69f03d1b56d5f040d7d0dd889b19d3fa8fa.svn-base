 ...
 * Last generated by Orchestration Designer at: 2015-MAR-11  07:55:31 PM
 */
public class RechargeDetails_PA extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:RechargeDetails_PA", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Prepaid-LastRechargeSMS");
	}
	/**

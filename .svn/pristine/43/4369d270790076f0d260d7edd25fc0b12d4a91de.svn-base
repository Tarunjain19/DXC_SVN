...
public class Initialize_PA_0028 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		strRequestId = mySession.getVariableField(IProjectVariables.REQUEST_DUPLICATE_BILL, IProjectVariables.REQUEST_DUPLICATE_BILL_FIELD_CODE).getStringValue();
		
		key = strApplicationName +AppConstant.SEPERATOR_HYPEN+ AppConstant.PA_0029;
		...
		strInitialAudio = DynamicMenu.playPrompt(dynamicList, strInitialAudio, ""+dynamicList.size(), AppConstant.PA_0029, info);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("PostpaidAccountInformation-DuplicateBill_PA_0028", "Default");
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("dmInputParameter:propertyFileName", "propertyFileName:GPFeatureLevel", false).setDebugId(6355));

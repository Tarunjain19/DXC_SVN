 ...
 * Last generated by Orchestration Designer at: 2015-JUN-24  06:35:55 PM
 */
public class PostpaidOfferSubMenu extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:PostpaidOfferSubMenu", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("EvaluatePostpaidOfferSubMenu");
	}
	/**

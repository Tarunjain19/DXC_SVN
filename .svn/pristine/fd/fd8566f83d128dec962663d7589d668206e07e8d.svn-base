 ...
 * Last generated by Orchestration Designer at: 2015-MAR-18  04:01:03 PM
 */
public class setCallVar_getXferVDN_BC extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		String last5Menu =Constants.EMPTY_STRING;
		...
		try{
			...
			strUUI = strUUI+AppProperties.GetInstance(Constants.IVR_CONFIG_PROPERTIES).getIVRProp(Constants.LANGUAGE_ENGLISH)+"|"+last5Menu + "|" + mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_TRANFER_CODE).getStringValue();
			...
			transferVDNInfo.setLanguage(AppProperties.GetInstance(Constants.IVR_CONFIG_PROPERTIES).getIVRProp(Constants.LANGUAGE_ENGLISH));
			transferVDNInfo.setTransferReasonCode(mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_TRANFER_CODE).getStringValue());
			...
			callInfo.setTRANSCODE(mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_TRANFER_CODE).getStringValue());
			callInfo.setDISPOSITION("XA");
			callInfo.setCALLENDREASON("TRANSFER");
			
			ivrreportdata.setCALLINFO(callInfo);
			if(transferVDNInfo.getTransferVDN1()==null){
				 mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_TRANSFER_VDN).setValue(ivrProperties.getIVRProp(AppProperties.GetInstance(Constants.IVR_CONFIG_PROPERTIES).getIVRProp(Constants.LANGUAGE_ENGLISH)+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
				 callInfo.setTRANSFERVDN(AppProperties.GetInstance(Constants.IVR_CONFIG_PROPERTIES).getIVRProp((Constants.LANGUAGE_ENGLISH)+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
					info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Transfer VDN from Prperty File"+AppProperties.GetInstance(Constants.IVR_CONFIG_PROPERTIES).getIVRProp((Constants.LANGUAGE_ENGLISH)+Constants.UNDERSCORE+Constants.DEFAULT_VDN));
			}else{
	 ...
	 * Last generated by Orchestration Designer at: 2017-JUN-19  10:56:29 AM
	 */
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("TransferCall", "Success");
		next.setDebugId(499);
		return next;
	}
	/**

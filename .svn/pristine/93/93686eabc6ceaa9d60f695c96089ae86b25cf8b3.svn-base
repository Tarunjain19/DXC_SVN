 ...
 * Last generated by Orchestration Designer at: 2015-MAR-17  02:56:05 PM
 */
public class LinkDown_RED_PA_0009 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:RED_PA_0009_property", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

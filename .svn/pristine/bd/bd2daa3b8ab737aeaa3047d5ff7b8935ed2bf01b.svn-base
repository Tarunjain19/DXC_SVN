 ...
 * Last generated by Orchestration Designer at: 2016-MAR-23  02:27:27 PM
 */
public class Dat_initializaVariables extends com.avaya.sce.runtime.Data {
	 ...
	 * and should not be manually edited.  Manual edits may be overwritten
	 * by the code generator.
	 * Last generated by Orchestration Designer at: 2016-MAR-23  02:27:46 PM
	 */
	@Override
	public void requestBegin(SCESession mySession) {
		...
		Logger logger = Logger.getLogger("Dialog.Designer.TraceWriter.TRCOM_CF_MissCall_IVR");
		...
		String isMissCallIVR				= IVRConstants.EMPTY_QUOTES;	
	...
	//	IVRRoutingInfo objIVRRoutingInfo = null;
		...
		try{
			...
			itraceInfo.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "#AAAAAAAAAAAAAAAA"+configFilePath);
			IVRProperties ivrProp = IVRProperties.getInstance(configFilePath, mySession);
			itraceInfo.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "#BBBBBBBBB"+ivrProp);
			rcom_static_phrasepath = ivrProp.getProperty(mySession,IVRConstants.STATIC_PHRASE_PATH).trim();
			itraceInfo.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "#CCCCCCCCCCCC  "+rcom_static_phrasepath);
			strDefaultLanguage	  = ivrProp.getProperty(mySession,IVRConstants.DEFAULT_LANGUAGE).trim();		
			itraceInfo.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "#Phrase Path::" +rcom_static_phrasepath);
			itraceInfo.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "#Default language::" +strDefaultLanguage);
		...
		/*	max_no_input = ivrProp.getProperty(mySession,IVRConstants.MAX_NO_INPUT).trim();
			...
			callInfo.setLASTNODEACCESSED(IVRConstants.NA);
		...
		*/
			...
			mySession.getVariableField(IProjectVariables.VAR__MISS, IProjectVariables.VAR__MISS_FIELD_JAVA__ERROR).setValue(false);
		...
		/*	strLanguages		 = ivrProp.getProperty(mySession,IVRConstants.DEFAULT_LANGUAGES).trim();
			...
			mySession.getVariableField(IProjectVariables.VAR__MISS, IProjectVariables.VAR__MISS_FIELD_JAVA__ERROR).setValue(true);
		...
		{
			mySession.getVariableField(IProjectVariables.CALL_DATA, IProjectVariables.CALL_DATA_FIELD_CURRENT_LANG).setValue(strDefaultLanguage);
			
		itraceInfo.writeln(ITraceInfo.TRACE_LEVEL_DEBUG,"Language Set  - " +strDefaultLanguage);
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "VAR_MISS:JAVA_ERROR", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(15)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Ann_Thanks", "LinkDown").setDebugId(16));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

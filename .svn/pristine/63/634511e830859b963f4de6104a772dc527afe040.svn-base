 ...
 * Last generated by Orchestration Designer at: 2016-FEB-09  01:40:02 PM
 */
...
public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			{
				key = appName+AppConstant.SEPERATOR_HYPEN+AppConstant.MN_0101;
				...
				initialPrompt = DynamicMenu.playPrompt(dynamicList, initialPrompt, AppConstant.NA, AppConstant.MN_0101, trace);
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "DM_GetRegisteredPhNum_Menu:ReturnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(446)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("DM_ReConfirm_RegPhNumMenu", "success").setDebugId(447));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

		} else if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Flag_Application_Error", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:TRUE", true).setDebugId(3040)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("DM_TechDiff_Msg", "TechDiff").setDebugId(3041));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions.add(new com.avaya.sce.runtime.varoperations.Increment("Counters:PhNum_Counter").setDebugId(3039));
			actions.add(new com.avaya.sce.runtime.Next("DAT_Chk_Tries", "failure").setDebugId(449));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

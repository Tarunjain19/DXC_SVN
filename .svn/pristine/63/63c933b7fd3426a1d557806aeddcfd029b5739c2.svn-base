 ...
 * Last generated by Orchestration Designer at: 2016-JUN-01  11:05:04 AM
 */
public class UUIDataParse extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		String rUUIData=AppConstants.EMPTY_STRING,convertedUUIData;
		String prefix,postfix;
		String ani,dnis=AppConstants.EMPTY_STRING;
		ITraceInfo trace = null;
		String[] arrrUUIData;
		String[] arrUUIDATA;
		String appName= AppConstants.EMPTY_STRING;
		String UUILang= AppConstants.EMPTY_STRING;
		String UUIMDN= AppConstants.EMPTY_STRING;
		...
		try {
			...
			prefix = AppConstants.startPart;
			postfix = AppConstants.endPart;
			
	
			
			if(rUUIData != null && !AppConstants.EMPTY_STRING.equalsIgnoreCase(rUUIData)){

 ...
 * Last generated by Orchestration Designer at: 2015-APR-26  12:50:47 PM
 */
public class Begin extends com.avaya.sce.runtime.BasicServlet {
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("PS_Related_Complaints-Test_ChkIVR", 0, true, "Start");
		list.add(aGoto);

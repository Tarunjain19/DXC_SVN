...
import com.rcom.ppp.model.GPRSSRCInfo;
 ...
 * Last generated by Orchestration Designer at: 2015-DEC-09  11:01:33 AM
 */
public class GPRS_GSM_CHECK extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Flag:GPRS_BAR", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "true", false).setDebugId(15031)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("TransferNotAllowed", "GPRS_GSM").setDebugId(15032));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "appVariables:transferReason", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "TR_0104", false).setDebugId(15392)).evaluate(mySession, bo1)) {
			actions = new java.util.ArrayList(3);
			actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "Postpiad or RelGlobal Customer GPRS Check", "").setDebugId(15395));
			actions.add(new com.avaya.sce.runtime.Next("SRC_Update", "GetTxfrVDN").setDebugId(15396));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Charging_Menu", "Not Bar").setDebugId(15029));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
...
public void requestBegin(SCESession mySession) {
		...
		String CallerType=mySession.getVariableField(IProjectVariables.APP_VARIABLES,IProjectVariables.APP_VARIABLES_FIELD_CALLER_TYPE).getStringValue();
		
		trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG," - CallerType :" + CallerType);
		trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG," - ani Name :" + ani);
		
		if(CallerType.contains("GSM")){

 ...
 */
public class PlayFailure extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperty:PlayFailure", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_noInputMaxTryPrompt", "DMProperty:initialPrompt", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_noMatchMaxTryPrompt", "DMProperty:initialPrompt", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

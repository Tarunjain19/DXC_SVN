 ...
 * Last generated by Orchestration Designer at: 2015-MAY-28  11:17:33 AM
 */
public class Suspended_MainMN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_maxNoMatchCount", "Suspended_MainMN:NomatchRemaining", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

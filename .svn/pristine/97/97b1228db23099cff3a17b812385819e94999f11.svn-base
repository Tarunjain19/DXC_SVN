 ...
 */
public class PushSMS_Ebill extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("PushSMS-PushSMSreturn", "ServiceManagement-PushSMS_PA_0048");
		return exitPoints;
	}
}

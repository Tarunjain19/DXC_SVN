 ...
 * Last generated by Orchestration Designer at: 2015-APR-08  10:34:14 PM
 */
public class MN_0008_Inet_VAS_MM extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:InternetVAS_MM", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("InternetAndVAS-Check_MN_0008_Options");
	}
	/**

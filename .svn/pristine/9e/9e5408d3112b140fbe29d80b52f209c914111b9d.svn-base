 ...
 */
public class Terminated_AnncCopy extends com.avaya.sce.runtime.Invoke {
	...
	public String getNext() {
		return("Locate_Retailer_and_Collect_Area_PIN_Code-tries_exceed");
	}
	/**

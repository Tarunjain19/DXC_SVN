...
public class InitializeLanguage extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			strInitialAudio =AppProperties.GetInstance(AppConstant.IVR_CONFIG).getIVRProp(Constants.DATA_MN_0006);
			...
			for (int i = 0; i < arrLanguages.length; i++) {
				...
				dynamicValueList.add(AppProperties.GetInstance(AppConstant.IVR_CONFIG).getIVRProp(arrLanguages[i]));
			...
			mySession.getVariableField(IProjectVariables.DMPROPERTY, IProjectVariables.DMPROPERTY_FIELD_MENU_OPTION_COUNT).setValue(arrLanguages.length);
			 ...
			 String PropertyLocation=AppProperties.GetInstance(AppConstant.IVR_CONFIG).getIVRProp("ENG_ConfigFilePath");
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Language_1925_MN_0001", "Default");
		next.setDebugId(3062);
		return next;
	}
	/**

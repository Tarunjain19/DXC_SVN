 ...
 */
public class AnnoExpireMessage extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_AnnounceID", "dmInputParameter:AnnoID", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

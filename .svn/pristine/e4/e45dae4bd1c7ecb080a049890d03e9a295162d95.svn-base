 ...
 */
public class Set_MN_0011 extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("VAS-MN_0011", "Default");
		next.setDebugId(954);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			initialPrompt=DynamicMenu.playPrompt(dynamicWave, initialPrompt, AppConstant.NA, AppConstant.MN_0014, trace);

 ...
 * Last generated by Orchestration Designer at: 2015-JUN-09  02:38:11 PM
 */
public class NoMatchNoInput_PP extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:NoMatchNoInput_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

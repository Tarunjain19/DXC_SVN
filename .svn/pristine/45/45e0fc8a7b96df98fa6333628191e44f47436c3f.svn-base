 ...
 * Last generated by Orchestration Designer at: 2015-MAY-24  05:00:03 PM
 */
public class GetPhoneNo_PC extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:GetPhoneNo_PC", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

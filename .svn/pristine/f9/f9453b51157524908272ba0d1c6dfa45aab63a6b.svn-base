 ...
 * Last generated by Orchestration Designer at: 2015-NOV-11  03:44:09 PM
 */
public class Ann_tryFrmMobile extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Ann_tryAgainfrmMobile", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Call_EndProcess");
		return submit;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		String strPath,callerPath = null;
		...
		strPath=strPath+mySession.getVariableField(IProjectVariables.MNU__SERVICE_MENU,IProjectVariables.MNU__SERVICE_MENU_FIELD_VALUE).getStringValue()+"|";
		mySession.getVariableField(IProjectVariables.CALL_INFO,IProjectVariables.CALL_INFO_FIELD_DTMF_PATH).setValue(strPath);
		
		/*
		callerPath=mySession.getVariableField(IProjectVariables.CALL_INFO,IProjectVariables.CALL_INFO_FIELD_CALLER_PATH).getStringValue();
		callerPath=callerPath+"TELV_PA0006"+"|";
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Voice customers dialing 1800 tollfree", ""));
		return(list);
	}
	/**

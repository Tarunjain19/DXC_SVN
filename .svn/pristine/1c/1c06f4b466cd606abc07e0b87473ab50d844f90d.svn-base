 ...
 */
public class ERechargeTransaction_PP extends com.avaya.sce.runtime.Invoke {
	 ...
	 * Last generated by Orchestration Designer at: 2015-SEP-21  04:08:47 PM
	 */
	public ERechargeTransaction_PP() {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "dm_PropertyFileName:ERechargeTransaction_PP", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

 ...
 * Last generated by Orchestration Designer at: 2015-MAR-17  12:00:59 PM
 */
public class DND_MN_0001 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:LanguageSelection", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionDynamicValues", "dmInputParameter:moreOptionDynamicValues", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

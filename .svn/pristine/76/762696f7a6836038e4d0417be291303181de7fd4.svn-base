 ...
 * Last generated by Orchestration Designer at: 2015-JUL-29  11:00:27 AM
 */
public class Begin extends com.avaya.sce.runtime.BasicServlet {
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("Prepaid_Start-PrepaidIntelligentLayer", 0, true, "Start");
		list.add(aGoto);

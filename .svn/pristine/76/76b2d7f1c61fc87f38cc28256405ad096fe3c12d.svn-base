 ...
 * Last generated by Orchestration Designer at: 2015-MAR-19  11:20:05 AM
 */
public class SelectLanguage_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:SelectLanguage_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_noMatchPrompt", "DM_input:DM_noMatchPrompt", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_noInputPrompt", "DM_input:DM_noInputPrompt", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

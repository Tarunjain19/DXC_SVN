 ...
 * Last generated by Orchestration Designer at: 2015-MAR-11  07:03:23 PM
 */
public class DataBalance_Regret_PA extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:DataBalance_Regret_PA", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

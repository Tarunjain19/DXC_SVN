 ...
 * Last generated by Orchestration Designer at: 2015-MAY-28  07:22:35 PM
 */
public class RechargeOption_MN extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:RechargeOption_MN", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Recharge_Account_Using_Cash_Card-Check_RechargeOption_MN");
	}
	/**

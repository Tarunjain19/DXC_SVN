 ...
 * Last generated by Orchestration Designer at: 2015-MAR-17  02:48:16 PM
 */
public class Retention_RED_PA_0002 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:RED_PA_0002_property", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

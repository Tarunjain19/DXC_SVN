package com.servion.rcom.CDMA.hostinterface.util;

public class HostConstants {

	public static final String GLOBALHOSTCONFIG = "webservice_CDMA";
	public static final String HOST_REQUEST_TYPE = "WS";
	public static final String CSS_HOST_METHOD = "cssInfo";
	public static final String DOT = ".";
	public static final String PARAM_SR_STATUS_SOLVING = "PARAM_SR_STATUS_SOLVING";
	...
	public static final String CSS_ENDPOINT_DATA_REQUEST = "CSS_ENDPOINT_DATA_REQUEST";
	public static final String CSS_ENDPOINT_CDMA_REQUEST = "CSS_ENDPOINT_CDMA_REQUEST";
	...
	public static final String CSS_REQUEST_TYPE_ITEMISED_BILL_ACTIVATION = "CSS_REQUEST_TYPE_ITEMISED_BILL_ACTIVATION";
	public static final String CSS_REQUEST_TYPE_DNC_ACTIVATION = "CSS_REQUEST_TYPE_DNC_ACTIVATION";
	public static final String CSS_REQUEST_TYPE_DNC_DEACTIVATION = "CSS_REQUEST_TYPE_DNC_DEACTIVATION";
	...
	public static final String CSS_REQUEST_TYPE_ILD_ACTIVATION = "CSS_REQUEST_TYPE_ILD_ACTIVATION";
	public static final String CSS_REQUEST_TYPE_STORE_PTP = "CSS_REQUEST_TYPE_STORE_PTP";
	public static final String CSS_REQUEST_TYPE_TVP_STATUS="CSS_REQUEST_TYPE_TVP_STATUS";
	public static final String CSS_REQUEST_TYPE_TVP_STATUS_UPDATE="CSS_REQUEST_TYPE_TVP_STATUS_UPDATE";
	public static final String CSS_REQUEST_TYPE_TVP_DATA_STATUS_UPDATE="CSS_REQUEST_TYPE_TVP_DATA_STATUS_UPDATE";
	...
	public static final String PACE_HOST_RESPONSE_ERROR_CODE_SUCCESS = "PACE_HOST_RESPONSE_ERROR_CODE_SUCCESS";
	...
	public static final String PTP_USER_ID = "PTP_USER_ID";
	public static final String PTP_USER_IP = "PTP_USER_IP";
	...
	public static final String MYPACKS_DTLS = "MYPACKS_DTLS";
	...
	public static final String PARAM_ITBA_ACTION_TYPE = "ACTION_TYPE";
	public static final String PARAM_ITBA_ACTION_TYPE_ACTIVATION = "ACT";
	
	public static final String PARAM_DND_ACTION_TYPE = "ACTION_TYPE";
	public static final String PARAM_DND_ACTION_TYPE_ACTIVATION = "ACT";
	public static final String PARAM_DND_ACTION_TYPE_DEACTIVATION = "DACT";
	...
	public static final String POA_TYPE="POA_TYPE";
	public static final String POA_ID_DETAILS="POA_ID_DETAILS";
	public static final String POA_ISSUE_DATE="POA_ISSUE_DATE";
	public static final String TVP_STATUS="TVP_STATUS";
	public static final String DOB="DOB";
	public static final String DATA_CONSENT="DATA_CONSENT";
	public static final String UPDATE_DATE="UPDATE_DATE";
	public static final String OUT_STATUS="OUT_STATUS";
	public static final String OUT_STATUS_CODE="OUT_STATUS_CODE";
	public static final String OUT_MSG="OUT_MSG";
	
	public static final String PARAM_PAY_LINK_URL = "URL";
	
	public static final String PARAM_ILD_ACTION_TYPE = "ACTION_TYPE";
	public static final String PARAM_ILD_ACTION_TYPE_ACTIVATION = "ACT";
	public static final String CUST_CATEGORY = "CUST_CATEGORY";
	public static final String HNI = "HNI";
	
	public static final String PARAM_PTP_USER_ID = "USER_ID";
	public static final String PARAM_PTP_USER_IP = "USER_IP" ;
	public static final String PARAM_PTP_MODE = "PTP_MODE";
	public static final String PARAM_PTP_AMOUNT = "PTP_AMOUNT";
	public static final String PARAM_PTP_MODE_CASH = "CASH";
	public static final String PARAM_PTP_MODE_CHEQUE = "CHEQUE";
	public static final String PARAM_PTP_MODE_CREDIT_CARD = "CREDIT CARD";
	public static final String PARAM_PTP_MODE_DEBIT_CARD = "DEBIT_CARD";
	
	public static final String TVP_STATUS_FLAG="TVP_STATUS_FLAG";

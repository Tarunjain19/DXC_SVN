...
public class LoadOnStartUp extends com.avaya.sce.runtime.BasicServlet {
	...
	public void init() throws ServletException {
		...
		String strPath  = this.getServletContext().getInitParameter(Constants.ConfigFilePath);
		
		if(strPath == null){
			strPath = "/Config/IVRConfig.properties";
			strPath = getServletContext().getRealPath(strPath);
		}
		
		System.out.println("config path:"+strPath);
			
		LoadProperty loadProperty = new LoadProperty(strPath);
		//AppProperties.setInstance("OtherFlow_Hostservice", "D:\\RCOM\\RCOM_CF_WebworldHelpdesk_IVR\\Config\\");
		System.out.println(LoadProperty.getivrconfigProp(Constants.ConfigFilePath));

	...
	public void requestBegin(SCESession mySession) {
		...
		try {
		   ...
		   String Temp_Lang=mySession.getVariableField(IProjectVariables.CALL_DATA, IProjectVariables.CALL_DATA_FIELD_DEFAULT_LANGUAGE).getStringValue();
			...
			service_Type=mySession.getVariableField(IProjectVariables.CALL_DATA,IProjectVariables.CALL_DATA_FIELD_SERVICE__TYPE).getStringValue();
			caller_type=mySession.getVariableField(IProjectVariables.CALL_DATA,IProjectVariables.CALL_DATA_FIELD_CALLER_TYPE).getStringValue();
			
			callInfo.setCALLERTYPE(caller_type);
			callInfo.setRESERVE1(strCallPath);
			callInfo.setRESERVE2(service_Type);
			callInfo.setRESERVE3(mySession.getVariableField(IProjectVariables.SESSION, IProjectVariables.SESSION_FIELD_ANI).getStringValue());
			callInfo.setRESERVE4(mySession.getVariableField(IProjectVariables.APP__VARIABLES, IProjectVariables.APP__VARIABLES_FIELD_UUIDNIS).getStringValue());

 ...
 * Last generated by Orchestration Designer at: 2015-MAY-22  05:01:12 PM
 */
public class SetLanguage extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			String langMenuRetCode = mySession.getVariableField(IProjectVariables.LANGUAGE__MN, IProjectVariables.LANGUAGE__MN_FIELD_RETURN_CODE).getStringValue();
			String langMenuRetValue = mySession.getVariableField(IProjectVariables.LANGUAGE__MN, IProjectVariables.LANGUAGE__MN_FIELD_VALUE).getStringValue();
			
			String dmPropertiesLocation = null;
			String language = null;
	
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "LANGUAGE__MN_FIELD_RETURN_CODE : " +langMenuRetCode);
			trace.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "LANGUAGE__MN_FIELD_VALUE : " +langMenuRetValue);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("SF_HotFlash", "Default");
		next.setDebugId(640);
		return next;
	}
	/**
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:hotFlashId", "constants:HotFlashId_DAKC_PA_0002", false).setDebugId(8350));

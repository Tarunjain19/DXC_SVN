 ...
 * Last generated by Orchestration Designer at: 2015-MAR-11  04:19:38 PM
 */
public class TGSM_PA_0021 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:MainAccountBalance_Zero_PA", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Account_Information-SetPushSMS_ZeroBal");
	}
	/**

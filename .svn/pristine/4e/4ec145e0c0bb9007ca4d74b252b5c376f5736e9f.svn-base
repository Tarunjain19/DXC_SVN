 ...
 */
public class ChangeLanguage_MN_0043 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_globalPropertyFileName", "DMProperties:GlobalPromptMenuRepeat", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperties:ChangeLanguage_MN_0043", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_initialPrompt", "DMProperties:initialAudios", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_rePromptNoInput", "DMProperties:initialAudios", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_rePromptNoMatch", "DMProperties:initialAudios", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionCount", "DMProperties:menuOptionCount", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionDynamicValues", "DMProperties:menuOptions", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

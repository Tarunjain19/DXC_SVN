...
@Entity
@NamedStoredProcedureQuery(name=Constants.PROC_spsvn_IVRReturnPackInfo, procedureName = Constants.spsvn_IVRReturnPackInfo, resultClasses = com.rcom.postpaid.model.CRMPackInfo.class, 
parameters = {

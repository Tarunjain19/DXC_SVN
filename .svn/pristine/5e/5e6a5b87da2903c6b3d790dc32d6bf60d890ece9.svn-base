...
public class AccessDB_DNCRegisterDays extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			if(daydiff >= 3)
			{
				...
				if(dndDeActivationDate != null && !dndDeActivationDate.equalsIgnoreCase(Constants.EMPTY_STRING))
				{
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(4289)).evaluate(mySession)) {

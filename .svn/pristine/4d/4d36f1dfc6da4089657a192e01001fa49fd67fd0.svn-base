...
public class Initialize_PA_0026 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			strMode = mySession.getVariableField(IProjectVariables.POSTPAID__BILL_DELIVERY_STATUS, IProjectVariables.POSTPAID__BILL_DELIVERY_STATUS_FIELD_MODE).getStringValue();
			strBillGenDate = mySession.getVariableField(IProjectVariables.POSTPAID__BILL_DELIVERY_STATUS, IProjectVariables.POSTPAID__BILL_DELIVERY_STATUS_FIELD_BILL_GENERATION_DATE).getStringValue();
			strBillDeliveryDate = mySession.getVariableField(IProjectVariables.POSTPAID__BILL_DELIVERY_STATUS, IProjectVariables.POSTPAID__BILL_DELIVERY_STATUS_FIELD_BILL_DELIVERY_DATE).getStringValue();
			strBillDeliveryStatus = mySession.getVariableField(IProjectVariables.POSTPAID__BILL_DELIVERY_STATUS, IProjectVariables.POSTPAID__BILL_DELIVERY_STATUS_FIELD_BILL_DELIVERY_STATUS).getStringValue();
			...
			strInitialAudio = audioPropertyInstance.getIVRProp(strApplicationName+Constants.HYPEN+Constants.HSDI_PA_0021);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("AccountInformation-BillgenDate_PA_0026", "Default");

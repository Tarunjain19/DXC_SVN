 ...
 * Last generated by Orchestration Designer at: 2015-MAY-13  09:48:02 PM
 */
public class AccessHost_DeRegisterDNC extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try{
			...
			req.setMDN(MDN);
			try{
			res = webService.executeDNCderegistration(((IVRDataBean) mySession.getProperty(Constants.IVRDATABEAN)), req);
			}
			catch(Exception e)
			{
			...
			{
				strSMSFrame = appProperties.getIVRProp(Constants.DNC_DEREGISTRATION_Success);
			...
			{
				strSMSFrame = appProperties.getIVRProp(Constants.DNC_DEREGISTRATION_Failure);
				smsHashTable = setPushSMS.generatePushSMSDataMap(strSMSFrame, arrSMSData);
	 ...
	 * Last generated by Orchestration Designer at: 2015-MAY-13  09:48:02 PM
	 */
	public AccessHost_DeRegisterDNC() {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:True", true).setDebugId(6473)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_CRITICAL, "WS Down|Service Managemant flow|AccessHost_DeRegisterDNC|", "EPM_Alarm:Description", true).setDebugId(6474));
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "Constants:False", false).setDebugId(6475));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(4581)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("ServiceManagement-PushSMS_DNCDeRegisterFailed", "LinkDown").setDebugId(4582));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("ServiceManagement-PushSMS_DNCDeRegistered", "Continue").setDebugId(4584));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

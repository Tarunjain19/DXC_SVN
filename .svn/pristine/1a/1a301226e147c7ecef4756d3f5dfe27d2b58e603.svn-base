...
public class Get_ConfirmationTopupInfo extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("ConfirmTopUpAmount");
		next.setDebugId(3173);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			talkTime = mySession.getVariableField(IProjectVariables.TOP_UP_DETAIL,IProjectVariables.TOP_UP_DETAIL_FIELD_TALK_TIME).getStringValue();

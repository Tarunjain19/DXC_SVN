 ...
 */
public class PA_0032 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:ActivateVAS_MaxTriesExceed_Annce", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

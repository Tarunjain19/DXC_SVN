 ...
 * Last generated by Orchestration Designer at: 2016-APR-08  12:52:08 PM
 */
public class Language_1925_MN_0001 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertiesLocation", "DMPropertyCopy:ConfigFilePath", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_globalPropertyFileName", "DMPropertyCopy:global", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMPropertyCopy:Language_1925_MN_0001", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_initialPrompt", "DMPropertyCopy:initialPrompt", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_noMatchPrompt", "DMPropertyCopy:initialPrompt", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("input_noInputPrompt", "DMPropertyCopy:initialPrompt", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionCount", "DMPropertyCopy:menuOptionCount", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
		...
		param = new com.avaya.sce.runtime.Parameter("input_moreOptionDynamicValues", "DMPropertyCopy:menuOption", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

...
public class HostConstants {
	...
	public static final String GLOBALHOSTCONFIG = "webservice";
	...
	public static final String CSS_ENDPOINT_TELEVERIFY_REQUEST = "CSS_ENDPOINT_TELEVERIFY_REQUEST";
	...
	public static final String E_KYC="E_KYC";

 ...
 * Last generated by Orchestration Designer at: 2015-MAY-26  08:16:24 PM
 */
public class Get_CouponNumber extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:Get_CouponNumber", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("Purchase_DTV_and_Validate_Coupon-check_GetCouponNumber");
	}
	/**

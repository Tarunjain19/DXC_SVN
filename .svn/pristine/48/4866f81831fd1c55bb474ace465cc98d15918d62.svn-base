 ...
 */
public class Initialize_MN_0004 extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			strInitialAudio = audioConfigInstance.getIVRProp(strApplicationName+Constants.HYPEN+Constants.MN_0004);
			info.writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "Audio Key:"+strApplicationName+Constants.HYPEN+Constants.MN_0004);
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("UpdateLanguage_MN_0004", "Default");
		next.setDebugId(462);
		return next;
	}
	/**

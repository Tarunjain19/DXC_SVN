...
public class executeDataBalance extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "EPM_Alarm:Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:TRUE", true).setDebugId(3187)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "WS_Alarm_Flag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:ON", true).setDebugId(3201)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.tracking.ReportAlarmInfo(com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_MAJOR, "WS Down|Account Info Flow|Exe Data Bal|", "EPM_Alarm:Description", true).setDebugId(3188));
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("EPM_Alarm:Flag", "constant:FALSE", false).setDebugId(3189));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "appVariables:HostResult", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:success", true).setDebugId(1119)).evaluate(mySession)) {

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition4", "dataBalanceAndValidity:noDataFlag", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:Key_False", true).setDebugId(1122)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("Account_Information-Set_TGSM_PA_0024", "Available").setDebugId(1123));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("Account_Information-PA_0080", "NotAvailable").setDebugId(2415));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition5", "Flag:CalledFromIntelligent", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "constant:Key_true", true).setDebugId(2936)).evaluate(mySession)) {
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("Account_Information-MainMenu", "MainMenu").setDebugId(2937));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferCode", "TR_0077", true).setDebugId(3026));
				actions.add(new com.avaya.sce.runtime.Next("Account_Information-TGSM_PA_0023", "network_failure").setDebugId(2939));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
		...
		try
		{
			...
			if(resDataBalance!=null){
				...
				if(AppConstant.zero.equals(resDataBalance.getResponseCode())){
					...
					mySession.getVariableField(IProjectVariables.DATA_BALANCE_AND_VALIDITY,IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_SMS_THREE_GFAIR_USAGE_DATE).setValue(strThreeGFairUsageBalanceExpiryDate);
					mySession.getVariableField(IProjectVariables.DATA_BALANCE_AND_VALIDITY,IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_SMSCDMA_USAGE_DATE).setValue(strcdmaDataUsageBalanceExpiryDate);
					mySession.getVariableField(IProjectVariables.DATA_BALANCE_AND_VALIDITY,IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_SMSTHREE_GNET_DATE).setValue(strThreeGNetBalanceExpiryDate);
					mySession.getVariableField(IProjectVariables.DATA_BALANCE_AND_VALIDITY,IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_SMSTWO_GNET_DATE).setValue(strTwoGNetBalanceExpiryDate);
					...
					dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_THREE_GFAIR_USAGE_BALANCE).setValue(strThreeGFairUsageBalance);
					dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_THREE_GFAIR_USAGE_BALANCE_EXPIRY_DATE).setValue(strThreeGFairUsageBalanceExpiryDate);
					...
					dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_THREE_GNET_BALANCE).setValue(strThreeGNetBalance);
					dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_THREE_GNET_BALANCE_EXPIRY_DATE).setValue(strThreeGNetBalanceExpiryDate);
					...
					dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_TWO_GNET_BALANCE).setValue(strTwoGNetBalance);
					dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_TWO_GNET_BALANCE_EXPIRY_DATE).setValue(strTwoGNetBalanceExpiryDate);
					}else{
					...
					dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_CDMA_USAGE_BALANCE).setValue(strcdmaDataUsageBalance);
					dataBalance.getComplexVariable().getField(IProjectVariables.DATA_BALANCE_AND_VALIDITY_FIELD_CDMA_BALANCE_EXPIRY_DATE).setValue(strcdmaDataUsageBalanceExpiryDate);
					}

 ...
 */
public class PushSMS_PA_0018 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:PushSMS_PA_0018", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
	...
	public String getNext() {
		return("AccountInformation-GlobalMenuDeliveryCheckBillLinkDown");
	}
	/**

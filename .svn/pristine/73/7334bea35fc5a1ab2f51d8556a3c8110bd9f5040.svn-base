 ...
 * Last generated by Orchestration Designer at: 2015-APR-02  01:21:05 PM
 */
public class ThankYou_PA extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "propertyFileName:ThankYouAnnc", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

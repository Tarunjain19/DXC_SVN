 ...
 * Last generated by Orchestration Designer at: 2015-JUN-18  11:21:48 AM
 */
public class GetPrepaidInfo_PC extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DM_propertyFileName:GetPrepaidInfo_PC", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

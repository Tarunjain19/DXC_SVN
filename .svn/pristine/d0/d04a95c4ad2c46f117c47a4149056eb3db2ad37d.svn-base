...
public class AccessHost_FreeUnitInfo extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		try {
			...
			{
				reqFreeUnitInfo.setMDN(mySession.getVariableField(IProjectVariables.APP_VARIABLES, IProjectVariables.APP_VARIABLES_FIELD_MOBILE_NO).getStringValue());
			}
			...
			if((resFreeUnitInfo.getResponseCode()).equals(AppConstant.zero)){
				arrayFreeUnitDetails = resFreeUnitInfo.getFreeUnitDetailsList();
				strSMSFrame = appProperties.getIVRProp(AppConstant.FREE_UNIT_Success);
				...
				strSMSFrame = appProperties.getIVRProp(AppConstant.FREE_UNIT_Failure);
				smsHashTable = setPushSMS.generatePushSMSDataMap(strSMSFrame, arrSMSData);
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "Flag:isLinkDown", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "Constants:yes", true).setDebugId(844)).evaluate(mySession)) {
			...
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("appVariables:transferReason", "TR_0032", true).setDebugId(6359));
			actions.add(new com.avaya.sce.runtime.Next("PostpaidAccountInformation-Linkdown", "LinkDown").setDebugId(848));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("dmInputParameter:propertyFileName", "propertyFileName:GPFeatureLevel", false).setDebugId(6348));
			actions.add(new com.avaya.sce.runtime.Next("PostpaidAccountInformation-FreeUnitInfo_PA_0016", "Continue").setDebugId(850));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

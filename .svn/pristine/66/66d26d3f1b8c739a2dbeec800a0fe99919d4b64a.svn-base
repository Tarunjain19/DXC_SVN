 ...
 * Last generated by Orchestration Designer at: 2015-SEP-08  05:12:37 PM
 */
public class WS_BalanceCheck extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AppVariables:IsHostFailure", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "CONSTANTS:YES", true).setDebugId(694)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:TransferPoint", "TransferPoints:RD01_TR_0055", false).setDebugId(695));
			actions.add(new com.avaya.sce.runtime.Next("Top_Up_Packs-link_down", "(Linkdown)").setDebugId(696));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "AppVariables:IsBalanceAvailableToBuy", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(698)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:IsBalanceAvailableToBuy", "false", true).setDebugId(702));
				actions.add(new com.avaya.sce.runtime.Next("Top_Up_Packs-DB_LogPurchaseRequest", "(Balance Available)").setDebugId(699));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("AppVariables:FromBalanceCheckFlow", "true", true).setDebugId(897));
				actions.add(new com.avaya.sce.runtime.Next("Top_Up_Packs-SF_RechargeAccount", "(Balance Not Available)").setDebugId(701));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

 ...
 */
public class GETIVROffer extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Prepaid-OffersMenu", "Default");
		next.setDebugId(10782);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		try
		{
			...
			key = appName +AppConstant.SEPERATOR_HYPEN+ AppConstant.HSDI_MN_0008;

 ...
 */
public class MainMenu_SIM_MN_0002 extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "DMProperty:MainMenu_SIM_MN_0002", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

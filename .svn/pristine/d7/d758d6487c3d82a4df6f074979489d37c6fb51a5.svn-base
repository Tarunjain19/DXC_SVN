 ...
 * Last generated by Orchestration Designer at: 2015-JUN-01  12:57:56 PM
 */
public class Begin extends com.avaya.sce.runtime.BasicServlet {
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("RechargeAcUsingCashCard-GetCashCardNo_MN", 0, true, "Start");
		list.add(aGoto);
